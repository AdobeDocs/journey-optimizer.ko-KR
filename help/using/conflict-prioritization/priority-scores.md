...
**이 페이지에서:** 여정, 캠페인 및 인바운드 작업에 우선 순위 점수를 할당하면 프로필이 두 개 이상 적격한 경우 우선 순위를 지정할 커뮤니케이션을 제어할 수 있습니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/3445008?captions=kor&quality=12)
