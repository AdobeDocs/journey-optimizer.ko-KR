...
규칙 세트를 사용하면 **여러 규칙을 규칙 세트로 그룹화**&#x200B;하여 선택한 여정 및 캠페인에 적용할 수 있습니다. 이를 통해 특정 기간 동안 고객이 진입할 수 있는 여정의 수와 빈도를 제한하거나, 커뮤니케이션 유형에 따라 사용자가 메시지를 수신하는 빈도를 제어할 때의 세부성이 향상됩니다.
...
>id="ajo_rule_type"
>title="규칙 유형"
>abstract="채널 규칙 세트에 적용할 규칙 유형을 선택하십시오. **빈도 상한 설정** 유형을 사용하여 커뮤니케이션 채널에 상한 설정 규칙을 적용합니다. 예를 들어, 하루에 1회 이상의 이메일 또는 SMS 메시지를 보내지 않도록 설정할 수 있습니다. **방해 금지 시간대**&#x200B;를 선택하여 시간 기반 제외 규칙을 정의하면, 특정 시간대에는 메시지가 전송되지 않도록 할 수 있습니다."
