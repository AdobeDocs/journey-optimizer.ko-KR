...
title: Journey Optimizer 리소스에서 작업 감사
...
# Journey Optimizer 리소스에서 작업 감사 {#track-changes}

## 감사 로그 기본 정보 {#audit-logs}

Journey Optimizer를 사용하여 시스템 사용자가 여정, 메시지, 랜딩 페이지 등과 같은 다양한 서비스 및 기능을 통해 수행한 작업을 식별할 수 있습니다.
