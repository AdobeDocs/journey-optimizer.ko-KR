...
Adobe Journey Optimizer은 수신 메시지에서 **시작**, **정지**, **정지 해지** 키워드를 자동으로 처리합니다. 이러한 키워드는 SMS 공급자로부터 자동 표준 응답을 트리거합니다.

SMS에 대한 기본 인바운드 키워드 지원(시작, 정지 및 정지 해지)이 작동하는 방식에 대한 자세한 내용은 다음 비디오를 참조하십시오.
