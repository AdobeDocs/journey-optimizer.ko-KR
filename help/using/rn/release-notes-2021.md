...
<p><a href="../configuration/delegate-subdomain.md#cname-subdomain-setup">자세한 설명서</a>에서 CNAME 하위 도메인 위임에 대해 자세히 알아보십시오.</p>
</td>
</tr>
</tbody>
</table>
...
* **PTR 기록 편집** - 이제 PTR 레코드를 편집하고 업데이트 상태를 모니터링할 수 있습니다. [자세히 알아보기](../configuration/ptr-records.md#edit-ptr-record)
...
<tr>
<td>
<p>보고에서 새 지표를 사용할 수 있습니다. 이메일 및 푸시 메시지에 대한 [타기팅] 및 [제외] 지표가 실시간 보고서와 글로벌 보고서 양쪽에 표시됩니다. </br> 최신 지표에 액세스하려면 채널 및 보고 유형별로 다른 보고 대시보드를 각각 재설정해야 합니다. 대시보드 사용자 지정에 대한 자세한 내용은 <a href="../reports/live-report.md">자세한 설명서</a>를 참조하세요.</p>
...
<p>이 기능은 현재 beta 버전으로 beta 고객에게만 제공됩니다. Beta 프로그램에 참여하려면 Adobe 고객 지원 센터에 문의해 주십시오.</p>
...
* **검색** - 이제 모든 페이지에서 통합 [!DNL CX Enterprise] 검색 필드를 통해 비즈니스 개체와 도움말 문서를 직접 검색할 수 있습니다. [자세히 알아보기](../start/user-interface.md#unified-search)
