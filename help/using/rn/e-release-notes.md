...
<tr>
<td>
<p>이제 여정 캔버스에서 전용 [콘텐츠 결정] 활동을 통해 개인화된 오퍼를 여정에 포함하고 조건 및 사용자 정의 작업을 포함한 여정 활동에 사용할 수 있습니다.</p>
...
* **채널 규칙 세트**
   ...
   * 캡핑의 **사용자 정의 기간** - 채널 규칙 세트 구성 화면에 새로 추가된 **반복 횟수** 필드를 사용하여 지정된 기간에 따라 여러 날, 주 또는 달에 걸쳐 빈도 캡핑 규칙을 적용할 수 있습니다.

   * **시간 단위 기간** - 이제 채널 규칙 세트에 대해 시간 단위로 캡핑을 적용할 수 있습니다.

* **코드 기반 경험**

   * 이제 코드 기반 경험 콘텐츠 템플릿에 결정 정책을 추가할 수 있습니다.

   * 이제 코드 기반 경험 여정 또는 캠페인 편집 화면에서 개인화 편집기를 열지 않고도 결정 정책을 직접 추가할 수 있습니다.

* **이메일 디자이너의 사용자 정의 CSS 지원**

  이제 Journey Optimizer의 [이메일 디자이너] 내에서 바로 이메일 콘텐츠에 사용자 정의 CSS를 추가할 수 있습니다.

* **캠페인에 새로운 탭 탐색 적용**

  새로운 탐색 패턴을 통해 콘텐츠 작성에 보다 빠르게 액세스하고 여러 캠페인 간에 설정을 더욱 확장할 수 있습니다.
