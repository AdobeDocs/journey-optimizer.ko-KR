...
<p>이 기능은 이제 모든 환경(<strong>일반 가용성</strong>)에서 사용할 수 있습니다.</p>
...
* **경험 이벤트 조회 사용 중단** - 2026년 4월 1일부터 여정 조건 식 편집기의 <strong>경험 이벤트 조회</strong>이(가) 지난 90일 동안 경험 이벤트 조회를 사용하지 않은 조직에 대해 사용되지 않습니다. 이 기능은 2025년 7월 8일 이후 신규 고객 조직에서 이미 사용할 수 없습니다. 대안은 [여정의 경험 이벤트 조회](../building-journeys/exp-event-lookup.md)를 참조하십시오.
...
* **타사 이미지 생성을 위한 Firefly 3P 모델 지원** - 이제 Journey Optimizer에서 이미지를 만드는 데 Firefly과 함께 <strong>타사 이미지 생성 모델</strong>(예: OpenAI 및 Gemini)을 사용할 수 있습니다. 이렇게 하면 각 사용 사례에 적합한 모델을 보다 유연하게 선택하고 <strong>Firefly 3P 게이트웨이</strong>를 통해 승인된 외부 공급자를 통합할 수 있습니다.

  <a href="https://jira.corp.adobe.com/browse/DOCAC-14145">DOCAC JIRA 작업에 연결</a>

#### 캠페인

* **여정 및 캠페인용 폴더** - 이제 <strong>여정</strong> 및 <strong>캠페인</strong>을 <strong>폴더</strong>로 구성하여 인터페이스에서 탐색 및 관리를 개선할 수 있습니다.
...
* **의사 결정 항목에 조각 첨부** - 이제 Journey Optimizer은 <strong>의사 결정 정책</strong>을 통해 코드 기반 경험 캠페인에서 활용할 수 있는 <strong>의사 결정 항목</strong>에 <strong>조각</strong>을(를) 첨부할 수 있는 기능을 제공합니다.
  ...
  **참고**: 이제 모든 환경에서 이 개선 사항을 사용할 수 있습니다(<strong>일반 가용성</strong>).
