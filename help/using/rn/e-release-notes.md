...
* **외부 대상에 대한 여정에서 보조 ID 지원** - **보조 식별자** 여정은 이제 CSV 파일에서 가져온 대상 및 Federated Audience Composition으로 만든 대상을 포함하여 **외부 대상**&#x200B;에 대해 지원됩니다. 대상자의 모든 비ID 속성 또는 비개인 ID 속성을 보조 ID로 지정할 수 있으며, 스키마 레이블 지정은 필요하지 않습니다.
