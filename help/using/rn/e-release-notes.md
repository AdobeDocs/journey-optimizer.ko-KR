...
Journey Optimizer에서는 이 릴리스의 새로운 기능인 온보딩 도우미를 소개합니다.

<table>
<thead>
<tr>
<th><strong>온보딩 도우미</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
* **캠페인 대시보드의 브랜드 일관성 점수** - 이제 캠페인 대시보드에서 직접 브랜드 일관성 점수를 평가하여 콘텐츠가 브랜드에 부합하는지 확인할 수 있습니다. 이렇게 하면 콘텐츠 디자이너를 열지 않고도 가이드라인을 한눈에 검증할 수 있습니다. ([DOCAC-14516](https://jira.corp.adobe.com/browse/DOCAC-14516)) <!-- Documentation link: TBD -->
