...
* 이제 [의사 결정 관리]에 새 페이지를 사용할 수 있습니다. 오퍼 콘텐츠, 의사 결정 규칙 및 등급 공식에서 표현식을 작성할 때 지원되는 모든 연산자, 도우미 및 함수를 나열합니다. 런타임 오류를 방지하려면 이 목록을 사용하십시오. 의사 결정 관리에서는 문서화된 기능만 지원됩니다. [자세히 보기](../offers/personalization-editor-supported-functions.md)
