...
* 여정 또는 캠페인에서 추적을 활성화할 때, 조각에 링크가 있고 이 조각을 이메일에 사용하는 경우 이러한 링크가 메시지에 포함된 다른 모든 링크와 같이 추적된다는 내용의 메모가 조각 섹션에 추가되었습니다. [자세히 알아보기](../content-management/create-fragments.md#content)
