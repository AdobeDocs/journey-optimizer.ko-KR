...
* 프로필 및 보호 기능 시작 페이지에 데이터를 수집할 때 이메일이 대소문자를 구분한다는 메모를 추가했습니다. 즉, 해당 수신자를 타겟팅할 때 중복 프로필을 만들고 사용할 수 있습니다. [자세히 보기](../audience/get-started-profiles.md)
...
* Experimentation Accelerator 설명서가 별도의 컬렉션으로 재배치되었습니다. [자세히 보기](https://experienceleague.adobe.com/en/docs/experimentation-accelerator/using/overview)
