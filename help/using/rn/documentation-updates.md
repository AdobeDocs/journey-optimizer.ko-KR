...
* 명확성을 높이기 위해 콘텐츠 최적화 설명서를 재구성했습니다. 기본 최적화 페이지는 시작 페이지, 타겟팅에 대한 전용 페이지, 실험에 대한 페이지 및 두 접근 방식을 결합하기 위한 페이지 등 네 개의 집중 하위 페이지로 분할되었습니다. [자세히 보기](../campaigns/gs-message-optimization.md)

* 이제 이러한 기능을 일반적으로 사용할 수 있으므로 세 개의 여정 경고(여정 게시됨, 여정 완료됨 및 사용자 지정 작업 한도 트리거됨)에서 제한된 가용성 노트가 제거되었습니다. [자세히 보기](../reports/alerts.md)
...
* 캠페인의 최적화 페이지에 이제 여정에서도 최적화를 사용할 수 있다는 사실을 반영하여 업데이트했습니다. [자세히 보기](../campaigns/gs-message-optimization.md)

* 캠페인에서 메시지 최적화를 활용하는 방법을 설명하는 튜토리얼 비디오 링크를 추가했습니다. [자세히 보기](../campaigns/gs-message-optimization.md)
