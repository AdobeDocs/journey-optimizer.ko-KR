...
* 명확성을 높이기 위해 콘텐츠 최적화 설명서를 재구성했습니다. 기본 최적화 페이지는 시작 페이지, 타겟팅에 대한 전용 페이지, 실험에 대한 페이지 및 두 접근 방식을 결합하기 위한 페이지 등 네 개의 집중 하위 페이지로 분할되었습니다. [자세히 보기](../content-management/gs-message-optimization.md)
