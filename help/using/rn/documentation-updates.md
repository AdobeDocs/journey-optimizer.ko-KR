...
* 모바일 브라우저를 통해 액세스할 때 Gmail 또는 Outlook에서 이메일이 다르게 렌더링되는 이유를 설명하고 해결 방법 팁과 함께 새로운 **모바일 웹 브라우저 제한 사항** 섹션이 **이메일 렌더링 테스트** 페이지에 추가되었습니다. [자세히 보기](../content-management/rendering.md#rendering-limitations)
