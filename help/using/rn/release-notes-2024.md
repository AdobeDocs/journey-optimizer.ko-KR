...
* **이벤트의 조회 테이블** - 이제 개체 배열 내의 속성을 사용하여 관계를 정의한 경우 조회 데이터 세트의 데이터를 활용할 수 있습니다. 조회 값을 여정(조건, 사용자 정의 액션 등) 및 메시지 개인화에서 사용할 수 있게 될 예정입니다. [자세히 보기](../event/experience-event-schema.md#relationships_limitations)
...
<p>자세한 내용은 <a href="../start/ajo-use-case-guide.md#playbooks">세부 설명서</a>를 참조하십시오.</p>
