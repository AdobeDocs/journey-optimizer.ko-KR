...
## 2026년 9월 릴리스 정보 {#sep-26-updates}
...
<thead>
<tr>
<th><strong>여정 수준 홀드아웃(제한된 가용성)</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>이제 여정 속성에서 직접 여정에 대한 홀드아웃 그룹을 구성할 수 있습니다. 홀드아웃은 여정에 참여하지 않고 어떠한 커뮤니케이션도 받지 않는 타깃 대상자의 구성 가능한 비율입니다. Customer Journey Analytics 보고서에서 홀드아웃 프로필과 활성 프로필을 비교하여 여정이 제공하는 실제 효과, 즉 추가적인 성과를 측정할 수 있습니다.</p>
...
* **여정 시뮬레이션에서 의사 결정** - **최적화** 활동의 일부로 경로 실험이 이제 시뮬레이션에서 지원됩니다. 라우팅은 의사 결정(Decisioning)에 의해 처리되며 시뮬레이션된 사용자마다 임의적이고 비결정적입니다.
...
* **여정 시뮬레이션의 의사 결정** - 이제 의사 결정에 의존하는 여정을 시뮬레이션할 수 있습니다. 새로 지원되는 옵션은 다음과 같습니다.

  * 이제 콘텐츠 결정 노드가 시뮬레이션에서 지원됩니다.
  * 이제 시뮬레이션에서 최적화 활동의 타깃팅 규칙 방법이 지원됩니다.
  * Adobe Journey Optimizer이 결정하는 콘텐츠(예: 결정 정책을 사용하는 이메일)가 있는 작업은 이제 시뮬레이션에서 지원됩니다.
  * 오퍼 자격 및 규칙, 대상, 우선 순위 또는 수식별 순위를 사용하는 의사 결정 정책이 완전히 지원됩니다. AI 모델별 순위 - Personalization 도 지원되지만 반환된 오퍼가 실행 횟수에 따라 달라질 수 있습니다.

  [자세히 알아보기](../building-journeys/simulate-journey-gs.md)

  사용 가능한 날짜: 2026년 9월 8일
