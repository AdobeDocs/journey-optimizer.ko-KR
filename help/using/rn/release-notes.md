...
**릴리스 일자**: 2024년 10월 1일 수요일

### 새로운 기능 {#24-10-features}

이 업데이트는 아래에 설명된 새로운 기능을 제공합니다.
...
<thead>
<tr>
<th><strong>여정 및 캠페인에서의 승인(LA)</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
>
> [Journey Optimizer 새 보고 인터페이스를 시작하는 방법 알아보기](../reports/report-gs-cja.md)
...
* **IP 준비 계획** - 이제 Adobe **Healthcare Shield** 또는 **개인 정보 보호 및 보안 보호** 추가 기능 서비스를 구입한 조직을 포함하여 모든 고객이 이 기능을 사용할 수 있습니다. [자세히 알아보기](../configuration/ip-warmup-gs.md)