...
이번 릴리스에서는 오케스트레이션된 캠페인에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 향후 며칠 또는 몇 주 내에 추가 변경 사항이 있을 예정입니다.
...
이번 릴리스에서는 의사 결정에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 향후 며칠 또는 몇 주 내에 추가 변경 사항이 있을 예정입니다.
...
이번 릴리스에서는 이메일 채널에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 향후 며칠 또는 몇 주 내에 추가 변경 사항이 있을 예정입니다.
