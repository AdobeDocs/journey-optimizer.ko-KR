...
>[!NOTE]
>
>이 릴리스 정보에 나열된 기능에는 사용자의 환경에서 각 변경 사항에 액세스할 수 있는 시기를 나타내는 **사용 가능 날짜**&#x200B;가 포함됩니다. **준비 중**(으)로 표시된 항목이 며칠 후에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.

## 2026년 5월 릴리스 정보 {#may-26-rn}

### 여정 {#may-26-journeys}

이 릴리스의 여정에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 추가 변경 사항은 이번 달에도 타깃팅됩니다. 아래 [준비 중](#may-26-journeys-coming-soon) 섹션을 참조하십시오.
...
다음 여정 기능은 이달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
...
이 릴리스의 오케스트레이션된 캠페인에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 추가 변경 사항은 이번 달에도 타깃팅됩니다. 아래 [준비 중](#may-26-oc-coming-soon) 섹션을 참조하십시오.
...
다음 오케스트레이션된 캠페인 기능은 이달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
...
다음 캠페인 개선 사항은 이번 달 말에 릴리스될 예정입니다. 아래의 [곧 출시](#may-26-campaigns-coming-soon) 섹션을 참조하십시오.

#### 곧 출시 예정 {#may-26-campaigns-coming-soon}

다음 캠페인 개선 사항이 이번 달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
...
이 릴리스의 Decisioning에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 추가 변경 사항은 이번 달에도 타깃팅됩니다. 아래 [준비 중](#may-26-decisioning-coming-soon) 섹션을 참조하십시오.
...
다음 Decisioning 기능은 이달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
...
이 릴리스의 이메일 채널에 다음과 같은 기능 및 개선 사항이 추가되었습니다. 추가 변경 사항은 이번 달에도 타깃팅됩니다. 아래 [준비 중](#may-26-email-coming-soon) 섹션을 참조하십시오.
...
다음 이메일 채널 개선 사항이 이번 달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
...
다음 관리 개선 사항은 이번 달 말에 릴리스될 예정입니다. 아래의 [곧 출시](#may-26-admin-coming-soon) 섹션을 참조하십시오.

#### 곧 출시 예정 {#may-26-admin-coming-soon}

다음 관리 개선 사항이 이번 달 말에 릴리스될 예정입니다. 정보는 변경될 수 있습니다.
