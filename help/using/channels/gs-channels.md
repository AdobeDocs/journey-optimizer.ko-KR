...
iPhone 잠금 화면 및 Dynamic Island에서 직접 지속적인 실시간 업데이트를 제공합니다. 개별 사용 사례(주문 추적, 탑승 상태) 또는 브로드캐스트 사용 사례(스포츠 점수, 비행 상태)에 대해 API 트리거된 캠페인에서 라이브 활동 강화

[iOS Live 활동에 대해 자세히 알아보기](../mobile-live/get-started-mobile-live.md)
:::
...
개인화되고 규정을 준수하는 커뮤니케이션 캠페인 및 여정을 위해 Meta의 Cloud API를 통해 WhatsApp 메시지를 통합하고 사용하는 방법에 대해 알아봅니다.
...
캠페인 및 여정에서 효과적인 커뮤니케이션을 위해 LINE 메시지를 구성하고, 만들고, 개인화하는 방법에 대해 알아봅니다.
