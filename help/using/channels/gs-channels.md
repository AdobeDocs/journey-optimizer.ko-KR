...
iPhone 잠금 화면 및 Dynamic Island에 직접 지속적인 실시간 업데이트를 제공합니다. 개인별 사용 사례(주문 추적, 탑승 상태) 또는 브로드캐스트 사용 사례(스포츠 점수, 항공편 상태)를 위해 API로 트리거되는 캠페인에서 라이브 활동을 구현할 수 있습니다.

[iOS 라이브 활동에 대해 자세히 알아보기](../mobile-live/get-started-mobile-live.md)
:::
...
Meta의 Cloud API를 통해 WhatsApp 메시지를 통합 및 사용하여 개인화되고 규정을 준수하는 커뮤니케이션 캠페인을 수행하는 방법에 대해 알아봅니다.

[WhatsApp 메시지에 대해 자세히 알아보기](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
캠페인 및 여정의 효과적인 커뮤니케이션을 위해 LINE 메시지를 구성하고 만들고 개인화하는 방법을 알아봅니다.

[LINE 메시지에 대해 자세히 알아보기](../../rp_landing_pages/line-landing-page.md)
:::
...
| 채널 | 여정 | 액션 캠페인(마케팅) | 액션 캠페인(트랜잭션) | API로 트리거되는 캠페인 | 오케스트레이션된 캠페인 |
|----------------------|----------|------------------------------|----------------------------------|-------------------------|------------------------|
| 이메일 | ✅ | ✅ | ✅ | ✅ | ✅ |
| SMS | ✅ | ✅ | ✅ | ✅ | ✅ |
| 푸시 알림 | ✅ | ✅ | ✅ | ✅ | ✅ |
