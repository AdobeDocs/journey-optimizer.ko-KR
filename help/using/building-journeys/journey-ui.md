...
* 기존 여정을 복제하여 설정 재사용
* 일괄 작업 표시줄에서 선택한 여러 여정에 일괄 작업 적용: 패키지에 추가, 폴더로 이동, 태그 편집, 액세스 관리, 삭제, 일시 중지 또는 다시 시작
...
* **일괄 작업 모음**: 패키지에 추가, 폴더로 이동, 태그 편집, 액세스 관리, 삭제, 일시 중지 및 다시 시작을 제공하는 여정을 하나 이상 선택하면 여정 목록 맨 아래에 표시되는 작업 모음 *(제품별)*
* **일괄 일시 중지/다시 시작**: 일괄 작업 표시줄에서 사용할 수 있는 일시 중지 및 다시 시작 작업은 작업당 최대 10개의 [라이브 여정](일시 중지) 또는 [일시 중지된 여정](다시 시작)로 제한됩니다. *(제품별)*
...
* 참고: 패키지에 추가, 폴더로 이동, 태그 편집, 액세스 관리 및 삭제는 캠페인, 조각 및 템플릿 목록과 공유되며, 일시 중지 및 다시 시작은 여정에 따라 다릅니다
...
* **Q: 한 번에 여러 여정에서 수행할 수 있는 일괄 작업은 무엇입니까?** — 일시 중지 및 다시 시작 외에, 여러 여정을 선택하여 패키지에 추가하거나, 폴더로 이동하거나, 태그를 편집하거나, 액세스를 관리하거나, 여정 목록 하단의 일괄 작업 표시줄을 사용하여 삭제할 수 있습니다.
