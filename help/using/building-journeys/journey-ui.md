...
여정 목록에서 확인란을 사용하여 한 번에 여러 항목을 선택하고 화면 하단에 나타나는 벌크 작업 표시줄에서 모든 항목에 작업을 적용할 수 있습니다.

![여러 여정이 선택된 일괄 작업 모음](assets/bulk-actions-journeys.png)

다음 작업을 사용할 수 있습니다.

* **[!UICONTROL 패키지에 추가]** - 선택한 여정을 다른 샌드박스로 내보냅니다. [개체를 내보내는 방법 알아보기 →](../configuration/copy-objects-to-sandbox.md)
* **[!UICONTROL 폴더로 이동]** - 선택한 여정을 폴더로 이동합니다. [폴더 작업 방법 →](#journeys-folders)
* **[!UICONTROL 여정 편집]** - 선택한 태그에 할당된 태그를 편집합니다. [태그를 사용하는 방법 알아보기 →](../start/search-filter-categorize.md#add-tags)
* **[!UICONTROL 액세스 관리]** - 선택한 여정에 액세스 레이블을 적용합니다. [개체 수준 액세스 제어에 대해 자세히 알아보기 →](../administration/object-based-access.md)
* **[!UICONTROL 삭제]** - 선택한 여정을 영구적으로 삭제합니다.
* **[!UICONTROL 일시 중지]** - 선택한 **Live** 여정 일시 중지(_일괄 일시 중지_). **Live** 여정을 선택한 경우에만 사용할 수 있습니다.
* **[!UICONTROL 다시 시작]** - 선택한 **일시 중지됨**&#x200B;개 여정 다시 시작(_일괄 다시 시작_). **일시 중지됨** 여정을 선택한 경우에만 사용할 수 있습니다.

![아래쪽 표시줄에서 두 개의 라이브 여정 일괄 일시 중지](assets/bulk-pause-journeys.png)

[일시 중지/다시 시작 여정에 대해 자세히 알아보세요](journey-pause.md). [다른 일괄 작업에 대해 자세히 →](../start/search-filter-categorize.md#bulk-actions)

>[!NOTE]
>
>작업당 최대 10개의 여정을 일시 중지/다시 시작할 수 있습니다.
