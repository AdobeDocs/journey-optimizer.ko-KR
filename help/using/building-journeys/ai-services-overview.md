...
[!DNL Intelligent Services]에 빌드된 [!DNL Adobe Experience Platform]은(는) 고객 경험 팀에 AI-as-a-service를 제공합니다. 이는 고객 행동을 예측하고, 캠페인 영향을 측정하고, 투자 수익을 개선하는 데 도움이 됩니다. 자세한 내용은 [[!DNL Adobe Experience Platform] 설명서](https://experienceleague.adobe.com/docs/experience-platform/intelligent-services/home.html){target="_blank"}를 참조하세요.
