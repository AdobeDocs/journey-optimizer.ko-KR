...
* **[!UICONTROL 삭제]**: **[!UICONTROL 추가 작업]**&#x200B;에서 활성 인벤토리에서 조각을 삭제합니다(...) 아이콘.
...
>title="여정 조각 추가"
>abstract="선택기에서 **[!UICONTROL 활성]** 조각만 사용할 수 있습니다. 조각을 삽입하면 해당 노드의 **정적 사본**&#x200B;이 만들어집니다. 원본 조각에 대한 이후의 모든 업데이트는 여정에 반영되지 않습니다."
