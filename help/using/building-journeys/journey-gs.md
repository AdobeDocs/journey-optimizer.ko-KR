...
* **완료됨**: 91일 이후 여정이 자동으로 이 상태로 전환됩니다 [기본 시간 초과](journey-gs.md#global_timeout). 이미 여정에 있는 프로필은 여정을 정상적으로 완료합니다. 새 프로필은 더 이상 여정에 들어갈 수 없습니다.
...
이외에도 [timeout](#timeout_and_error) 또한 여정 활동에 사용되며, 인터페이스에 표시되지 않고 변경할 수 없는 글로벌 여정 시간 초과가 있습니다.
