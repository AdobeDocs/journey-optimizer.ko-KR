...
* 다음 단계는 푸시 메시지여야 합니다. 다른 채널, 활동 또는 단계는 허용되지 않습니다(선택 사항 제외) **종료** 활동).
...
## 여정 종료, 중지 또는 닫기{#end-journey}

여정은 두 개의 특정 컨텍스트에서 개인에 대해 종료될 수 있습니다.

* 사람이 경로의 마지막 활동에 도달합니다. 마지막 활동은 다음과 같은 것일 수 있습니다 **종료** 활동 또는 다른 활동입니다. 사용 **종료** 활동은 필수가 아닙니다. [이 페이지](../building-journeys/end-activity.md)를 참조하십시오.
...
여정을 닫으면(위의 이유 중 하나) 상태가 됩니다 **[!UICONTROL Closed]**. 여정은 새 개인이 여정에 들어갈 수 있도록 하는 것을 중지합니다. 여정에 이미 있는 사람은 여정을 정상적으로 완료할 수 있습니다. 기본 글로벌 시간 초과 30일 이후에는 여정이 **완료됨** 상태. 다음 보기 [섹션](../building-journeys/journey-gs.md#global_timeout).
