...
* 게시하기 전에 합성 테스트 프로필과 함께 테스트 모드를 사용하여 여정 테스트
...
* **테스트 모드**: 라이브 커뮤니케이션을 활성화하지 않고 가상 테스트 프로필을 사용하여 여정 실행을 시뮬레이션하는 유효성 검사 모드 *(제품별)*
...
* 혼동하지 마십시오: &quot;테스트 모드&quot; ≠ &quot;시험 실행&quot; — 테스트 모드는 합성 프로필을 사용하고 시험 실행은 고객에게 연락하지 않고 실제 생산 데이터를 사용합니다.
...
* **Q: 여정이 라이브로 전환되기 전에 테스트할 수 있습니까?** — 예. 테스트 모드를 합성 테스트 프로필과 함께 사용하여 여정을 단계별로 진행하거나, 시험 실행을 사용하여 통신을 보내지 않고 실제 프로덕션 데이터에 대해 실행합니다.
