...
여정 관리 메뉴 섹션에서 **[!UICONTROL 여정]**&#x200B;을(를) 클릭합니다. 사용 가능한 두 가지 탭은 다음과 같습니다.
...
* **Live**: **Publish** 단추를 사용하여 여정을 게시했습니다.
...
1. **찾아보기** 탭에서 **[!UICONTROL 여정 만들기]**&#x200B;를 클릭하여 새 여정을 만듭니다.

1. 오른쪽에 표시되는 구성 창에서 여정의 속성을 편집합니다. 이 [이 여정](journey-properties.md)에서 페이지의 속성을 설정하는 방법을 알아보세요.
...
1. 개인이 수행할 다음 단계를 드래그 앤 드롭합니다. 예를 들어 채널 작업 뒤에 조건을 추가할 수 있습니다. 활동에 대한 자세한 내용은 [이 섹션](using-the-journey-designer.md)을 참조하세요.

1. 테스트 프로필을 사용하여 여정을 테스트합니다. 이 [섹션](testing-the-journey.md)에서 자세히 알아보기

1. 여정을 Publish에 추가하여 활성화하십시오. 이 [섹션](publishing-the-journey.md)에서 자세히 알아보세요.

   ![](assets/jo-journeyuc2_32bis.png)

1. 전용 보고 도구를 사용하여 여정을 모니터링하여 여정의 효율성을 측정합니다. 이 [섹션](../reports/live-report.md)에서 자세히 알아보세요.
