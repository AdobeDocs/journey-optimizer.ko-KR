...
1. 지정된 시간 제한 내에 이벤트가 수신되지 않을 때 개인 사용자를 시간 제한 경로로 보내려면 **[!UICONTROL 시간 제한 경로 설정]** 옵션을 선택합니다. 이 옵션이 활성화되지 않은 경우 시간 초과에 도달하면 개인에 대한 여정이 계속됩니다. 항상 을(를) 활성화하도록 다시 명령합니다. **시간 제한 경로 설정** 옵션을 선택합니다.
...
* 시간 제한 기간 내에 하나의 이벤트가 표시되면 개인이 수신된 이벤트의 경로로 이동합니다.
