...
description: Adobe Journey Optimizer의 AI를 사용하여 자연어 프롬프트를 사용하여 여정 고급 표현식 편집기에서 직접 표현식을 생성하는 방법에 대해 알아봅니다.
feature: Journeys
...
# AI를 사용하여 표현식 생성 {#generate-expression}
...
>[!IMPORTANT]
>
>이 기능을 사용하기 전에 Journey Optimizer의 생성 AI 기능에 적용되는 관련 [보호 기능 및 제한 사항](../../content-management/gs-generative.md#generative-guardrails)을 읽어 보십시오.

여정 고급 표현식 편집기에 내장된 이 AI 기반 기능은 일반 언어 프롬프트에서 유효한 표현식을 생성하는 데 도움이 됩니다.
...
### 대상자 멤버십 프롬프트 {#example-prompts-audience}

일반 언어로 만들려는 대상 멤버십 검사에 대해 설명합니다. 예:

* *&quot;Gold Loyalty 대상에 프로필이 있는지 확인&quot;*
