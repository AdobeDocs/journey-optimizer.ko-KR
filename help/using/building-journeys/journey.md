...
[유효성 검사 방법을 →](choose-validation-method.md) | [여정 테스트 →](testing-the-journey.md) | [시험 실행 →](journey-dry-run.md)에 대해 알아보기
