...
Adobe Journey Optimizer은 서로 다른 특성과 보호 기능을 갖는 세 가지 유형의 대상을 지원합니다.
...
* **대상 여정 읽기**: 세 가지 대상 유형이 모두 지원됩니다. 여정 실행 시 일괄 내보내기가 수행됩니다.
* **대상 자격 여정**: 스트리밍 대상 권장, 일괄 처리 대상에 자격 감지 지연, 업로드 대상 지원되지 않음
...
[대상자](../audience/about-audiences.md), [세그먼트 만들기](../audience/creating-a-segment-definition.md) 및 [사용자 지정 업로드 대상자](../audience/custom-upload.md)에 대해 자세히 알아보세요.
