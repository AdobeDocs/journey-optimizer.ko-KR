...
전체 비교를 위해 [유효성 검사 방법 선택](choose-validation-method.md)을 참조하거나 [시뮬레이션](simulate-journey-gs.md), [테스트 모드](testing-the-journey.md) 및 [시험 실행](journey-dry-run.md)에 대해 자세히 알아보세요.
