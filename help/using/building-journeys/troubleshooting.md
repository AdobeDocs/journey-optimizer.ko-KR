...
Journey reporting measures the progress of individuals inside a journey. 사람들이 어디에서 왜 멈췄는지를 쉽게 파악할 수 있습니다.
...
* [!DNL Journey Optimizer] In the sending logs of the message, you can see the status of each execution. 녹색인지, 빨간색인지 그리고 무엇이 문제인지를 볼 수 있습니다. 비즈니스 사용자는 이 화면에 액세스하고 추가 조사를 위해 관리자에게 로그를 보낼 수 있습니다.
