...
* **조건 기반** - 일정 기간 동안 활동이 없거나 프로필 특성이 변경되는 등 [특정 조건](conditions.md)이 충족되면 프로필이 종료됩니다.
...
* **[여정 기반 트리거](../event/about-events.md)**: &quot;프로필 만들기&quot;, &quot;트랜잭션 완료&quot; 또는 사용자 지정 이벤트와 같은 이벤트를 사용하여 이벤트를 시작합니다. [**[!UICONTROL 관리]** > **[!UICONTROL 이벤트]**&#x200B;에서 이벤트를 구성](../event/about-creating.md)하고 [이벤트 스키마 및 필드를 정의](../event/experience-event-schema.md)합니다. 그런 다음 [여정 디자이너](using-the-journey-designer.md)의 **[!UICONTROL 이벤트]** 팔레트에서 이벤트를 추가합니다.

* **[대상 기반 항목](read-audience.md)**: 특정 대상에 속하는 프로필에 대한 여정을 일회성 배치로 또는 되풀이하는 일정으로 타깃팅합니다. [대상자 만들기](../audience/creating-a-segment-definition.md)(**[!UICONTROL 대상자]**) 메뉴에서 **[!UICONTROL 대상자 읽기]** 활동을 추가한 다음 [일정을 구성](journey-properties.md#schedule). 입력한 후 [분기 세그먼트, 제외 또는 병합](read-audience.md#audience-targeting-in-journeys)에 조건을 사용하십시오.
...
* **[특성 필터](conditions.md)**: AND/OR 논리를 사용하여 이벤트 또는 대상을 프로필 특성 및 컨텍스트와 결합하여 항목 기준을 구체화합니다. [조건](conditions.md)을(를) 사용하여 [프로필 특성](../audience/get-started-profiles.md), 이벤트 또는 [외부 데이터](../datasource/about-data-sources.md)를 참조합니다.
...
* **[비활성 시간 초과](wait-activity.md)**: 설정된 일정 내에 참여가 발생하지 않으면 프로필을 종료합니다. 마지막 참여 날짜를 확인하는 대상자와 함께 [종료 기준](journey-properties.md#exit-criteria)을 사용하고 정의된 기간이 있는 [대기 활동](wait-activity.md)을 설정하고 [조건](conditions.md)을 사용하여 활동을 확인하세요.
