...
**종료 날짜**&#x200B;를 추가할 수도 있습니다. 이렇게 하면 해당 일자가 되었을 때 프로필이 자동으로 종료됩니다. 종료 날짜를 지정하지 않으면 [전역 여정 제한 시간](#global_timeout)(일반적으로 91일)까지 프로필을 유지할 수 있습니다. 유일한 예외는 **되풀이 시 강제 재입력**&#x200B;이 활성화된 되풀이 대상 여정 읽기이며, 다음 발생의 시작 날짜에 끝납니다.
...
마케터는 여정의 목적이 더 이상 충족되지 않으면 여정에서 프로필을 제거하려는 경우가 많습니다. 목표 관리와 밀접하게 연관된 **전역 종료 기준**&#x200B;을 통해 이를 달성할 수 있습니다.
...
종료 기준은 여정 수준에서 설정됩니다. 한 여정에 여러 종료 기준이 있을 수 있습니다. 여러 종료 기준을 설정한 경우 OR 논리를 사용하여 위에서 아래로 평가가 수행됩니다. 따라서 종료 기준 n°1과 종료 기준 n°2가 있는 경우 n°1 **또는** n°2로 평가됩니다. 기준은 여정의 모든 단계에서 평가됩니다.

종료 기준을 **만들기**&#x200B;하려면:

* 오른쪽 레일에서 다음 아이콘 ![](assets/exitcriteria_icon.png){width="40%" align="left"}을(를) 클릭합니다.
* **종료 기준 추가** 단추를 클릭합니다.

![](assets/exitcriteria.png){width="40%" align="left"}

* 여러 종료 기준을 추가할 수 있습니다.
* **레이블**&#x200B;을(를) 입력하고 종료 기준이 이벤트나 대상을 기반으로 하는지 선택합니다.
...
참고: 대상을 사용한 종료 기준은 작동하는 데 최대 10분이 걸릴 수 있습니다.

### 제한 및 제한 사항

* 종료 기준은 초안 상태에서 정의됩니다
