...
## 일시 중지된 여정에서 종료 기준 적용 {#journey-global-filters}
...
1. **종료 기준** 아이콘을 선택하십시오.
   ...
   ![일시 중지된 여정에 프로필 특성 종료 기준을 추가합니다](assets/add-global-filter.png)
