...
| [단일 이벤트](general-events.md) | <ul> <li>첫 번째 노드에서: 이벤트가 삭제됩니다.</li> <br><li>다른 노드: 라이브 여정과 동일한 동작이지만 이벤트가 <strong>Action</strong> 활동 이후이고 사용자가 해당 작업에서 일시 중지된 경우에는 이벤트가 무시됩니다. </li></ul> |
