...
* **승인 정책 준수** — 여정이 승인 정책의 적용을 받는 경우 게시에서 승인을 위해 즉시 게시하지 않고 제출합니다. 승인자가 로그오프하면 여정이 자동으로 게시됩니다. 이후에 수행할 별도의 게시 단계는 없습니다. [자세히 알아보기](../test-approve/gs-approval.md)
...
| --- | --- | --- | --- |
| [시뮬레이션](simulate-journey-gs.md) | 수동으로 생성되거나 자동 생성된 임시 시뮬레이션된 사용자 | 여정 설계 시 빠른 반복 — AEP 테스트 프로필을 만들거나 프로파일과 함께 전파될 때까지 기다릴 필요 없음 | 예 — 시뮬레이트된 사용자 레벨에서 정의된 실행 주소로 |
...
1. 여정을 게시하려면 오른쪽 상단 드롭다운 메뉴에 있는 **[!UICONTROL 게시]** 옵션을 클릭합니다.
   ...
   >[!NOTE]
   >
   > 여정에 승인 정책이 적용되어 있는 경우 **[!UICONTROL 게시]**&#x200B;를 클릭하면 여정을 즉시 게시하지 않고 승인을 위해 제출합니다. 승인자가 로그오프하면 여정이 자동으로 게시됩니다. 다시 게시할 필요가 없습니다. [자세히 알아보기](../test-approve/gs-approval.md)
...
여정이 승인 정책의 적용을 받는 경우 **[!UICONTROL 게시]**&#x200B;를 클릭하면 바로 게시하지 않고 승인을 위해 제출됩니다. 승인자가 로그오프하면 여정이 자동으로 게시됩니다. 이후에 수행할 별도의 게시 단계는 없습니다. [승인에 대해 자세히 알아보기](../test-approve/gs-approval.md).
...
* **Q: 게시하기 전에 승인이 필요합니까?** — 여정이 승인 정책의 대상인 경우에만 게시가 승인을 위해 여정을 즉시 게시하지 않고 제출하며 승인자가 로그오프하면 자동으로 게시됩니다.
