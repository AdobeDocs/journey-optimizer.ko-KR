...
**대상 자격** 이벤트 활동을 사용하여 개인이 Adobe Experience Platform 대상 출입구를 기준으로 여정에 들어오거나 앞으로 이동하도록 할 수 있습니다. 모든 신규 실버 고객이 여정을 입력하고 개인화된 메시지를 보내도록 할 수 있습니다. 이 [섹션](audience-qualification-events.md)에서 자세히 알아보세요.

### 오케스트레이션{#jo-orch}

오케스트레이션 활동은 여정의 다음 단계를 결정하는 데 도움이 되는 다양한 조건입니다.

오케스트레이션 활동에서 **대상 읽기** 활동을 사용하여 Adobe Experience Platform 대상을 수신하도록 여정을 설정합니다. [대상자 읽기 활동에 대해 자세히 알아보기](read-audience.md).
