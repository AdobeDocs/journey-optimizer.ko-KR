...
>[!TIP]
>
>여정 시작 및 종료 기준을 처음 사용하십니까? 실제 사용 사례, 모범 사례 및 단계별 구성 지침을 포함하는 [여정 시작 및 종료 기준에 대한 포괄적인 안내서](entry-exit-criteria-guide.md)로 시작하십시오.
...
<tr style="border: 0;">
  <td>
    ...
    <br>일반적인 패턴과 확장 가능한 접근 방식을 학습하여 [!DNL Adobe Journey Optimizer]에서 경험 이벤트를 최대한 활용할 수 있습니다. 이러한 사용 사례는 옵트아웃 관리, 메시지 빈도 제어, 사용자 행동을 기반으로 콘텐츠 개인화, 실시간 신호 반응과 같은 자주 발생하는 문제를 해결하는 데 도움이 되도록 설계되었습니다.
    </div>
      <div>
...
<img alt="평일에만 이메일 보내기" src="../assets/do-not-localize/icon-first-journey.svg">
</a>
<div>
<a href="weekday-email-uc.md"><strong>평일에만 전자 메일 보내기</strong></a>
</div>
<p>
</td>
<td></td>
...
비디오 튜토리얼을 탐색하여 [!DNL Adobe Journey Optimizer]에서 가장 일반적인 사용 사례를 빌드하는 주요 단계를 알아보세요.
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <br/>
      <strong>포기한 장바구니</strong><br/><p>[!DNL Adobe Journey Optimizer]의 플레이북 기능을 사용하여 포기한 장바구니 사용 사례를 구현하는 방법을 알아봅니다.</p><a href="https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/use-cases/abandoned-cart" target="_blank">사용 사례 비디오 보기</a>
    </td>
    <td>
  ...
  <tr style="border: 0;">
    ...
    <br/>
      <strong>실시간 오퍼 개인화</strong><br/><p>[!DNL Adobe Journey Optimizer]에서 날씨 관련 데이터를 사용하여 서비스를 제공하면 기업이 실제 환경 조건을 기반으로 고객 경험을 개인화할 수 있습니다.</p><a href="https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction" target="_blank">단계별 자습서 팔로우</a>
    </td>
    <td>
      <img src="../assets/do-not-localize/icon-configure.svg" width="35px">
    <br/>
      <strong>의사 결정을 통해 게재된 오퍼 추적 및 보고</strong><br/><p>[!DNL Adobe Journey Optimizer]을(를) 통해 제공되는 오퍼에 대한 보고 및 성능 분석을 사용하도록 설정: 상황에 맞는 신호를 기반으로 오퍼가 개인화되고 제공되면 노출 횟수와 사용자 상호 작용을 모두 추적하여 효과를 평가해야 합니다.</p><a href="https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/reporting-on-ajo-od/introduction" target="_blank">단계별 자습서 팔로우</a> 
    </td>
    <td>
      <img src="../assets/do-not-localize/icon_profile-audience.svg" width="35px">
    <br/>
      <strong>등급 수식으로 오퍼 개인화</strong><br/><p>[!DNL Adobe Journey Optimizer] 내에서 우편 번호 및 연간 소득과 같은 사용자 특성을 활용하여 개인화된 금융 오퍼를 제공하는 방법을 알아봅니다. 등급 수식을 사용하면 위치별 프로모션 및 소득 기반 자격 조건을 기반으로 오퍼에 지능적으로 점수가 매겨지고 우선 순위가 지정됩니다.</p><a href="https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction" target="_blank">단계별 자습서 팔로우</a> 
    </td>
  </tr>
</table>

[오케스트레이션을 옴니채널 참여로 크기 조정 [!DNL Adobe Journey Optimizer]](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction){target="_blank"}에 대한 비디오 튜토리얼도 참조하세요. 6개의 레슨 과정을 통해 비즈니스 커뮤니케이션을 간단한 아웃바운드 메시지에서 정교한 옴니채널 경험으로 향상시키는 방법을 배웁니다. 실용적인 예제를 통해 사전 예방적 지원 활동과 반응형 참여를 원활하게 통합하는 고객 여정을 만드는 통찰력을 얻을 수 있습니다.
...
<p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/take-flight-with-personalization-how-airlines-can-elevate-offers/ba-p/767513?profile.language=ko" target="_blank">Personalization 항공편 이용: 항공사가 오퍼를 향상시키는 방법 [!DNL Adobe Journey Optimizer]
</a></p>
<p><a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/mastering-real-time-personalization-a-marketer-s-guide-to-aem/ba-p/762606?profile.language=ko" target="_blank">실시간 Personalization 마스터링: AEM 콘텐츠 조각 및 [!DNL Adobe Journey Optimizer]
</a></p>
</div>
<p></td>
<td>
...
- **TL;DR:** 이 페이지는 실무자가 Adobe Journey Optimizer을 최대한 활용할 수 있도록 경험 이벤트, 데이터 세트 쿼리, 비즈니스 시나리오, 기술 패턴, 비디오 튜토리얼 및 커뮤니티 블로그 게시물을 다루는 실제 여정 사용 사례를 선별한 라이브러리입니다.

**의도:**
- 멀티채널 메시지, 구독자 캠페인 및 평일 전용 이메일 게재와 같은 비즈니스 시나리오에 대한 실용적인 사용 사례 예를 살펴보십시오
- 라이브 여정에서 사용자 지정 작업, 처리량 제한 및 프로필 제거에 대한 기술 사용 사례 패턴을 찾습니다
- 고객 온보딩, 장바구니 포기 및 재참여를 포함한 일반적인 여정 패턴에 대한 비디오 튜토리얼에 액세스합니다
- Adobe Journey Optimizer 데이터 세트(단계 이벤트, 추적 이벤트, 오퍼 제안)를 쿼리하여 사용자 지정 분석 및 보고를 빌드합니다
- 경험 이벤트 조회 패턴을 사용하여 옵트아웃, 빈도 및 실시간 개인화를 관리합니다.

**용어집:**
- **경험 이벤트**: Adobe Experience Platform에 저장되고 여정 *(제품별)을 트리거하거나 개인화하는 데 사용되는 고객 인터랙션(예: 구매, 클릭, 페이지 보기)에 대한 타임스탬프가 있는 레코드*
- **단계 이벤트**: 프로필이 여정에서 취하는 모든 단계를 캡처하는 자동으로 생성된 데이터 세트 레코드로, 사용자 지정 보고 및 디버깅에 사용됩니다&#x200B;*(제품별)*
- **사용자 지정 작업**: 외부 API를 호출하여 데이터를 서드파티 시스템 *(제품별)*(으)로 보내거나 서드파티 시스템으로부터 받는 여정 활동

**보호 기능:**
- 각 사용 사례 예에는 규범적 구성이 아니라 시작점이며 특정 요구 사항에 맞게 조정되어야 하는 권장 사항이 포함되어 있습니다
- 데이터 세트 쿼리를 사용하려면 Adobe Experience Platform 쿼리 서비스에 액세스해야 합니다.
- 비디오 튜토리얼은 Experience League의 외부 학습 리소스를 참조합니다

**용어:**
- 정식 이름: 사용 사례 — 약어: 없음 — 변형: 여정 사용 사례, 실제 예, 레서피
- 동의어: &quot;비즈니스 사용 사례&quot; = &quot;마케팅 사용 사례&quot;; &quot;기술 사용 사례&quot; = &quot;개발자 사용 사례&quot;

**FAQ:**
- **Q: 여정 시작 및 종료 기준을 처음 사용하는 경우 어디서 시작해야 합니까?** — 실제 사용 사례, 모범 사례 및 단계별 구성 지침을 포함하는 여정 시작 및 종료 기준에 대한 포괄적인 안내서부터 시작합니다.
- **Q: 사용자 지정 보고를 위해 여정 단계 이벤트를 쿼리하려면 어떻게 합니까?** — Adobe Experience Platform 쿼리 서비스를 사용하여 여정 단계 이벤트 데이터 세트를 쿼리합니다. 예제 쿼리는 연결된 데이터 세트 쿼리 예제 페이지에서 사용할 수 있습니다.
- **Q: 평일에만 전자 메일을 보내는 사용 사례를 어디에서 찾을 수 있습니까?** — 커뮤니티 블로그 게시물로 사용할 수 있는 평일 이메일 사용 사례 페이지를 참조하십시오.
- **Q: 라이브 여정에서 프로필을 제거하려면 어떻게 해야 합니까?** — 라이브 프로필에서 여정을 제거하는 기술 사용 사례에 설명된 대로 일시 중지된 여정에서 프로필 속성 종료 기준 기능을 사용합니다.
