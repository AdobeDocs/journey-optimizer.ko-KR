...
>title="메시지 활동"
>abstract="Journey Optimizer에는 메시지 기능이 내장되어 있습니다. 여정에서 푸시, 텍스트 메시지, 인앱 또는 이메일 메시지 활동을 추가하고 설정 및 콘텐츠를 정의할 수 있습니다. 그런 다음 여정의 맥락에서 자동으로 실행되고 전송됩니다."
...
1. 활동을 구성합니다. 다음 페이지에서 메시지 콘텐츠를 만드는 자세한 단계를 배웁니다.
   ...
   <div>
   <a href="../sms/create-sms.md"><strong>텍스트 메시지 만들기</strong></a>
   </div>
   <p>
   </td>
   </tr>
