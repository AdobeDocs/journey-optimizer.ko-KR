...
프로필은 창 외부에 있는 최적의 열기 시간을 가질 수 있습니다. 예를 들어, John은 오후 5시에 클릭에 최적 상태로 열려 있습니다.

프로필 수준에서는 매시간 매시간 점수가 있습니다. 이 예에서는 항상 창 내에서 이메일이 전송됩니다. 런타임에 시스템은 해당 창(오전 10시부터 3시간 창)의 점수 목록을 확인합니다. 이어 10, 11, 12를 비교한 뒤 점수가 가장 높은 것을 판별한다. 해당 시간에 이메일이 전송됩니다.
