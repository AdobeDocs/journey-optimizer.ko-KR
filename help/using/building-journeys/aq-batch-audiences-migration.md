...
>[!CAUTION]
>
>**시행일: 2026년 9월** 대상 자격 노드 또는 종료 기준에서 배치 대상을 사용하는 새 여정, 초안 노드 및 중복 지표는 이 날짜 이후에 게시할 수 없습니다. 2026년 6월 릴리스 이후 여정 캔버스에 유효성 검사 경고가 이미 표시되어 있습니다.
...
**[종료 기준](journey-properties.md#exit-criteria)**&#x200B;은(는) 시작 노드와 동일한 **[!UICONTROL 대상 자격]** 메커니즘을 사용하므로 동일한 제한 사항이 적용됩니다. 앞으로 **[!UICONTROL 종료 기준]**&#x200B;을 구성할 때 스트리밍 대상을 사용하십시오.

## 여정 영향 방식 {#impact}

대상 자격 노드 또는 종료 기준에서 배치 대상을 사용하는 라이브 여정은 2026년 9월 이후에도 계속 실행됩니다. 그러나 여정을 중지, 복제 또는 다시 게시하는 경우 구성이 업데이트될 때까지 차단됩니다.


| 여정 상태 | 2026년 9월 이후의 영향 |
| --- | --- |
