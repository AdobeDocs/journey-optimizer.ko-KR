...
1. 다음 **[!UICONTROL 세그먼트 읽기]** 활동을 통해 세그먼트가 여정을 입력하는 시간을 지정할 수 있습니다. 이렇게 하려면 **[!UICONTROL 여정 일정 편집]** 여정 속성에 액세스한 다음 **[!UICONTROL 스케줄러 유형]** 필드.
   ...
   **증분 읽기** 옵션: 여정에 반복이 있는 경우 **세그먼트 읽기** 는 처음으로 실행되며, 세그먼트의 모든 프로필이 여정을 입력합니다. 이 옵션을 사용하면 여정의 마지막 실행 이후 세그먼트에 입력한 개인만 타겟팅할 수 있습니다.
...
>[!NOTE]
>
>일회성 읽기 세그먼트 여정은 여정 실행 후 30일 후에 완료됨 상태로 이동합니다. 예약된 읽기 세그먼트의 경우 마지막 항목이 실행된 후 30일이 경과한 시점입니다.
