...
테스트 프로필만 테스트 모드에서 여정을 입력할 수 있습니다. 새 테스트 프로필을 만들거나 기존 프로필을 테스트 프로필로 전환할 수 있습니다. 다음을 참조하십시오 [섹션](../building-journeys/creating-test-profiles.md).
...
* 실시간 고객 프로필 서비스에서 &quot;테스트 프로필&quot;로 플래그가 지정된 개인만 테스트된 여정을 입력할 수 있습니다. 다음을 참조하십시오 [섹션](../building-journeys/creating-test-profiles.md).
