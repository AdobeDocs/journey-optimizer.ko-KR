...
* **활성 날짜 기간** - 테스트 모드를 시작할 때 여정이 구성한 [시작 및 종료 날짜/시간](journey-properties.md#dates) 창에 현재 시간이 포함되어 있는지 확인합니다. 그렇지 않으면 트리거된 테스트 이벤트가 자동으로 삭제됩니다. 이 문제 해결에 대해 자세히 알아보세요[이 페이지의](troubleshooting-execution.md#troubleshooting-test-transitions).
