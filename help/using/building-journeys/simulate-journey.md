...
1. **[!UICONTROL 이벤트 구성]**&#x200B;을 클릭하여 편집기를 열고 필요에 따라 이벤트를 조정합니다. 시뮬레이션된 특정 사용자에 대한 페이로드만 변경하려면 해당 사용자 옆의 ![이벤트 편집](assets/do-not-localize/Smock_Edit_18_N.svg)을 클릭합니다.

   ![이벤트 선택을 위한 필드 및 드롭다운이 있는 이벤트 구성 인터페이스](assets/simulate-9.png)

1. **[!UICONTROL 트리거 이벤트]** 보기에서 실행에 포함할 시뮬레이션된 사용자를 지정합니다. 이벤트 구성은 한 번에 하나의 이벤트에 적용됩니다. 선택한 이벤트 또는 포함된 사용자 집합을 수정하면 이전에 입력한 필드 값이 재설정됩니다. 선택 항목을 변경하기 전에 현재 구성을 완료합니다.

   ![테스트 사용자 목록 및 이벤트 필드를 사용한 이벤트 구성](assets/simulate-8.png)

1. **[!UICONTROL 완료]**&#x200B;를 클릭합니다.

1. 그런 다음 **[!UICONTROL 테스트 이벤트]**&#x200B;에서 **[!UICONTROL 모두 보내기]**&#x200B;를 선택하여 **[!UICONTROL 여정 테스트]**&#x200B;에 나열된 모든 시뮬레이션된 사용자를 테스트로 보내거나 ![단일 사용자에 대한 보내기 아이콘](assets/do-not-localize/Smock_Send_18_N.svg)을 선택하여 해당 사용자에 대한 시뮬레이션만 실행하십시오.
