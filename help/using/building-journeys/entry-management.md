...
* **다시 시작 대기 기간**: 프로필이 여정에 다시 들어가기까지 경과해야 하는 최소 시간입니다. 기본값은 5분이고, 최대값은 91일입니다. *(제품별)*
...
* 대상 여정 읽기: 샌드박스 수준에서 최대 20,000TPS입니다.
* 대상 자격 및 단일 이벤트 여정: 조직 수준에서 최대 5,000개의 TPS를 공유합니다.
* 비즈니스 이벤트는 5,000개의 TPS 할당량에 포함됩니다. 이후의 대상자 읽기 활동은 20,000개의 TPS 제한을 따릅니다.
* 기본 재입력 대기 시간은 5분이며, 최대값은 91일입니다(전역 시간 초과).
...
* **Q: 기본 재등록 대기 기간은 무엇입니까?** — 5분, 최대 91일까지 구성 가능
