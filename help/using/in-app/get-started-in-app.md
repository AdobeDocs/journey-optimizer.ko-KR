---
title: 인앱 메시지 시작
description: Journey Optimizer를 사용하여 인앱 알림을 전송하는 방법 알아보기
feature: Overview
...
Journey Optimizer를 사용하여 인앱 알림을 만들고 메시지 레이아웃 및 표시, 텍스트 및 단추 옵션을 비롯한 경험 옵션을 구성합니다.
...
* 인앱 채널을 구성합니다. [추가 정보](inapp-configuration.md)

* 시작하기 전에 Journey Optimizer 캠페인에 대한 올바른 권한이 있는지 확인하십시오. [추가 정보](../campaigns/get-started-with-campaigns.md#campaign-prerequisites)
