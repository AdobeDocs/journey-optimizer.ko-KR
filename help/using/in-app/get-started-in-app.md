...
* **[인앱 콘텐츠 디자인](design-in-app.md)** - 인앱 메시지 레이아웃, 스타일, 단추 및 대화형 요소를 사용자 지정합니다.
* **[웹용 인앱](create-in-app-web.md)** - 웹 응용 프로그램용 인앱 메시지를 만들고 전달하는 방법을 알아봅니다.
* **[인앱 채널 튜토리얼](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/channels/in-app-channel/in-app-messages-overview){target="_blank"}** - 인앱 메시지 기능 및 모범 사례에 대한 단계별 비디오 튜토리얼을 살펴보십시오.
