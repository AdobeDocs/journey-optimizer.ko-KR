...
title: 채널 활동 사용
description: 채널 활동을 추가하는 방법 알아보기
hide: true
hidefromtoc: true
...
>title="다이렉트 메일 활동"
>abstract="다이렉트 메일 활동은 워크플로 내에서 다이렉트 메일 전송 과정을 원활하게 하며 일회성 메시지와 반복 메시지를 모두 사용할 수 있습니다. 이는 다이렉트 메일 제공업체에 필요한 추출 파일 생성 프로세스를 자동화하는 역할을 합니다. 채널 활동을 워크플로 캔버스에 결합하여 고객 행동 및 데이터에 따라 작업을 트리거할 수 있는 크로스 채널 워크플로를 만들 수 있습니다."
