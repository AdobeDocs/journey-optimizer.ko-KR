...
1. [초기 이벤트와 여정 ](#create-context)를 만듭니다.
1. [이메일에 장바구니 컨텐츠를 추가합니다](#each-helper).
...
1. HTML 콘텐츠 구성 요소를 각각의 새 구조 구성 요소에 끌어다 놓습니다.
...
1. 상황별 도구 모음에서 **[!UICONTROL Show the source code]** 을 클릭합니다.

   ![](../assets/personalization-uc-helpers-3.png)

1. **[!UICONTROL Edit HTML]** 창에서 `upperCase` 문자열 함수를 추가합니다.
...
1. 이름 토큰 추가:
   ...
   1. 표현식에 **[!UICONTROL First name]** 토큰을 추가합니다.
...
1. **[!UICONTROL Edit HTML]** 창에서 `each` 도우미를 추가합니다.
   1. 목록에서 **[!UICONTROL Helper functions]** 을 선택합니다.
...
1. 식에 `productListItems` 배열을 추가합니다.
   ...
   1. 목록에서 **[!UICONTROL Context]** 을 선택합니다.

      **[!UICONTROL Context]** 옵션은 여정 컨텍스트이 메시지에 전달된 후에만 사용할 수 있습니다.

   1. **[!UICONTROL Journey Orchestration]** > **[!UICONTROL Events]** > ***[!UICONTROL event_name]***을 선택한 다음 **[!UICONTROL productListItems]** 노드를 확장합니다.

      이 예에서 *event_name*&#x200B;은 이벤트의 이름을 나타냅니다.

   1. 표현식에 **[!UICONTROL Product]** 토큰을 추가합니다.
   ...
   1. 표현식을 수정합니다.
      ...
      ```
1. 열기 `{{#each}}` 태그와 닫는 `{/each}}` 태그 사이에 이 코드를 붙여 넣습니다.
...
1. 항목 이름, 수량 및 가격에 대한 개인화 토큰을 추가합니다.
   ...
   1. 이전 검색 결과에서 식에 **[!UICONTROL Name]** 토큰을 추가합니다.
...
1. **[!UICONTROL Edit HTML]** 창에서 `if` 도우미를 추가합니다.
   1. 목록에서 **[!UICONTROL Helper functions]** 을 선택합니다.
...
1. 조건에 제품 이름 토큰을 추가합니다.
   ...
   1. 표현식에 **[!UICONTROL Name]** 토큰을 추가합니다.
...
1. **[!UICONTROL Test]** 토글을 켜고 **[!UICONTROL Trigger an event]** 를 클릭합니다.

   메시지를 게시한 후에만 테스트 모드를 설정할 수 있습니다.

   ![](../assets/personalization-uc-helpers-15.png)

1. **[!UICONTROL Event configuration]** 창에서 입력 값을 입력한 다음 **[!UICONTROL Send]** 를 클릭합니다.
