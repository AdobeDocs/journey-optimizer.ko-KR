...
Journey Optimizer은 고객 집합에 대한 제한된 가용성에서도 전체/기본 URL 개인화를 지원합니다. 예:
...
>title="자동 완성"
>abstract="이 옵션을 토글하여 활성화하면 코드 입력 시 시스템이 자동으로 코드를 제안하고 완성합니다. 이 기능은 HTML 및 텍스트 형식에서만 사용할 수 있으며 프로필 및 컨텍스트 속성을 지원합니다. 이 옵션을 토글하여 비활성화하면 편집기는 기본 HTML 코드 자동 완성 기능을 대신 제공합니다."
...
1. **[!UICONTROL 자동 완성]**: 입력할 때 코드를 자동으로 제안하고 완료합니다. 이 기능은 HTML 및 텍스트 형식에서만 사용할 수 있으며 프로필 및 컨텍스트 속성을 지원합니다. 이 옵션을 토글하여 비활성화하면 편집기는 기본 HTML 코드 자동 완성 기능을 대신 제공합니다.
