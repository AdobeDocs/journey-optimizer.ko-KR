...
>title="자동 완성"
>abstract="이 옵션을 켜면 입력하는 동안 시스템이 자동으로 코드를 제안하고 완성합니다. 이 기능은 HTML 및 텍스트 포맷에서만 사용할 수 있으며 프로필 및 컨텍스트 속성을 지원합니다. 토글을 통해 비활성화하면 편집기는 대신 기본 HTML 코드 자동 완성 기능을 제공합니다."
...
1. **[!UICONTROL 자동 완성]**: 입력할 때 코드를 자동으로 제안하고 완료합니다. 이 기능은 HTML 및 텍스트 포맷에서만 사용할 수 있으며 프로필 및 컨텍스트 속성을 지원합니다. 토글을 통해 비활성화하면 편집기는 대신 기본 HTML 코드 자동 완성 기능을 제공합니다.
