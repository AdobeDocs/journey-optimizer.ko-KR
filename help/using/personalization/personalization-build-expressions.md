...
1. **[!UICONTROL 자동 완성]**: 입력할 때 코드를 자동으로 제안하고 완료합니다. 이 기능은 HTML 및 텍스트 형식에만 사용할 수 있으며 프로필 및 컨텍스트 속성을 지원합니다. 토글을 통해 비활성화된 경우 편집기는 대신 기본 HTML 코드 자동 완성을 제공합니다.
...
1. **[!UICONTROL 유효성 검사]**: 식의 구문을 확인하십시오. 자세한 내용은 [이 섹션](personalization-validation.md)을 참조하십시오.
