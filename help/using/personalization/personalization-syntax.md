...
* 일반: `let`, `export`, `to`, `as`, `this`, `last`, `next`, `now`, `NOW`, `today`, `yesterday`, `tomorrow`, `from`, `FROM`, `From`, `before`, `BEFORE`, `Before`, `after`, `AFTER`, `After`
* 시간 단위: `millisecond`, `milliseconds`, `second`, `seconds`, `minute`, `minutes`, `hour`, `hours`, `day`, `days`, `week`, `weeks`, `month`, `months`, `year`, `years`, `decade`, `decades`, `century`, `centuries`, `millennium`, `millennia`
* 부울 및 논리 연산자: `true`, `TRUE`, `True`, `false`, `FALSE`, `False`, `not`, `NOT`, `Not`, `and`, `AND`, `And`, `or`, `OR`, `Or`, `null`, `NULL`, `Null`
