...
**여정 식 함수:** [고급 식 편집기](../building-journeys/expression/expressionadvanced.md) | [컬렉션 관리 함수](../building-journeys/expression/collection-management-functions.md)(첫 번째, 모두, 마지막) | [목록 함수](../building-journeys/functions/list-functions.md)(serializeList, filter, sort) | [배열 함수](../personalization/functions/arrays-list.md)(head, tail)
