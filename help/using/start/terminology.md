...
| 용어 | 정의 |
|------|------------|
| **의사 결정** | 새로운 구현에 권장되는 Journey Optimizer의 현재 세대 의사 결정 프레임워크 스키마 기반 항목 카탈로그 관리, 유연한 수집 규칙, 재사용 가능한 의사 결정 구성 요소 및 실험 기능을 제공합니다. 코드 기반 경험, 푸시, SMS 및 이메일에 사용 가능합니다. [자세히 알아보기](../experience-decisioning/gs-experience-decisioning.md) |
...
| **지원되는 채널** | 코드 기반 경험, 푸시, SMS, 이메일 | 이메일, 인앱, 푸시, SMS, DM |
