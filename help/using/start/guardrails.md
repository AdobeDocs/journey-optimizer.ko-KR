...
* **대상 읽기** 활동을 사용하는 여정의 경우 정확히 동시에 시작할 수 있는 최대 여정 수가 있습니다. 다시 시도는 시스템에서 수행되지만 5분에서 10분 간격과 같이 시간에 따라 분산하여 정확히 같은 시간에 시작하는 5개 이상의 여정(**대상자 읽기**, 예약됨 또는 &quot;가능한 한 빨리&quot; 시작)를 사용하지 마십시오.
* **대상자 읽기** 활동은 Adobe Campaign 활동과 함께 사용할 수 없습니다.
* **대상자 읽기** 활동은 비즈니스 이벤트 활동 이후의 여정에서 첫 번째 활동으로만 사용할 수 있습니다.
...
| Edge 세분화를 사용한 Edge Decisioning API 요청 | 초당 1500 |
| Edge 세분화를 사용하지 않는 Edge Decisioning API 요청 | 5,000/초 |
