...
* 프로필은 모든 활성 [버전의 여정](../building-journeys/publish-journey.md#create-a-new-version-of-a-journey-journey-create-new-version)에 대해 동일한 여정에서 동시에 여러 번 나타날 수 없습니다. 재진입이 활성화된 경우 프로필은 여정에 다시 입장할 수 있지만 여정의 이전 인스턴스를 완전히 종료할 때까지는 다시 입장할 수 없습니다. [자세히 보기](../building-journeys/end-journey.md)
