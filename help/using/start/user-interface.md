...
* **[!UICONTROL Journey Administration]** - 이 메뉴를 사용하여 구성 [events]../event/about-events.md), [데이터 소스](../datasource/about-data-sources.md) 및 [작업](../action/action.md) 여정에서 를 사용 중입니다.
