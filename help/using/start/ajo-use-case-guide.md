...
title: 이 작업에 대한 Journey Optimizer 기능은 무엇입니까?
description: 일반적인 실무자 목표를 올바른 Adobe Journey Optimizer 기능과 매핑하고 실습 튜토리얼을 통해 목표 우선 의사 결정 안내서를 통해 원하는 작업을 신속하게 수행하고 시작할 수 있는 적합한 도구를 찾을 수 있습니다.
feature: Get Started
...
# 이 작업에 대한 Journey Optimizer 기능은 무엇입니까? {#ajo-use-case-guide}
...
전송하려는 채널로 시작: [이메일](../email/get-started-email.md) · [푸시](../push/get-started-push.md) · [SMS/MMS/RCS](../mobile/get-started-mobile.md) · [웹](../web/get-started-web.md) · [인앱](../in-app/get-started-in-app.md). 모바일별 지침은 [모바일 학습 허브](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}를 참조하세요.

## 측정 및 최적화 {#measure-optimize}

성능을 추적하고 구체화하십시오. [실시간 보고서](../reports/live-report.md) · [실시간 보고서로 여정 모니터링 및 분석](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. 실험을 분석하고 다음 단계 권장 사항을 얻으려면 [Experimentation Agent](ai-features.md#experimentation-agent) **(AI)**([자습서](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"})을(를) 사용하십시오.
