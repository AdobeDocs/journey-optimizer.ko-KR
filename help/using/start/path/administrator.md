...
[마케터](marketer.md)가 메시지를 만들고 보낼 수 있도록 하려면 **관리** 메뉴에 액세스하세요. 채널 설정을 구성하려면 **[!UICONTROL 채널]** 메뉴를 찾아보십시오.
...
1. **채널 구성 설정**. 이메일, SMS, 푸시 알림 및 기타 채널에 필요한 모든 기술 매개 변수를 정의합니다.
   ...
   * **과(와) Adobe Experience Platform 데이터 수집 모두에서**&#x200B;푸시 알림 설정[!DNL Adobe Experience Platform]을(를) 정의합니다. [자세히 알아보기](../../push/push-gs.md)

   * 전자 메일, SMS, 푸시, 인앱, 웹 및 기타 채널에 필요한 모든 기술 매개 변수를 구성하려면 **채널 구성**&#x200B;을 만드십시오. [자세히 알아보기](../../configuration/channel-surfaces.md)

   * SMS에 필요한 모든 기술 매개 변수를 설정하려면 **SMS 채널**&#x200B;을 구성하십시오. [자세히 알아보기](../../sms/sms-configuration.md)
...
조직의 요구 사항이 증가함에 따라 다음과 같은 고급 기능을 고려하십시오.

* **동의 정책**: 조직에서 Healthcare Shield 또는 Privacy and Security Shield를 구입한 경우 여러 채널에서 고객 환경 설정을 준수하도록 동의 정책을 만드십시오. [자세히 알아보기](../../action/consent.md)
...
2. **사용 모니터링**: 관리 대시보드를 사용하여 시스템 사용을 추적하고 문제를 식별하십시오
