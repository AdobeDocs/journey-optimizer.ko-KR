...
액세스 및 거버넌스에 대해 [관리자](administrator.md)와(과) 공동 작업:
...
데이터 구조 및 이벤트에 대해 [개발자](developer.md)와(과) 공동 작업:

* 구현해야 하는 XDM 스키마 및 이벤트 구조 제공
* 전송해야 하는 이벤트와 필요한 페이로드 형식을 정의합니다.
* 데이터 수집 요구 사항 및 데이터 품질 표준 조정
* 이벤트 전달 및 데이터 수집 함께 테스트

>[!TAB 마케터와 함께 작업]

대상 및 데이터에 대해 [마케터](marketer.md)와(과) 공동 작업:

* 개인화 및 세분화를 위한 계산된 속성 만들기
* 캠페인 및 여정 요구 사항을 기반으로 대상 구축
* 오케스트레이션된 캠페인에 대한 관계형 스키마 구성
* 고급 사용 사례를 위한 다중 엔티티 세그멘테이션 지원
