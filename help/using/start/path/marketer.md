...
1. **대상자 만들기**. Journey Optimizer에서는에서 직접 세그먼트 정의를 통해 대상자를 만들 수 있습니다. **대상** 메뉴를 사용하여 여정에 활용할 수 있습니다.  대상자에 대해 자세히 알아보기 [이 페이지에서](../../audience/about-audiences.md). 세그먼트 정의를 작성하는 방법 살펴보기 [이 샘플에서](../../audience/creating-a-segment-definition.md).
