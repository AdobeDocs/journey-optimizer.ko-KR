...
[Adobe Journey Optimizer 블루프린트](https://experienceleague.adobe.com/ko/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/journey-optimizer-overview){target="_blank"}를 참조하십시오.


>[!MORELIKETHIS]
>
>* [시작하는 주요 단계](quick-start.md)
>* [데이터 관리 시작](../data/gs-data.md)
