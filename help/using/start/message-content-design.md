...
**이 페이지에서:** 참여를 유도하는 온-브랜드 메시지를 전달할 수 있도록 개인화된 이메일, 푸시, SMS 및 인앱 콘텐츠를 디자인하는 도구와 모범 사례를 살펴보십시오.
...
SMS를 사용하여 개인화된 모바일 메시지를 작성하고, MMS를 사용하여 멀티미디어 콘텐츠와의 통신을 강화하고, 타겟팅된 메시지에 동적 콘텐츠를 활용합니다.

[텍스트 메시지 만들기](../mobile/create-mobile-message.md)
:::
