...
* **URL 추적 매개 변수 설정** - 표면 수준에서 추적 매개 변수를 구성하여 캠페인 식별자(utm_campaign, utm_source 등)를 자동으로 추가합니다. 모든 이메일 링크. 이렇게 하면 전체 디지털 에코시스템에서 속성 추적을 사용할 수 있습니다. [자세히 알아보기](../email/url-tracking.md)
...
**성능 모니터링:** 열기, 클릭 수, 링크 수준 성능을 포함한 캠페인 및 여정 보고서에서 실시간 지표를 봅니다. [캠페인 보고서](../reports/campaign-global-report-cja-email.md) | [보고서 여정](../reports/journey-global-report-cja-email.md)
...
**추적 데이터 보기:** 보고서의 표시 지표, 클릭스루 비율 및 요소 수준 성능에 액세스합니다. [캠페인 보고서](../reports/campaign-global-report-cja-web.md) | [보고서 여정](../reports/journey-global-report-cja-web.md)
...
* **본문 클릭 동작** - 사용자가 알림을 누를 때 발생하는 작업(앱 열기, 딥링크로 이동 또는 웹 URL 열기)을 설정합니다. 각 작업은 자동으로 추적됩니다. [자세히 알아보기](../push/design-push.md#on-click-behavior)
...
**참여 분석:** 보고서에서 클릭스루 비율, 단추 성능 및 추적된 링크 세부 정보를 봅니다. [캠페인 보고서](../reports/campaign-global-report-cja-push.md) | [보고서 여정](../reports/journey-global-report-cja-push.md)
...
**추적되는 내용:** Journey Optimizer은 자동으로 표시, 단추 클릭, 해제, 트리거된 지표 및 표시된 지표와 연결된 성능을 캡처합니다. [캠페인 보고서](../reports/campaign-global-report-cja-inapp.md) | [보고서 여정](../reports/journey-global-report-cja-inapp.md)
...
**추적되는 내용:** 구현되면 모든 디지털 접점(웹 사이트, 모바일 앱, IoT 장치 등)에서 디스플레이, 클릭 수, 클릭스루 비율 및 요소 수준 성능을 추적합니다. [캠페인 보고서](../reports/campaign-global-report-cja-code.md) | [보고서 여정](../reports/journey-global-report-cja-code.md)
...
**참여 모니터링:** 여러 세션에서 디스플레이, 클릭 수, 클릭스루 비율 및 참여 패턴을 추적합니다. [캠페인 보고서](../reports/campaign-global-report-cja-content.md) | [보고서 여정](../reports/journey-global-report-cja-content.md)
...
* **사용자 지정 성공 지표 정의** - 비즈니스 목표(구매, 등록, 갱신 등)에 맞게 특정 KPI를 구성합니다. 표준 참여 지표 이외. [자세히 알아보기](../building-journeys/success-metrics.md)
...
* **통합 성능 보기:** 캠페인과 여정 모두에 대한 포괄적인 보고서에 액세스하여 이메일, 푸시, SMS 및 기타 채널 간 성능을 비교하고 최상의 결과를 도출하는 조합을 파악합니다. [캠페인 보고서](../reports/campaign-global-report-cja.md) | [보고서 여정](../reports/journey-global-report-cja.md)
