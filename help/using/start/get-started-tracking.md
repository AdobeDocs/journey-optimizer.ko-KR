...
**코드 기반 추적을 위한 사전 요구 사항:** 코드 기반 경험에서 의사 결정을 추적하려면 구현에서 Web SDK 또는 Mobile SDK을 사용하여 Adobe Experience Platform에 제안 상호 작용 이벤트(디스플레이 및 클릭 수)를 전송하는지 확인하십시오. [자세히 알아보기](../experience-decisioning/gs-experience-decisioning.md)
