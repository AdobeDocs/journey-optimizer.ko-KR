...
3. **개발자**: 기술 통합 처리\
   개발자를 통해 Adobe Journey Optimizer은 기술 통합을 구현하여 모바일 앱, 웹 사이트 및 외부 시스템과 상호 작용할 수 있습니다. 예를 들어 푸시 알림은 개발자 중심적 구성을 사용합니다.
...
4. **개발자**: 모바일 앱을 통합하고 API를 구현하고 사용자 정의 통합을 구축합니다.\
   예: Adobe Journey Optimizer API를 사용하여 모바일 앱 내의 고객 작업에 따라 푸시 알림을 트리거합니다.
