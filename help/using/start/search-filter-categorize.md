...
대부분의 목록에서 검색 표시줄을 사용하여 특정 항목을 찾고 필터링 기준을 정의합니다. 열 헤더를 클릭하여 목록을 정렬할 수도 있습니다. 캠페인 폴더 보기에서는 **[!UICONTROL 우선순위]** 및 **[!UICONTROL 채널 구성]**&#x200B;별로 정렬하는 기능도 지원됩니다.
...
* **[!UICONTROL 패키지에 추가]** - 선택한 항목을 다른 샌드박스로 내보냅니다. [개체를 내보내는 방법 알아보기 →](../configuration/copy-objects-to-sandbox.md)
