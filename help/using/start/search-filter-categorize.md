...
대부분의 목록에서 검색 표시줄을 사용하여 특정 항목을 찾고 필터링 기준을 정의합니다. 열 머리글을 클릭하여 목록을 정렬할 수도 있습니다. 캠페인 폴더 보기에서는 **[!UICONTROL 우선 순위]** 및 **[!UICONTROL 채널 구성]**&#x200B;을 기준으로 정렬도 지원됩니다.
...
**캠페인**, **조각** 및 **템플릿** 목록에서 확인란을 사용하여 여러 항목을 한 번에 선택하고 화면 하단에 나타나는 일괄 작업 표시줄에서 모든 항목에 작업을 적용할 수 있습니다.

다음 작업을 사용할 수 있습니다.

* **[!UICONTROL 패키지에 추가]** - 선택한 항목을 다른 샌드박스로 내보냅니다. [개체를 내보내는 방법에 대해 알아봅니다→](../configuration/copy-objects-to-sandbox.md)
* **[!UICONTROL 폴더로 이동]** - 선택한 항목을 폴더로 이동합니다.
* **[!UICONTROL 태그 편집]** - 선택한 항목에 할당된 태그를 편집합니다. [태그를 사용하는 방법에 대해 알아보세요→](#add-tags)
* **[!UICONTROL 액세스 관리]** - 선택한 항목에 액세스 레이블을 적용합니다. [개체 수준 액세스 제어에 대해 자세히 →](../administration/object-based-access.md)
* **[!UICONTROL 보관]** - 선택한 항목 보관 조각 및 템플릿에 사용할 수 있습니다.
* **[!UICONTROL 삭제]** - 선택한 항목을 영구적으로 삭제합니다. 캠페인에만 사용할 수 있습니다.
