...
* **Personalization** - Personalization 편집기에서 새 표현식을 생성하거나, 기존 코드를 설명하거나, AI 길잡이 문제를 수정하십시오. [Personalization 표현식용 AI 도우미](../content-management/generative-personalization-expressions.md)
...
[사용 가능한 모든 플레이북 보기](https://experienceleague.adobe.com/docs/experience-platform/use-case-playbooks/playbooks/playbooks-list.html?lang=ko){target="_blank"} | [Experience Platform 설명서에서 자세히 알아보기](https://experienceleague.adobe.com/docs/experience-platform/use-case-playbooks/playbooks/overview.html){target="_blank"}
