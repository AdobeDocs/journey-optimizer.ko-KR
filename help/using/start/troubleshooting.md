...
SMS 옵트아웃 구성 [에 대해 자세히 알아보세요](../mobile/mobile-opt-out.md).
...
SMS 옵트아웃 처리에 대해 자세히 알아보세요. [이 페이지](../mobile/mobile-opt-out.md).
...
이 페이지의 [여정](../building-journeys/read-audience.md)에서 **대상자 읽기** 활동에 대해 자세히 알아보세요.
