...
1. 아래에 자세히 설명된 대로 SMS API 자격 증명을 구성합니다.
   ...
   | 도움말 키워드 | **새 SMS 구성의 경우 [Webhooks 메뉴](sms-webhook.md)를 사용하여 동의 키워드를 구성하십시오. 기존 구성은 이 섹션에서 동의 키워드를 계속 사용할 수 있습니다.** </br>**도움말 메시지**&#x200B;를 자동으로 트리거할 기본 또는 사용자 지정 키워드를 입력하십시오. 여러 키워드의 경우 쉼표로 구분된 값을 사용하십시오. |
   ...
   | 이중 옵트인 키워드 | **새 SMS 구성의 경우 [Webhooks 메뉴](sms-webhook.md)를 사용하여 동의 키워드를 구성하십시오. 기존 구성은 이 섹션에서 동의 키워드를 계속 사용할 수 있습니다.** </br>이중 옵트인 프로세스를 트리거하는 키워드를 입력합니다. 사용자 프로필이 존재하지 않으면 확인 후 생성됩니다. 여러 키워드의 경우 쉼표로 구분된 값을 사용하십시오. [SMS 이중 옵트인에 대해 자세히 알아보기](https://video.tv.adobe.com/v/3427129/?learn=on). |
