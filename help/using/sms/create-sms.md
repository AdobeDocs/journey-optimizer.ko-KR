...
>id="ajo_message_sms"
>title="문자 메시지 만들기"
>abstract="문자 메시지(SMS/MMS)를 만들려면 여정 또는 캠페인에 SMS 작업을 추가하고 표현식 편집기로 개인화를 시작합니다."
...
>title="SMS 콘텐츠 정의"
>abstract="표현식 편집기를 사용하여 콘텐츠를 정의하고 동적 요소를 통합하여 텍스트 메시지(SMS/MMS)를 사용자 정의하고 개인화할 수 있습니다."
