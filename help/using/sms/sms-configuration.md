...
title: SMS 구성
description: Journey Optimizer를 사용하여 SMS를 전송하도록 환경을 구성하는 방법을 알아봅니다
role: Admin
level: Intermediate
...
[!DNL Journey Optimizer] 여정을 만들고 타겟팅된 대상자에게 메시지를 전송할 수 있습니다.
...
>[!IMPORTANT]
>
>Adobe Journey Optimizer는 현재 Adobe Journey Optimizer와 별도로 SMS 서비스를 제공하는 Sinch 및 Twilio와 같은 타사 공급자와 통합됩니다.  SMS를 구성하기 전에 Adobe Journey Optimizer와 적용 가능한 SMS 공급자 간의 연결을 설정할 수 있는 API 토큰 및 서비스 ID를 수신하려면 이러한 SMS 공급자 중 하나와 계정을 만들어야 합니다. SMS 서비스 사용은 해당 SMS 공급자의 추가 약관을 따릅니다. Sinch 및 Twilio는 통합을 통해 Adobe Journey Optimizer 사용자가 사용할 수 있는 타사 제품이므로 SMS 서비스와 관련된 문제나 문의 사항은 Sinch 또는 Twilio 사용자가 해당 SMS 공급자에게 문의하여 도움을 받아야 합니다. Adobe는 타사 제품을 제어하지 않으며 책임을 지지 않습니다.

## 새 API 자격 증명 만들기 {#create-api}

>[!CONTEXTUALHELP]
>id="ajo_admin_sms_api_header"
>title="Journey Optimizer를 사용하여 SMS 공급업체 구성"
>abstract="공급업체 를 선택하고 SMS API 자격 증명을 입력합니다."

>[!CONTEXTUALHELP]
>id="ajo_admin_sms_api"
>title="Journey Optimizer를 사용하여 SMS 공급업체 구성"
>abstract="SMS를 전송하기 전에 공급자 설정을 Journey Optimizer와 통합해야 합니다. 완료되면 SMS 표면을 만들어야 합니다. 이러한 단계는 Adobe Journey Optimizer 시스템 관리자가 수행해야 합니다."
...
Journey Optimizer를 사용하여 SMS 공급자를 구성하려면 다음 단계를 수행합니다.
...
1. 을(를) 선택합니다 **[!UICONTROL SMS vendor]**:
   ...
   * [!DNL Sinch]. 을(를) 찾으려면 **[!UICONTROL Service ID]** 및 **[!UICONTROL API Token]**, Sinch 계정에서 SMS > API 메뉴에 액세스합니다.
   * [!DNL Twilio]. 을(를) 찾으려면 **[!UICONTROL Service ID]** 및 **[!UICONTROL API Token]**&#x200B;콘솔 대시보드 페이지의 계정 정보 창에 액세스합니다.
...
이제 Journey Optimizer를 사용하여 SMS 메시지를 보낼 준비가 되었습니다.
