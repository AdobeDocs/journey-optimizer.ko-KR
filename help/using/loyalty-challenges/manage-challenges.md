...
* **게시됨**: 문제가 활성 상태이며 연결된 여정이 만들어졌습니다.
...
* 업데이트된 문제를 고객이 사용할 수 있도록 하려면 연결된 여정을 다시 게시해야 합니다.
...
* **활성 작업에 사용되지 않는 작업**: 자유롭게 편집할 수 있습니다. 모든 속성은 영향 없이 수정할 수 있습니다.
* **실시간 문제에 사용되는 작업**: 변경 사항은 해당 작업을 사용하는 모든 문제에 영향을 주므로 주의하십시오. 수정 사항은 참조하는 모든 문제에 즉시 적용됩니다.
...
* 작업 인벤토리에서 **[!UICONTROL 어려움에 사용됨]** 수를 확인하십시오.
* 작업을 참조하는 초안, 예약됨 또는 라이브 문제가 없는지 확인합니다.
