...
* **초안**: 만들거나 편집하는 중
* **예약됨**: 게시됨, 시작 날짜에 활성화됨
* **Live**: 활성 상태이며 고객이 참여할 수 있습니다.
* **완료됨**: 합격 종료 날짜 또는 목표 충족됨
...
* **초안 문제**: 전체 편집 기능
* **예약된/라이브 문제**: 제한된 편집(콘텐츠 업데이트, 날짜 확장)
...
### 과제 만들기* 간단한 첫 번째 과제 시작* 프로덕션에 게시하기 전에 철저하게 테스트* 요구 사항 및 보상에 대한 명확한 커뮤니케이션 보장* 고객이 과제를 완료할 수 있도록 현실적인 타이밍 설정

### 관리 및 모니터링* 과제 성과를 정기적으로 점검(라이브 과제의 경우 최소 매주)* 목적, 대상자 또는 기간을 나타내는 수사적 이름 사용* 조직에 일관된 태그 적용* 완료된 문제를 아카이빙하여 재고를 관리
...
* **문제가 고객에게 표시되지 않음**: 상태, 대상자 자격, 콘텐츠 카드 구성 확인
...
* [과제 만들기](create-challenges.md) - 새로운 충성도 과제 만들기
