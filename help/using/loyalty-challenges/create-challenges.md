...
![](assets/do-not-localize/schedule-icon.svg) **[!UICONTROL 일정 열기]** 아이콘을 선택하여 챌린지 실행 시기를 구성합니다.
...
* **표준 과제**: 순서에 관계없이 지정된 수의 작업을 완료하십시오.\
  *예: 구매, 리뷰 작성, 친구 참조, 소셜 미디어 공유 또는 프로필 업데이트 등 5가지 작업 중 3가지를 완료하십시오*

* **연속 문제**: 동일한 작업을 여러 번 연속적으로 완료하십시오.\
  *예: 7일 연속 구매하여 보너스 보상을 획득하십시오*

* **순차적인 문제**: 정의된 순서로 작업 완료\
  *예: 먼저 구매한 다음 리뷰를 작성한 다음 소셜 미디어에서 공유 - 작업을 이 순서로 완료해야 함*
...
1. **[!UICONTROL 작업 완료 요구 사항]** 섹션에서 챌린지가 완료된 것으로 간주되는 시기를 지정하십시오.

   * **[!UICONTROL 고객이 완료할 작업을 하나 선택]**: 고객은 원하는 작업을 선택하여 완료하면 보상을 받을 수 있습니다.
   * **[!UICONTROL 고객이 특정 수의 작업을 완료합니다]**: 고객은 정의된 수의 작업을 완료해야 합니다.

1. 기본적으로 문제를 해결하면 여러 트랜잭션에서 작업을 완료할 수 있습니다. 모든 작업을 한 번의 트랜잭션으로 완료하도록 하려면 ![](assets/do-not-localize/settings-icon.svg) **[!UICONTROL 설정]** 아이콘을 선택하고 아래 옵션을 켜십시오.
