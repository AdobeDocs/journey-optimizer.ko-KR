...
### 챌린지 속성 정의 및 사용자 정의 메타데이터 사용 {#properties}

>[!CONTEXTUALHELP]
>id="ajo_loyalty_challenge_properties"
>title="챌린지 속성"
>abstract="챌린지 속성 창에서 챌린지 이름 및 설명을 설정하고 추적 또는 외부 통합을 위한 사용자 정의 키/값 메타데이터를 추가합니다."
...
>title="대상자"
>abstract="대상 탭에서 사용 가능한 Adobe Experience Platform 대상 중 챌린지에 참여할 수 있는 사용자를 선택합니다."
