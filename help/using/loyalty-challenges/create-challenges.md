...
구조 탭에서 과제 구성 방법(속성, 일정, 완료할 작업 및 제공할 보상)을 정의합니다.

### 과제 속성 정의 및 사용자 지정 메타데이터 사용 {#properties}

1. 과제 속성 창에서 과제 설정을 정의합니다.

   ![](assets/challenge-create-properties.png)

   **이름**: 챌린지를 설명하는 이름을 입력하십시오. 이 이름은 과제 인벤토리에 표시됩니다.

   **설명**: 도전 목적 및 목표를 설명하는 설명을 입력하십시오.
...
* **시작 날짜 및 시간**: 고객이 도전을 사용할 수 있게 되는 시기를 설정합니다.

* **종료 날짜 및 시간**: 문제가 만료되어 더 이상 새 완료를 허용하지 않는 시기를 설정합니다.

* **표준 시간대**: 과제에서는 기본적으로 받는 사람의 로컬 표준 시간대를 사용합니다.
...
1. 드롭다운에서 **[!UICONTROL 보상 공급자]**&#x200B;를 선택합니다. 고객 포인트와 보상을 관리하는 충성도 솔루션입니다.

1. 선택한 게재 방법에 따라 보상 금액을 구성합니다.

   +++도전이 완료되면 보상 제공

   **도전 완료 시 [충성도 포인트]의 수** 필드에서 고객이 전체 도전을 완료할 때 제공할 총 보상 금액을 지정합니다.
...
>[!NOTE]
>
>충성도 요구사항에는 보상 잔액을 추적하는 내장 원장 시스템이 포함되지 않습니다. 선택한 보상 제공자가 포인트 추적 및 상환을 처리하는지 확인합니다.
...
[콘텐츠 카드를 디자인하고 개인화하는 방법을 알아보세요](../content-card/design-content-card.md).
...
1. ![](assets/do-not-localize/Smock_More_18_N.svg) 아이콘을 선택하고 **[!UICONTROL 편집]**&#x200B;을 선택하여 메시지 콘텐츠를 디자인합니다.
   ...
   * [인앱 메시지를 만드는 방법 알아보기](../in-app/get-started-in-app.md)
   * [이메일 메시지를 만드는 방법 알아보기](../email/get-started-email.md)
   * [푸시 알림을 만드는 방법 알아보기](../push/get-started-push.md)
...
1. **[!UICONTROL 대상자]** 탭으로 이동하여 **[!UICONTROL 대상자 선택]**&#x200B;을 선택합니다.

   ![](assets/challenge-create-audience.png)

1. 사용 가능한 Adobe Experience Platform 대상자 목록에서 타겟 대상자를 선택합니다.
...
* [과제 관리](manage-challenges.md) - 과제 편집, 모니터링 및 최적화
