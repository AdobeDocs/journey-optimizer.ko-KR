...
* **[!UICONTROL 적격 항목 및 제외]**: 작업 완료 시 계산되는 항목 또는 항목 그룹과 그렇지 않은 항목 그룹을 정의하거나 **[!UICONTROL 고유한 데이터 가져오기]**&#x200B;를 선택하여 외부 데이터에서 적격 여부를 결정합니다. [자세히 알아보기](#eligible-items-exclusions)
...
이 옵션을 사용하려면 **[!UICONTROL 적격 항목 및 제외]**&#x200B;에서 개인화 아이콘을 선택한 다음 **[!UICONTROL 데이터 가져오기]**&#x200B;를 선택하십시오.

![](assets/tasks-create-eligible-bring.png)

>[!IMPORTANT]
>
>이 작업을 작업에 할당할 때 **[!UICONTROL 표준]**&#x200B;을(를) 과제 유형으로 선택하십시오. 과제 수준에서 **[!UICONTROL 직접 데이터 가져오기]**&#x200B;를 선택하지 마십시오. 이 옵션은 작업 및 보상을 포함한 전체 구조가 외부에서 제공되는 전체 데이터 기반 과제를 위한 옵션입니다.
