...
충성도 문제는 도전을 프로그래밍 방식으로 관리하고 프로필 참여를 추적할 수 있는 REST API를 노출합니다.

* **[충성도 챌린지 메타데이터 API](https://developer.adobe.com/journey-optimizer-apis/references/loyalty-challenges){target="_blank"}** — 챌린지를 만들고, 검색하고, 업데이트하고, 게시하고, 보관하고, 복제합니다.
...
인증 및 필수 헤더에 대해서는 [인증 자습서](https://developer.adobe.com/journey-optimizer-apis/references/authentication){target="_blank"}를 참조하십시오.
