...
**이 페이지에서:** 충성도 문제에 액세스하고, 과제 및 작업 인벤토리를 검토하고, 기존 과제 및 재사용 가능한 작업을 관리하는 방법을 알아봅니다.
...
* **[!UICONTROL 상태]**: 문제를 제공하는 자동 생성된 여정의 현재 상태입니다.
...
* **질문 삭제**: ![](assets/do-not-localize/Smock_More_18_N.svg) 아이콘을 선택하고 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.

  >[!IMPORTANT]
  >
  >게시되는 경우에도 도전을 삭제할 수 있습니다. 삭제하기 전에 영향을 고려하십시오.

* **챌린지 편집**: 챌린지 이름을 선택하여 세부 정보 페이지를 열고 원하는 대로 변경합니다.

  편집하기 위해 게시된 문제를 열면 먼저 문제를 초안 상태로 되돌려야 합니다. 자동 생성된 여정에 직접 맞춤화된 내용은 손실됩니다. 변경 내용을 적용한 후 문제를 다시 저장하고 게시한 다음 관련 여정을 게시합니다. [챌린지를 시작하는 방법 알아보기](create-challenges.md#launch)
