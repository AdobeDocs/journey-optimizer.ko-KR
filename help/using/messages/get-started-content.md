---
title: 메시지 시작
description: Journey Optimizer에서 개인 맞춤화된 메시지를 만들고 전달하는 방법 알아보기
feature: Overview
...
[!DNL Journey Optimizer]을(를) 사용하여 개인화된 푸시 알림, SMS 및 이메일 메시지를 만들고 전달합니다. 모든 메시지는 여정 캔버스에서 작업의 일부로 편집할 수 있는 인라인입니다.  템플릿으로 저장 기능을 사용하여 컨텐츠를 쉽게 재사용할 수 있습니다. 다음을 수행할 수 있습니다.

* [!DNL Journey Optimizer] **이메일 디자인 기능**&#x200B;을 활용하여 응답형 이메일을 만들거나 가져옵니다.

* **Adobe Experience Manager Assets Essentials**&#x200B;를 활용하여 이메일을 보강하고 에셋 데이터베이스를 빌드하고 관리합니다.

* **Adobe Stock 사진**&#x200B;을 찾아 콘텐츠를 빌드하고 이메일 디자인을 개선합니다.

* 프로필 속성에 따라 개인화된 **푸시 알림, SMS 및 이메일**&#x200B;을 만들어 고객 경험을 향상시킵니다.

* 이러한 컨텐츠를 기반으로 하여 **게재를 전송하고** 고객 행동을 추적합니다.

>[!NOTE]
>
>사용자는 제품 프로필에 따라 여정에 액세스하고 여정을 만들고 편집 및/또는 게시할 수 있습니다. 사용자 권한에 대한 자세한 내용은 [이 섹션](../administration/permissions.md)을 참조하세요.
