...
1. 서버에 대한 세부 정보 및 자격 증명을 입력합니다.
   ...
   * **컨테이너 이름**: **컨테이너 이름**&#x200B;을 찾으려면 [이 페이지](https://learn.microsoft.com/en-us/azure/storage/blobs/blob-containers-portal)를 참조하세요.
     ...
     **컨테이너 이름**&#x200B;에는 슬래시 없이 컨테이너 이름만 포함되어야 합니다. 파일을 저장할 컨테이너 내의 경로를 지정하려면 DM 캠페인의 **[!UICONTROL 파일 이름]** 필드를 업데이트하여 원하는 경로를 포함하십시오. [자세히 알아보기](create-direct-mail.md#extraction-file)
