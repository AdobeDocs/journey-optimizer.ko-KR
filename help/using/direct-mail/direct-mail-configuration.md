...
>
>* DM 파일은 내보낼 때만 생성됩니다. 시스템은 이전 내보내기를 무기한 스토어 저장하지 않습니다. 더 길거나 영구적인 백업 백업의 경우 파일 라우팅 옵션(SFTP 또는 클라우드 스토리지)을 구성합니다.
...
>title="파일 라우팅 구성 정의"
>abstract="DM 메시지를 만든 후에는 타기팅된 대상자 데이터가 포함된 파일을 생성하여 서버로 내보냅니다. DM 공급자가 DM 게재를 위해 해당 파일에 액세스하여 사용할 수 있도록 서버 세부 사항을 지정해야 합니다."
...
1. DM 파일을 내보내는 데 사용할 서버 유형(Amazon S3, SFTP, Azure 또는 Data Landing Zone)을 선택합니다.

   ![](assets/file-routing-config-type.png){width="800" align="center"}

1. 아래 탭에 자세히 설명된 대로 각 서버 유형별 필드를 입력합니다.
...
를 사용하여 [!DNL Journey Optimizer]DM 배달을 할 수 있으려면 메일 공급자가 사용할 파일의 형식에 대한 설정을 정의하는 채널 구성을 만들어야 합니다.
...
1. 만든 파일 라우팅 구성 중 **[!UICONTROL 파일 라우팅 구성]**&#x200B;을(를) 선택하십시오. DM 공급자가 사용하기 위해 파일을 내보낼 위치를 정의합니다.
