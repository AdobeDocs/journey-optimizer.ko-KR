...
1. DM 메시지에 결정 정책을 추가하려면 **[!UICONTROL 데이터 필드]** 섹션에서 열을 선택하고 ![](../experience-decisioning/assets/do-no-localize/editor-icon.svg) 아이콘을 사용하여 개인화 편집기를 엽니다. 결정 정책을 만들고 삽입하려면 **[!UICONTROL 결정 정책]** 메뉴로 이동하십시오. 그런 다음 의사 결정 항목 속성을 추출 파일의 열 데이터로 사용할 수 있습니다.
