...
>[!CAUTION]
>
>비표시 목록을 보고, 내보내고 관리할 수 있는 권한이 [관리자 여정](../administration/ootb-product-profiles.md#journey-administrator)(으)로 제한됩니다. [이 섹션](../administration/permissions-overview.md)에서 [!DNL Journey Optimizer] 사용자의 액세스 권한 관리에 대해 자세히 알아보세요.
