...
>title="여정 구성 정보"
>abstract="여정과 함께 메시지를 전송하려면 데이터 소스, 이벤트 및 액션을 구성해야 합니다. 데이터 소스를 사용하여 시스템에 대한 연결을 정의하면 여정에 사용할 조건 등의 추가 정보를 검색할 수 있습니다. 이벤트를 수신하면 이벤트를 사용하여 여정을 트리거할 수 있습니다. 사용자 정의 액션을 통해 서드파티 시스템에 연결하여 메시지를 전송할 수 있습니다. Journey Optimizer 빌트인 메시지 기능을 사용하는 경우 액션을 구성할 필요가 없습니다."
