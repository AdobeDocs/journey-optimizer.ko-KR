...
>title="채널 구성"
>abstract="채널 구성은 시스템 관리자에 의해 정의된 구성입니다. 여기에는 헤더 매개변수, 하위 도메인, 모바일 앱 등과 같이 메시지를 전송하기 위한 모든 기술 매개변수가 포함되어 있습니다."
...
>title="채널 구성 설정"
>abstract="여정 또는 캠페인에서 이메일과 같은 액션을 만들 수 있도록 먼저 메시지에 필요한 모든 기술 설정을 정의하는 채널 구성을 만들어야 합니다. 채널 구성을 만들고, 편집하고, 삭제하려면 메시지 사전 설정 관리 권한이 있어야 합니다."
