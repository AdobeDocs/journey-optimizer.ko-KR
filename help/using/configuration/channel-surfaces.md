...
>title="채널 서피스 설정"
>abstract="채널 표면에서는 메시지에 필요한 모든 기술 매개 변수(이메일 유형, 발신자 이름, 모바일 앱, SMS 구성 등)를 정의합니다.: 구성이 완료되면 여정 또는 캠페인에서 작업을 만들 때 선택할 수 있습니다. 채널 서피스를 생성, 편집 및 삭제하려면 채널 서피스 관리 권한이 있어야 합니다."
