...
**이 페이지에서:** DMARC의 정의, 정책 작동 방식 및 Adobe Journey Optimizer에서 직접 위임된 하위 도메인에 대한 DMARC 레코드를 설정하고 관리하는 방법에 대해 알아봅니다.
...
* **새 하위 도메인을 Adobe에 위임**&#x200B;할 때 [!DNL Journey Optimizer] 관리 인터페이스에서 직접 **DMARC을 설정**&#x200B;할 수 있습니다. [방법 알아보기](#set-up-dmarc)
