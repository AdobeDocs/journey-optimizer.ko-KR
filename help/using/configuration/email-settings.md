...
1. 서피스와 연결할 IP 풀을 선택합니다. [자세히 알아보기](ip-pools.md)
...
>[!CAUTION]
>
>다음 **[!UICONTROL 보낸 사람 이메일]** 및 **[!UICONTROL 오류 이메일]** 주소는 현재 선택한 주소를 사용해야 합니다 [위임된 하위 도메인](about-subdomain-delegation.md). 예를 들어 위임된 하위 도메인이 *marketing.luma.com*, 다음 사용 가능 *contact@marketing.luma.com* 및 *error@marketing.luma.com*.
...
이렇게 하려면 **[!UICONTROL 숨은 참조 이메일]** 채널 서피스 레벨의 선택적 피쳐 [자세히 알아보기](archiving-support.md#bcc-email)
