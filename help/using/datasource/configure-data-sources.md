...
# 데이터 소스 {#configure-data-source} 구성
...
기본 이름이 자동으로 추가되더라도 필드 그룹에 이름을 지정하는 것이 좋습니다. 실제로 필드 그룹 이름은 [!DNL Journey Optimizer]에서 다른 사용자에게 표시됩니다. 필드 그룹에 관련 이름을 지정하는 것이 가장 좋습니다.
