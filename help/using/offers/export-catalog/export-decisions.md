...
**필드:** 배치
**제목:** 배치 제한
**설명:** 배치 제약 조건은 이 기준을 나열된 배치에만 적용할 수 있다고 말합니다. 대상 배치가 `xdm:placements` 목록에 있는 경우에만 옵션 선택을 고려합니다. 그렇지 않으면 전체 결정 기준을 건너뜁니다. &#39;xdm:placements&#39; 목록이 생략되거나 비어 있으면 타깃팅된 모든 배치에 대한 기준이 고려됩니다. 여기에 나열된 배치에는 옵션 선택에 대한 암시적 기준이 적용됩니다. 고려할 옵션에는 타깃팅된 배치에 대한 표현이 있어야 합니다.
**유형:** 배열
