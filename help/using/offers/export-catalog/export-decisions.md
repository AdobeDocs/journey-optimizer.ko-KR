...
오퍼가 수정될 때마다 결정을 위해 자동 생성된 데이터 세트가 업데이트됩니다.
...
* 옵션 필터
   ...
   **필드:** 필터
   **제목:** 옵션 필터
   **설명:** 첨부된 컬렉션 구분자를 사용하여 인벤토리의 옵션과 일치하는 컬렉션 구분자(이전에 &quot;태그&quot;라고 함) 기반 필터에 대한 참조. 값은 참조되는 의사 결정 규칙의 URI(@id)입니다. 스키마 https://ns.adobe.com/experience/decisioning/filter 를 참조하십시오.
   **유형:** 문자열
