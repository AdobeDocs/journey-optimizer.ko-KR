...
Journey Optimizer를 사용하면 오퍼 우선 순위 외에도 다음을 만들 수 있습니다 **등급 공식**. 오퍼의 우선 순위 점수를 고려하지 않고 주어진 배치에 대해 먼저 제공해야 하는 오퍼를 결정하는 공식입니다.
...
1. 결정을 만들거나 기존 결정을 편집합니다. 자세한 내용은 [결정 만들기](../offer-activities/create-offer-activities.md).
...
1. 클릭 **[!UICONTROL Select]**. 이제 등급 전략이 배치와 연결됩니다.
