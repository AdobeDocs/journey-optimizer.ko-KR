...
1. 사용 **[!UICONTROL 자격 요건]** 이 배치에 대한 오퍼 선택을 제한하는 필드.
   ...
   이 제한은 다음을 사용하여 적용할 수 있습니다. **결정 규칙**&#x200B;또는 하나 또는 여러 개 **Adobe Experience Platform 세그먼트**. 둘 다 다음에 자세히 설명되어 있습니다. [이 섹션](../offer-library/add-constraints.md#segments-vs-decision-rules).

   * 오퍼 선택을 Experience Platform 세그먼트의 멤버로 제한하려면 다음을 선택합니다. **[!UICONTROL 세그먼트]**&#x200B;을 클릭한 다음 을 클릭합니다 **[!UICONTROL 세그먼트 추가]**.

      ![](../assets/activity_constraint_segment.png)

      왼쪽 창에서 하나 이상의 세그먼트를 추가하고 **[!UICONTROL 및]** / **[!UICONTROL 또는]** 논리 연산자.

      ![](../assets/activity_constraint_segment2.png)

      에서 세그먼트를 사용하여 작업하는 방법을 알아봅니다 [이 섹션](../../segment/about-segments.md).
...
1. 세그먼트 또는 결정 규칙을 선택하면 예상 적격 프로필에 대한 정보를 볼 수 있습니다. 클릭 **[!UICONTROL 새로 고침]** 을 클릭하여 데이터를 업데이트합니다.
