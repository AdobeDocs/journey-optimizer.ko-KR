...
1. 또한 **컬렉션 구분자**.
   ...
   그런 다음 오퍼에 연결하고 이 컬렉션 구분자를 사용하여 오퍼를 컬렉션으로 그룹화할 수 있습니다.

   이 예에서 *요가* 컬렉션 한정자입니다.

   ![](assets/offers-e2e-tag.png)

   수집 구분자를 만드는 자세한 단계는 [이 섹션](../../using/offers/offer-library/creating-tags.md).
...
1. 를 사용하십시오 *요가* 컬렉션 구분자를 사용하여 이전에 만든 4개의 개인화된 오퍼를 선택합니다.
