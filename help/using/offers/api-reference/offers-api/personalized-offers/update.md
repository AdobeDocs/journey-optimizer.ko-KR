...
에 PATCH 요청을 수행하여 개인화된 오퍼를 수정하거나 업데이트할 수 있습니다 [!DNL Offer Library] API
...
| 컨텐츠 유형 | `Content-Type: application/vnd.adobe.platform.xcore.patch.hal+json; version=1; schema="https://ns.adobe.com/experience/offer-management/personalized-offer;version=0.5"` |
...
성공적인 응답은 고유 인스턴스 ID 및 개인화된 오퍼를 포함하여 개인화된 오퍼의 업데이트된 세부 사항을 반환합니다 `@id`.
