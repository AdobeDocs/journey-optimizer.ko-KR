...
에 PATCH 요청을 수행하여 컨테이너에서 컬렉션 구분자(이전에 &quot;태그&quot;라고 함)를 수정하거나 업데이트할 수 있습니다 [!DNL Offer Library] API.
...
성공적인 응답은 고유 인스턴스 ID 및 컬렉션 한정자를 포함하여 컬렉션 구분자의 업데이트된 세부 정보를 반환합니다 `@id`.
