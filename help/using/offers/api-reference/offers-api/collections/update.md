...
에 PATCH 요청을 수행하여 컬렉션을 수정하거나 업데이트할 수 있습니다 [!DNL Offer Library] API
...
| 컨텐츠 유형 | `application/vnd.adobe.platform.xcore.patch.hal+json; version=1; schema="https://ns.adobe.com/experience/offer-management/offer-filter;version=0.1"` |
