...
다음은 의사 결정 관리를 사용할 때 사용할 주요 개념입니다.
...
* **의사 결정** (이전에는 오퍼 활동이라고 함):결정에는 오퍼의 선택을 알려주는 논리가 포함됩니다.
...
* **오퍼 라이브러리**:오퍼 라이브러리는 개인화된 오퍼, 폴백 오퍼, 의사 결정 규칙 및 결정을 관리하는 데 사용되는 중앙 라이브러리입니다.
