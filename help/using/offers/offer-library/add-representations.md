...
>
>[의사 결정 관리]에서 개인화 편집기를 사용하면 함수의 하위 집합만 지원됩니다. [식 편집기에서 지원되는 함수](../personalization-editor-supported-functions.md)를 참조하세요.
...
개인화 편집기를 사용하여 URL을 개인화할 수 있습니다. [개인화](../../personalization/personalize.md#use-expression-editor)에 대해 자세히 알아보세요. [의사 결정 관리]에서는 특정 함수만 지원됩니다. [식 편집기에서 지원되는 함수](../personalization-editor-supported-functions.md)를 참조하세요.

![](../assets/offer-content-url.png)

예를 들어 오퍼로 표시되는 이미지를 개인화하려고 합니다. 뉴욕시의 스카이라인을 보기 위해 도시 휴가를 선호하는 이용자들과 하와이 북해안을 보기 위해 해변 휴가를 선호하는 이용자들을 원한다는 것이다.

개인화 편집기를 사용하여 유니온 스키마를 사용하여 Adobe Experience Platform에 저장된 프로필 속성을 검색합니다. [자세히 알아보기](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schemas-overview.html){target="_blank"} 의사 결정 관리에서 지원되는 함수는 식 편집기에서 [지원되는 함수](../personalization-editor-supported-functions.md)를 참조하십시오.
...
1. 오퍼에 표시할 텍스트를 입력합니다.
   ...
   개인화 편집기를 사용하여 콘텐츠를 개인화할 수 있습니다. [개인화](../../personalization/personalize.md#use-expression-editor)에 대해 자세히 알아보세요. [의사 결정 관리]에서는 특정 함수만 지원됩니다. [식 편집기에서 지원되는 함수](../personalization-editor-supported-functions.md)를 참조하세요.
