...
# 결정 규칙 만들기 {#create-decision-rules}
...
>[!NOTE]
>
>의사 결정 관리에서는 표현식 함수의 하위 집합만 지원됩니다. 규칙에서 표현식 또는 프로필 특성을 사용하는 경우 지원되는 함수 목록을 보려면 표현식 편집기에서 [지원되는 함수](../personalization-editor-supported-functions.md)를 참조하십시오.
