...
* **[데이터 개요 설정 튜토리얼](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/set-up-data-overview){target="_blank"}** - Journey Optimizer의 데이터 설정에 대한 초보자 친화적인 비디오 연습으로, 스키마, 데이터 세트 및 소스의 전체 내용을 다룹니다.

* **[데이터 세트 만들기 및 데이터 수집 튜토리얼](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/create-datasets-and-ingest-data){target="_blank"}** - Adobe Experience Platform에서 데이터 세트를 만들고 소스 커넥터를 사용하여 데이터를 수집하는 방법을 보여 주는 실습형 튜토리얼로서, 고유한 샌드박스에서 따를 수 있는 단계별 지침을 제공합니다.
