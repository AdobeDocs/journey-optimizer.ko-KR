...
>[!NOTE]
>
>2024년 11월 1일부터 Journey Optimizer 시스템 생성 데이터 세트에 TTL(Time-to-Live) 가드레일이 적용됩니다. 또한 스트리밍 세분화는 더 이상 추적 및 피드백 데이터 세트에서 보내기 및 열기 이벤트 사용을 지원하지 않습니다. [자세히 알아보기](datasets-ttl.md)
