...
>[!NOTE]
>
>2024년 11월 1일부터 Journey Optimizer 시스템 생성 데이터 세트에 다음과 같은 TTL(Time-to-Live) 가드레일이 적용됩니다.
>
>* 프로필 스토어의 데이터에 대해 90일
>* 데이터 레이크의 데이터에 대해 13개월
>
>또한 해당 시점부터 스트리밍 세분화는 더 이상 추적 및 피드백 데이터 세트에서 이벤트 보내기 및 열기 사용을 지원하지 않습니다.
