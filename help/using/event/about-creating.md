...
에서 고급 표현식 함수에 액세스할 수 있습니다. **[!UICONTROL 고급 모드]** 추가 조작을 수행하려면 버튼을 누릅니다. 이러한 함수를 사용하면 필드의 일부(예: 첫 번째 문자 10개)만 고려하여 필드 연결을 수행하는 등 형식 변경과 같은 특정 쿼리를 수행하는 데 사용되는 값을 조작할 수 있습니다. 이 [페이지](../building-journeys/expression/expressionadvanced.md)를 참조하십시오.

>[!AVAILABILITY]
>
>고급 표현식 편집기는 조직(LA) 세트에만 사용할 수 있습니다.
