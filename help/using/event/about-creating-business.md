...
**구체화된 세그먼트를 오버로드하지 않도록 하는 보호 기능이란 무엇입니까?**

비즈니스 이벤트의 경우, 재사용성 항목은 1시간으로 설정됩니다. 즉, 주어진 여정에 대해 1시간 기간 내에 새 내보내기 작업이 생성되지 않습니다. 첫 번째 이벤트 작업에서 푸시된 데이터는 다시 사용됩니다. 예약된 여정의 경우 가드레일이 없습니다.
