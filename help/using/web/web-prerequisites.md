...
>title="페이지 일치 규칙 작성"
>abstract="[!DNL Journey Optimizer] 웹 디자이너에 액세스하려면 특정 브라우저 확장 기능이 설치되어 있어야 합니다. Adobe Experience Cloud Visual Editing Helper - Google Chrome 또는 Microsoft Edge에서만 사용할 수 있습니다."
