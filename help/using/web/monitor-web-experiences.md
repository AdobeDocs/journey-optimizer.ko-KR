...
>title="클릭 추적 사용"
>abstract="웹 페이지의 모든 요소에 대한 클릭 수를 추적하여 사용자 상호 작용을 모니터링합니다. 요소를 선택하고 상황별 메뉴에서 **추적 요소 클릭**&#x200B;을 선택한 다음 의미 있는 레이블을 추가합니다. 추적된 데이터는 웹 보고서에 표시되므로 사용자들이 콘텐츠에 참여하는 방식을 파악할 수 있습니다."
