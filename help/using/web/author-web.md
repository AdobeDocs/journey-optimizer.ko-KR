...
in [!DNL Journey Optimizer] 웹 저작 기능은 Adobe Experience Cloud Visual Helper chrome 브라우저 확장 프로그램에서 제공됩니다. [추가 정보](visual-editing-helper.md)
...
>[!CAUTION]
>
>에서 액세스 [!DNL Journey Optimizer]를 설정하는 경우 웹 페이지는 [Adobe Experience Platform 웹 SDK](https://experienceleague.adobe.com/docs/platform-learn/implement-web-sdk/overview.html){target=&quot;_blank&quot;}.

1. 에서 **[!UICONTROL Action]** 캠페인의 탭에서 을 선택합니다. **[!UICONTROL Edit content]** 웹 캠페인 작성을 시작하려면 다음을 수행하십시오.
...
1. 페이지의 컨텐츠가 표시됩니다.
   ...
   >[!CAUTION]
   >
   >웹 페이지에는 [Adobe Experience Platform 웹 SDK](https://experienceleague.adobe.com/docs/platform-learn/implement-web-sdk/overview.html){target=&quot;_blank&quot;}.

1. 클릭 **[!UICONTROL Open web designer]** 편집 [추가 정보](author-web.md)
...
1. 에서 **[!UICONTROL Components]** 왼쪽의 웹 페이지에 다음 구성 요소를 추가하고 필요에 따라 편집할 수 있습니다.

   * [구분선](../email/content-components.md#divider)
   * [HTML](../email/content-components.md#HTML)
   * [이미지](../email/content-components.md#image)
   * 제목 - 이 구성 요소를 사용하는 것은 **[!UICONTROL Text]** 이메일 디자이너의 구성 요소입니다. [추가 정보](../email/content-components.md#text)
   * 단락 - 이 구성 요소를 사용하는 것은 **[!UICONTROL Text]** 이메일 디자이너의 구성 요소입니다. [추가 정보](../email/content-components.md#text)
   * 링크 - 에서 링크 스타일을 정의하는 방법을 알아봅니다. [이 섹션](../email/styling-links.md)
   * [오퍼 결정](../email/add-offers-email.md)

   ![](assets/web-designer-components.png)

1. 페이지를 마우스로 가리킨 다음 **[!UICONTROL Insert before]** 또는 **[!UICONTROL Insert after]** 단추를 클릭하여 구성 요소를 페이지의 기존 요소에 추가합니다.
...
1. 에서 표시되는 스타일을 조정합니다 **[!UICONTROL Container]** 오른쪽 창(예: 배경, 텍스트 색상, 테두리, 크기, 위치 등) 선택한 구성 요소에 따라 다릅니다.
...
1. 을(를) 클릭합니다. **[!UICONTROL Expand/Collapse Breadcrumbs]** 화면의 왼쪽 하단에 있는 버튼을 클릭하여 선택한 요소에 대한 정보를 빠르게 표시합니다.
...
기본값에서 바꿀 수 있습니다 **[!UICONTROL Design]** 모드로 **[!UICONTROL Browse]** 전용 단추를 사용하여 모드 지정

![](assets/web-designer-browse-mode.png)

에서 **[!UICONTROL Browse]** 모드에서는 개인화할 선택한 서피스에서 정확한 페이지로 이동할 수 있습니다.

이 기능은 특히 특정 URL에서 시작 시점부터 사용할 수 없거나 인증이 뒤따르는 페이지를 처리할 때 유용합니다. 예를 들어 계정 페이지 또는 장바구니 페이지를 인증하고, 이동한 다음, **[!UICONTROL Design]** 모드 로 이동하여 원하는 페이지에서 변경할 수 있습니다.

### 장치 크기 변경

장치 크기를 다음과 같이 사전 정의된 크기로 변경할 수 있습니다 **[!UICONTROL Tablet]** 또는 **[!UICONTROL Mobile landscape]**&#x200B;또는 사용자 지정 크기를 정의합니다. 원하는 픽셀 수를 입력하여 사용자 정의 크기를 정의합니다.
...
1. 을(를) 선택합니다 **[!UICONTROL Modifications]** 버튼을 클릭하여 왼쪽에 해당 창을 표시합니다.
...
1. 를 사용하여 작업을 취소하거나 재실행할 수도 있습니다 **[!UICONTROL Undo/Redo]** 화면 오른쪽 상단의 단추.

   ![](assets/web-designer-undo-redo.png)

   버튼을 클릭하고 버튼을 눌러 **[!UICONTROL Undo]** 및 **[!UICONTROL Redo]** 옵션. 그런 다음 단추 자체를 클릭하여 원하는 작업을 적용합니다.

## 개인화 및 오퍼 추가

개인화를 추가하려면 컨테이너를 선택하고 표시되는 상황별 메뉴 표시줄에서 개인화 아이콘을 선택합니다. 표현식 편집기를 사용하여 변경 사항을 추가합니다. [추가 정보](../personalization/personalization-build-expressions.md)

![](assets/web-designer-personalization.png)

를 사용하십시오 **[!UICONTROL Offer decision]** 삽입할 구성 요소 [오퍼](../offers/get-started/starting-offer-decisioning.md) 참조하십시오. 프로세스는 와 같습니다 [이메일에 오퍼 추가](../email/add-offers-email.md). 의사 결정 관리 를 활용하여 고객에게 제공할 최상의 오퍼를 선택할 수 있습니다.
...
1. 다음 중 하나에서 **[!UICONTROL Edit content]** 화면 또는 웹 디자이너에서 **[!UICONTROL Simulate content]**.

   ![](assets/web-designer-simulate.png)

1. 클릭 **[!UICONTROL Manage test profiles]** 테스트 프로필을 한 개 이상 선택하려면 다음을 수행하십시오.
