...
**개 프로필**
Adobe Journey Optimizer은 실시간 고객 프로필과 함께 사용할 수 있는 다양한 기능을 제공하므로 브랜드가 고객에 대한 통합된 360도 보기를 만들 수 있습니다. 주요 &#x200B; 기능으로는 실시간 데이터 수집, ID 그래프 생성 및 고객 참여 도구가 있습니다. [프로필 시작](get-started-profiles.md)
