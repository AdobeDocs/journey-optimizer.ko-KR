...
* 이메일 또는 캠페인의 링크에서 고객이 마케팅 커뮤니케이션 또는 특정 서비스나 뉴스레터를 **옵트인 또는 옵트아웃**&#x200B;하도록 허용
...
1. [**테스트 및 게시**](manage-lp.md) — 페이지를 미리 보고, 양식 동작을 테스트한 다음 게시하여 라이브로 만듭니다.
...
* 사용자가 특정 서비스를 옵트인하거나 옵트아웃할 수 있도록 구독 목록을 포함하여 **옵트인 및 옵트아웃 흐름**&#x200B;을 빠르고 원활하게 설정합니다. [자세히 보기](lp-use-cases.md#subscription-to-a-service)
