...
1. 랜딩 페이지 URL 정의. URL의 첫 번째 부분에서는 이전에 랜딩 페이지 하위 도메인을 의 일부로 설정해야 합니다 [사전 설정](../landing-pages/lp-presets.md#lp-create-preset) 선택하셨습니다. [자세히 알아보기](../landing-pages/lp-subdomains.md)
...
1. 랜딩 페이지 URL 정의. URL의 첫 번째 부분에서는 이전에 랜딩 페이지 하위 도메인을 설정해야 합니다. [자세히 알아보기](../landing-pages/lp-subdomains.md)
...
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/segment/profiles/creating-test-profiles.html" text="테스트 프로필 선택"
