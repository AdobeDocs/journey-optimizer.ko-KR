...
>[!NOTE]
>
>첫 번째 랜딩 페이지를 만들기 전에 [랜딩 페이지 구성](../../rp_landing_pages/lp-configuration-landing-page.md) 설정을 완료하십시오. 여기에는 랜딩 페이지를 호스팅하도록 하위 도메인을 구성하는 작업과 하위 도메인 및 기타 채널 설정을 지정하는 하나 이상의 사전 설정을 정의하는 작업이 포함됩니다. 랜딩 페이지를 만들 때 사전 설정을 선택해야 합니다.
...
>[!CAUTION]
>
>* 랜딩 페이지를 게시하려면 **[!UICONTROL 메시지 게시]** 권한이 있어야 합니다.
>* 게시하기 전에 모든 경고를 확인하고 해결하십시오. [자세히 알아보기](#check-alerts)
