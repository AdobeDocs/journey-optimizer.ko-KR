...
**고급 HTML 편집기**&#x200B;는 여정, 캠페인에 대한 [이메일 디자인](content-from-scratch.md) 또는 [이메일 콘텐츠 템플릿](../content-management/create-content-templates.md)을(를) 편집하든 간에 [!DNL Journey Optimizer] [이메일 Designer](get-started-email-design.md)에서 직접 **이메일 콘텐츠**&#x200B;의 원시 HTML 소스를 보고 편집할 수 있는 전문가 모드입니다.
...
* [이메일 디자이너 시작하기](get-started-email-design.md)
