...
이메일 디자인에 대한 우수 사례는 아래 표를 참조하십시오.

| 권장 | 주의하여 사용 | 권장되지 않음 |
|-|-|-|
| <ul><li>구조용 <b>정적, 테이블 기반 레이아웃</b></li> <li>레이아웃 일관성을 위해 <b>HTML 테이블 및 중첩 테이블</b></li> <li>600px와 800px 사이의 <b>템플릿 너비</b> </li> <li>스타일링을 위한 <b>간단한 인라인 CSS</b> </li> <li><b>웹 지원 글꼴</b>(범용 호환성)</li> | <ul><li><b>배경 이미지</b>가 특정 전자 메일 플랫폼에 나타나지 않을 수 있습니다.</li><li><b>사용자 지정 웹 글꼴</b>은(는) 범용 지원이 없습니다.</li><li><b>넓은 레이아웃</b>이 작은 화면에 제대로 표시되지 않을 수 있습니다.</li><li><b>이미지 맵</b>은(는) 제한된 기능을 제공합니다.</li><li><b>포함된 CSS</b>이(가) 이메일 게재 중에 제거되는 경우가 있습니다.</li> | <ul><li><b>JavaScript</b>은(는) 일반적으로 이메일 환경에서 지원되지 않습니다.</li> <li> 대부분의 플랫폼에서 <b>`<iframe>`</b>개의 태그가 차단되었습니다. </li> <li><b>Flash</b>이(가) 오래되어 더 이상 지원되지 않습니다.</li> <li><b>포함된 오디오</b>이(가) 재생되지 않는 경우가 많습니다.</li> <li><b>포함된 비디오</b>이(가) 많은 전자 메일 플랫폼과 호환되지 않습니다.</li> <li> <b>Forms</b>은(는) 전자 메일 내에서 작동하지 않습니다.</li> <li> `<div>` 계층화로 인해 렌더링 문제가 발생할 수 있습니다.</li> |
