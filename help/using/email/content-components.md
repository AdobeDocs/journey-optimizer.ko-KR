...
이메일 콘텐츠를 만들 때 **[!UICONTROL Content components]** 이메일에 배치되면 편집할 수 있는 원시 구성 요소를 사용하여 이메일을 추가로 개인화할 수 있습니다.
...
1. 이메일 디자이너에서 기존 콘텐츠를 사용하거나 끌어서 놓습니다 **[!UICONTROL Structure components]** 빈 컨텐츠에 추가하여 전자 메일 레이아웃을 정의합니다. [방법 알아보기](content-from-scratch.md)

1. 에 액세스하려면 **[!UICONTROL Content components]** 섹션의 왼쪽 창에서 해당 버튼을 선택합니다.
...
1. 다음 아이콘을 사용하여 각 구성 요소의 스타일링 속성을 조정합니다 **[!UICONTROL Component settings]** 오른쪽 창입니다. 예를 들어 각 구성 요소의 텍스트 스타일, 패딩 또는 여백을 변경할 수 있습니다. [정렬 및 패딩에 대해 자세히 알아보기](alignment-and-padding.md)
...
예를 들어 **[!UICONTROL Container]** 구성 요소를 추가한 다음 [단추](#button) 구성 요소를 생성하지 않습니다. 특정 컨테이너 배경을 사용할 수도 있고 단추에 다른 배경을 사용할 수도 있습니다.

![](assets/email_designer_container_component.png)

## 단추 {#button}

를 사용하십시오 **[!UICONTROL Button]** 이메일에 하나 이상의 단추를 삽입하고 이메일 대상자를 다른 페이지로 리디렉션하는 구성 요소입니다.

1. From **[!UICONTROL Content components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL Button]** 구성 요소를 **[!UICONTROL Structure component]**.

1. 새로 추가한 버튼을 클릭하여 텍스트를 개인화하고 **[!UICONTROL Components settings]** 전자 메일 디자이너 오른쪽 창에서 클릭합니다.

   ![](assets/email_designer_button_component.png)

1. 에서 **[!UICONTROL Link]** 필드에서 버튼을 클릭할 때 리디렉션할 URL을 추가합니다.
...
1. 다음과 같은 스타일 속성을 변경하여 단추를 추가로 개인화할 수 있습니다 **[!UICONTROL Border]**, **[!UICONTROL Size]**, **[!UICONTROL Margin]**&#x200B;등 에서 **[!UICONTROL Component settings]** 창

## 텍스트 {#text}

를 사용하십시오 **[!UICONTROL Text]** 텍스트를 전자 메일에 삽입하고 스타일(테두리, 크기, 패딩 등)을 조정할 수 있는 구성 요소입니다 사용 **[!UICONTROL Component settings]** 창

![](assets/email_designer_text_component.png)

1. From **[!UICONTROL Content components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL Text]** 구성 요소를 **[!UICONTROL Structure component]**.
...
1. 도구 모음에서 사용할 수 있는 다음 옵션을 사용하여 텍스트를 변경합니다.
   ...
   * **[!UICONTROL Enable conditional content]**: 조건부 컨텐츠를 추가하여 구성 요소의 컨텐츠를 타깃팅된 프로필에 적용합니다. [다이내믹 컨텐츠에 대해 자세히 알아보기](../personalization/get-started-dynamic-content.md)

1. 텍스트 색상, 글꼴 패밀리, 테두리, 패딩, 여백 등과 같은 기타 스타일 속성을 조정합니다. 에서 **[!UICONTROL Component settings]** 창

## 구분선 {#divider}

를 사용하십시오 **[!UICONTROL Divider]** 전자 메일의 레이아웃과 콘텐츠를 구성하는 분할 라인을 삽입하는 구성 요소입니다.

선 색상, 스타일 및 높이와 같은 스타일 속성을 **[!UICONTROL Component settings]** 창
...
1. From **[!UICONTROL Content Components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL HTML]** 구성 요소를 **[!UICONTROL Structure component]**.

1. 새로 추가된 구성 요소를 클릭한 다음, 을 선택합니다 **[!UICONTROL Show the source code]** 상황별 도구 모음에서 HTML을 추가합니다.

   ![](assets/email_designer_html_component.png)

1. 이메일에 추가할 HTML 코드를 복사하여 붙여넣은 다음 **[!UICONTROL Save]**.

   ![](assets/email_designer_html_content.png)

>[!NOTE]
>
>이메일 디자이너와 호환되는 외부 콘텐츠를 만들기만 하면 됩니다. 메시지를 처음부터 만들고 기존 이메일의 콘텐츠를 구성 요소로 복사하는 것이 좋습니다.

## 이미지 {#image}

를 사용하십시오 **[!UICONTROL Image]** 컴퓨터의 이미지 파일을 전자 메일 콘텐츠에 삽입하는 구성 요소입니다.

1. From **[!UICONTROL Content components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL Image]** 구성 요소를 **[!UICONTROL Structure component]**.
...
1. 새로 추가한 구성 요소를 클릭하고 **[!UICONTROL Components settings]** 창:
...
1. 여백, 테두리 등과 같은 다른 스타일 속성을 조정합니다. 또는 링크를 추가하여 대상자를 **[!UICONTROL Component settings]** 창
...
를 사용하십시오 **[!UICONTROL Video]** URL 링크를 통해 이메일 콘텐츠에 비디오를 삽입하는 구성 요소입니다.

1. From **[!UICONTROL Content Components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL Video]** 화합물 **[!UICONTROL Structure component]**.

   ![](assets/email_designer_17.png)

1. 새로 추가한 구성 요소를 클릭합니다.

1. 에서 **[!UICONTROL Video link]** 필드 **[!UICONTROL Components settings]** 창에서 비디오 URL을 추가합니다.

   ![](assets/email_designer_18.png)

1. 을(를) 추가할 수 있습니다 **[!UICONTROL Poster image]** 를 추가하여 대상자가 재생 버튼을 클릭할 때까지 표시할 이미지를 지정합니다.

1. 스타일, 여백, 테두리 등과 같은 다른 스타일 속성을 조정합니다. 에서 **[!UICONTROL Component settings]** 창

## Social {#social}

를 사용하십시오 **[!UICONTROL Social]** 소셜 미디어 페이지에 대한 링크를 이메일 콘텐츠에 삽입하는 구성 요소입니다.

1. From **[!UICONTROL Content Components]**&#x200B;을(를) 끌어다 놓습니다. **[!UICONTROL Social]** 구성 요소를 **[!UICONTROL Structure component]**.

1. 새로 추가한 구성 요소를 클릭합니다.

1. 에서 **[!UICONTROL Social]** 필드 **[!UICONTROL Components settings]** 창에서 추가하거나 제거할 소셜 미디어를 선택합니다.
...
1. 필요한 경우, 각 소셜 미디어의 아이콘을 변경할 수도 있습니다 **[!UICONTROL Image]** 필드.

1. 스타일, 여백, 테두리 등과 같은 다른 스타일 속성을 조정합니다. 에서 **[!UICONTROL Component settings]** 창

## 오퍼 결정 {#offer-decision}

를 사용하십시오 **[!UICONTROL Offer decision]** 오퍼를 메시지에 삽입하는 구성 요소입니다. 다음 [의사 결정 관리](../offers/get-started/starting-offer-decisioning.md) 엔진은 고객에게 제공할 최상의 오퍼를 선택합니다.
