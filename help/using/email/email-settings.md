...
**[!UICONTROL 헤더 매개변수]** 섹션에서 해당 구성을 사용한 이메일 유형에 대한 **발신자**, **회신 대상**, **오류** 값을 입력합니다. [자세히 알아보기](header-parameters.md)


선택적으로, 전송자가 **발신자**&#x200B;에 입력한 작성자와 달라야 하는 경우, 이메일 헤더에 추가할 다른 **보낸 사람** 이름 및 이메일을 설정합니다. [자세히 알아보기](header-parameters.md#sender-header)
