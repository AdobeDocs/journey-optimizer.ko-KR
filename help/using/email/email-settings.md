...
* 배치 여정의 경우, 이메일 표면 구성이 완료되기 전에 이미 시작된 배치 실행에는 적용되지 않습니다. 변경 사항은 다음 반복 또는 새 실행에 적용됩니다.
...
* 소매점의 주간 프로모션과 같은 프로모션 이메일의 경우, **마케팅** 유형을 선택합니다. 이러한 메시지는 사용자 동의가 필요합니다.

* 주문 확인, 암호 재설정 알림, 배송 정보와 같은 비상업적 이메일의 경우, **트랜잭션** 유형을 선택합니다. 이러한 이메일은 마케팅 커뮤니케이션에서 **구독을 취소**&#x200B;한 프로필로 전송될 수 있습니다. 이러한 메시지는 특정 상황에서만 전송될 수 있습니다.
...
목록에서 하위 도메인을 선택하면 **[!UICONTROL 목록 구독 취소 활성화]** 옵션이 표시됩니다. 기본적으로 활성화되어 있습니다.

이 옵션을 활성화하면 이메일 헤더에 원클릭 구독 취소 URL을 포함할 수 있습니다. [자세히 알아보기](list-unsubscribe.md)

## 헤더 매개변수 {#email-header}

**[!UICONTROL 헤더 매개 변수]** 섹션에서 해당 구성을 사용하여 보낸 전자 메일 형식에 대한 **보낸 사람**, **회신** 및 **오류** 값을 입력하십시오. [자세히 알아보기](header-parameters.md)


선택적으로, 보낸 사람이 **보낸 사람** 작성자와 달라야 하는 경우 전자 메일 헤더에 추가할 다른 **보낸 사람** 이름 및 전자 메일을 설정하십시오. [자세히 알아보기](header-parameters.md#sender-header)
...
이를 위해서는 채널 구성 수준에서 **[!UICONTROL BCC 이메일]** 선택 기능을 활성화해야 합니다. [자세히 알아보기](../configuration/archiving-support.md#bcc-email)
