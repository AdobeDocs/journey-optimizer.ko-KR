...
* 배치 여정의 경우, 이메일 표면 구성이 완료되기 전에 이미 시작된 배치 실행에는 적용되지 않습니다. 변경 사항은 다음 반복 또는 새 실행에서 적용됩니다.
...
>[!NOTE]
>
>이메일 설정을 보다 세밀하게 관리하기 위해 동적 하위 도메인을 정의할 수 있습니다. 자세히 알아보기 [자세히 알아보기](../email/surface-personalization.md#dynamic-subdomains)

도메인의 신뢰도를 유지하고, IP 준비 프로세스 속도를 높이며, 전달성을 향상시키기 위해 전송 하위 도메인을 Adobe에 위임할 수 있습니다. 자세히 알아보기. [자세히 알아보기](../configuration/about-subdomain-delegation.md)

## IP 풀 세부 정보 {#ip-pools}

구성에 연결할 IP 풀을 선택합니다. 자세히 보기 [자세히 알아보기](../configuration/ip-pools.md)
...
IP 풀을 선택한 후, IP 풀 드롭다운 목록 아래에 표시된 IP 주소에 마우스를 가져다 대면 PTR 정보가 표시됩니다. PTR 기록에 대해 자세히 알아보기 [PTR 레코드에 대해 자세히 알아보기](../configuration/ptr-records.md)
...
이 옵션을 활성화하면 이메일 헤더에 원클릭 구독 취소 URL을 포함할 수 있습니다. 자세히 알아보기 [자세히 알아보기](list-unsubscribe.md)

## 헤더 매개변수 {#email-header}

**[!UICONTROL 헤더 매개변수]** 섹션에서 해당 구성을 사용한 이메일 유형과 연결된 발신자 이름과 이메일 주소를 입력합니다. 자세히 알아보기 [자세히 알아보기](header-parameters.md)
...
이를 위해서는 **[!UICONTROL 게재 주소]** 필드를 편집하고 사용 가능한 이메일 유형 XDM 필드 목록에서 항목을 선택합니다.


![](assets/email-config-delivery-address.png)

실행 필드가 업데이트되어 기본 주소로 사용되며. 샌드박스 수준의 일반 설정보다 우선 적용됩니다.
