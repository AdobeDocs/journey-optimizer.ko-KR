...
1. 을(를) 클릭합니다. **[!UICONTROL Navigation tree]** 왼쪽 창에서 아이콘을 선택하고 **[!UICONTROL Body]**.

   ![](assets/preheader_body.png)

1. 에서 **[!UICONTROL Body settings]** 오른쪽 창에서 다음 옆에 있는 편집 아이콘을 클릭합니다 **[!UICONTROL Preheader]** 필드를 추가하여 컨텐츠를 추가합니다.
