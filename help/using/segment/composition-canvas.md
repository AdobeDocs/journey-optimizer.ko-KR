...
<li><b><a href="composition-canvas.md">컴포지션 캔버스 작업</a></b></li>
...
1. 타깃팅할 대상 선택:
   ...
   * 다음을 클릭합니다. **[!UICONTROL 규칙 작성]** 단추를 클릭하여 새 세그먼트 정의를 [세분화 서비스](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/overview.html).
...
>id="ajo_ao_enrich"
>title="활동 강화"
>abstract="보강 활동을 사용하여 기존 대상자에 속한 프로필을 제외합니다. 속성 유형을 사용하여 제외 를 사용하면 특정 속성에 따라 프로필을 제외할 수 있습니다."
...
>title="데이터 보강 속성"
>abstract="대상자에 연결할 데이터 보강 세트에서 속성을 하나 또는 여러 개 선택하십시오. 컴포지션이 게시되면 이러한 속성이 대상과 연결되고 캠페인에서 활용하여 게재를 개인화할 수 있습니다."
...
1. 다음을 클릭합니다. **[!UICONTROL 속성 추가]** 버튼을 누른 다음 강화 데이터 세트에서 대상자에 연결할 하나 또는 여러 속성을 선택합니다.
...
이 작업은 **[!UICONTROL 저장]** 각 경로의 끝에 있는 활동. 컴포지션을 게시할 때 각 경로에 대해 한 명의 대상이 Adobe Experience Platform에 저장됩니다.
