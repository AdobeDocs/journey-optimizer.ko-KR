...
대상 작성으로 인한 대상은 **[!UICONTROL 찾아보기]** 탭에서 다음을 수행합니다. **[!UICONTROL 세그먼트]** 메뉴 아래의 제품에서 사용할 수 있습니다.
...
>[!NOTE]
>
>이 베타 버전의 경우, 세그먼트 인벤토리에 처음 표시된 여러 구성 요소 및/또는 메타데이터는 이 탭(예: 분류, 평가 방법 등)에 표시되지 않습니다.
>
