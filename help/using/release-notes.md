...
* **글로벌 보기의 데이터 형식** - 이제 **글로벌 보기**(**실행** 탭 내)에서 숫자와 백분율 간을 전환할 수 있습니다. [자세히 알아보기](message-monitoring.md)
...
* **검색** - 이제 모든 페이지에서 통합 Experience Cloud 검색 필드를 통해 직접 비즈니스 개체 및 도움말을 검색할 수 있습니다. [자세히 알아보기](user-interface.md#unified-search)
...
* **배경** - 이제 배경 이미지가 실시간 미리 보기에서 지원됩니다. [자세히 알아보기](preview.md)
* **원클릭 옵트아웃 링크** - 이메일 콘텐츠에 새로운 유형의 링크를 삽입할 수 있습니다. **옵트아웃** 링크를 사용하면 옵트아웃을 확인하기 위해 랜딩 페이지로 리디렉션되지 않고 한 번의 클릭으로 커뮤니케이션 구독을 취소할 수 있습니다. [자세히 알아보기](message-tracking.md#one-click-opt-out-link)
...
* **허용 목록** - 이제 API 호출을 통해 비프로덕션 샌드박스에서 허용 목록을 활성화 및 비활성화할 수 있습니다. [자세히 알아보기](allow-list.md#enable-allow-list)
...
* 여정 목록 화면에 여정 유형 필터를 추가했습니다. [자세히 보기](user-interface.md#section_lgm_hpz_pgb)
...
* 이제 신원과 네임스페이스가 **[!UICONTROL Preview]** 화면에 표시됩니다. [자세히 보기](preview.md#preview-your-messages)
* 이제 교정용 테스트 이메일 수가 10개로 제한됩니다.
* 교정을 보낼 때 **제목 줄 접두사**&#x200B;에 사용할 수 있는 문자가 제한됩니다. [자세히 보기](preview.md#send-proofs)
