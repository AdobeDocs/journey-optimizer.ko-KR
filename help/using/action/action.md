...
**작업** 목록에서 c 키를 누르면 새 여정, 작업, 데이터 소스 또는 이벤트를 만들 수 있습니다. 바로 가기에 대한 자세한 내용은 [이 섹션](../user-interface.md#cjm-accessibility)을 참조하십시오.

작업 목록을 확인하거나 새 작업을 구성하려면 왼쪽 탐색에서 **[!UICONTROL Administration]** / **[!UICONTROL Configuration]** 로 이동합니다. 그러면 작업 목록이 표시됩니다. 인터페이스에 대한 자세한 내용은 [이 페이지](../user-interface.md)를 참조하십시오.
