...
>abstract="**오케스트레이션** 탭에는 모든 오케스트레이션된 캠페인이 나열되어 있습니다. 오케스트레이션된 캠페인의 이름을 클릭하여 편집할 수 있습니다. **오케스트레이션된 캠페인 만들기** 버튼을 사용하여 새 오케스트레이션된 캠페인을 추가합니다."

오케스트레이션된 캠페인을 만들려면 다음 단계를 수행합니다.

1. **[!UICONTROL 캠페인]** 메뉴로 이동한 다음 **[!UICONTROL 오케스트레이션]** 탭을 선택합니다.

1. **[!UICONTROL 캠페인 만들기]** 단추를 클릭하고 **[!UICONTROL 오케스트레이션 - 마케팅 및 트랜잭션]** 캠페인 유형을 선택합니다.

   [채널 활동](../orchestrated/activities/channels.md)을 추가할 때 각 메시지가 마케팅인지 아니면 트랜잭션인지를 선택합니다.
...
>[!NOTE]
>
>일정에 따라 실행되는 대신 외부 시스템 또는 애플리케이션에서 신호를 받으면 캠페인을 시작할 수도 있습니다. [신호를 사용하여 오케스트레이션된 캠페인을 트리거하는 방법을 알아봅니다](trigger-orchestrated-campaign.md).
