...
title: 오케스트레이션된 캠페인에서 전역 변수 정의
description: 오케스트레이션된 캠페인에서 전역 변수를 추가하고 관리하는 방법을 알아봅니다.
feature: Campaigns
...
1. **[!UICONTROL 저장]** 옆에 있는 **..** 아이콘을 클릭한 다음 **[!UICONTROL 변수 편집]**&#x200B;을 선택합니다.
   ...
   ![캠페인 메뉴의 변수 편집 옵션](assets/variables-list.png){zoomable="yes"}

1. **[!UICONTROL 변수 추가]**&#x200B;를 클릭하고 변수의 이름과 값을 설정합니다. 기존 변수를 편집하려면 **..** 단추를 클릭하고 **[!UICONTROL 편집]**&#x200B;을 선택합니다.

   변수를 추가하거나 편집할 ![변수 패널](assets/variables-edit.png){zoomable="yes"}
