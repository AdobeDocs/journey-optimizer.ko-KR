...
Journey Optimizer Campaign Orchestration은 먼저 모델 기반 스키마 위에 임시 쿼리를 작성할 수 있습니다. 모델 기반 스키마는 현재만 배치 소스를 지원합니다. 또한 모든 유형의 Adobe Experience Platform 대상에서 대상자 읽기를 지원합니다.
