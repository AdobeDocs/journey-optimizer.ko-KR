...
## 오케스트레이션된 캠페인에 데이터 세트 활성화 {#enable}

>[!CONTEXTUALHELP]
>id="ajo_oc_enable_dataset_for_oc"
>title="오케스트레이션된 캠페인"
>abstract="데이터 세트를 만든 후에는 오케스트레이션된 캠페인에 대해 명시적으로 활성화해야 합니다. 이 단계를 통해 데이터 세트를 Adobe Journey Optimizer 내에서 실시간 오케스트레이션 및 개인화할 수 있습니다."


데이터 세트를 만든 후에는 오케스트레이션된 캠페인에 대해 명시적으로 활성화해야 합니다. 이 단계를 통해 데이터 세트를 Adobe Journey Optimizer 내에서 실시간 오케스트레이션 및 개인화할 수 있습니다.
