...
**[!UICONTROL 결합]** 활동에서 **[!UICONTROL 결합]**&#x200B;을 구성할 수 있습니다. 이를 위해 **[!UICONTROL 조정 유형]**&#x200B;을(를) 선택하여 중복 처리 방법을 정의해야 합니다.
...
1. **[!UICONTROL 참여 설정]** 섹션에서 인바운드 전환의 **[!UICONTROL 기본 세트]**&#x200B;를 선택합니다. 요소가 제외되는 집합입니다. 다른 집합은 기본 집합에서 제외되기 전에 요소와 일치합니다.
