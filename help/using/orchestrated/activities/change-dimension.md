...
마케터는 오케스트레이션된 캠페인 내에 있는 한 데이터 엔티티에서 관련된 다른 엔티티로 전환하여 대상자 타기팅을 향상시킬 수 있습니다. 이를 통해 단순히 사용자 프로필을 활용하는 것을 넘어 구매, 예약 또는 기타 상호 작용과 같은 특정 행동에 집중할 수 있습니다.

이렇게 하려면 **[!UICONTROL 차원 변경]** 활동을 사용합니다. 이 활동을 사용하면 오케스트레이션된 캠페인 중에 타기팅 차원을 조정할 수 있습니다.
...
그런 다음 **[!UICONTROL 차원 변경]** 활동을 추가하여 타기팅 차원을 **[!UICONTROL 위시리스트]**&#x200B;에서 **[!UICONTROL 수신자]로 전환합니다.** 이 단계에서는 오케스트레이션된 캠페인 타깃이 해당 위시리스트에 연결된 올바른 프로필을 사용하도록 하여 의도한 프로필로 SMS를 보낼 수 있도록 합니다.
