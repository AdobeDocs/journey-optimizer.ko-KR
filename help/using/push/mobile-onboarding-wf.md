...
이 새로운 워크플로우는 총 클릭 수를 줄이고 Journey Optimizer에 대한 모바일 구성을 가속화하여 데이터 수집 설정을 자동화합니다. 이 빠른 시작 워크플로우에서는 모바일 구성을 [설정](#gs-mobile-wf), [구현](#implement-mobile-wf), [유효성 검사](#valid-mobile-wf) 및 [검토](#review-mobile-wf)하는 네 가지 간단한 단계를 수행합니다.
...
구현을 검토하고 확인하여 확인합니다. 테스트 푸시 알림을 보낼 수 있습니다.
...
* [푸시 알림 보고서](../reports/journey-global-report-cja-push.md#track-link-url-push)
