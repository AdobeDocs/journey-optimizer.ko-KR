...
푸시 알림은 특히 모바일 앱 사용자가 앱을 적극적으로 사용하지 않을 때 언제든지 모바일 앱 사용자에게 연락할 수 있도록 지원합니다. 푸시 알림은 서비스에 대한 업데이트 제공, 사용자에게 조치 요청하기, 사용자에게 새로운 딜 알리기 등 다양한 사용 사례를 달성하는 데 도움이 될 수 있습니다.  플랫폼의 규정에 따라 최종 사용자가 알림을 받거나 보려면 옵트인이 필요합니다. 사용자 옵트인은 앱을 설치한 후 처음 시작할 때 바로 받거나, 필요에 따라 후속 세션이나 워크플로를 통해 받을 수 있습니다.
...
전용 탭을 사용하여 **iOS** 및 **Android**&#x200B;에 대한 푸시 알림 설정을 정의합니다.
