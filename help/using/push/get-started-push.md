...
푸시 알림은 특히 모바일 앱 사용자가 앱을 적극적으로 사용하지 않거나 웹 사이트를 탐색하지 않는 경우 언제든지 모바일 앱 사용자 및 웹 방문자에게 연락할 수 있도록 지원합니다. 푸시 알림은 서비스에 대한 업데이트 제공, 사용자에게 조치 요청하기, 사용자에게 새로운 딜 알리기 등 다양한 사용 사례를 달성하는 데 도움이 될 수 있습니다.  플랫폼의 규정에 따라 최종 사용자가 알림을 받거나 보려면 옵트인이 필요합니다. 사용자 옵트인은 앱을 설치한 후 처음 시작할 때 바로 받거나, 필요에 따라 후속 세션이나 워크플로를 통해 받을 수 있습니다.
...
전용 탭을 사용하여 **iOS**, **Android** 및 **웹** 플랫폼에 대한 푸시 알림 설정을 정의합니다.

>[!NOTE]
>
>**[!DNL Journey Optimizer]**&#x200B;는 이메일 및 SMS 메시지에서 옵트아웃을 관리하는 방법을 제공하지만, 푸시 알림은 수신자가 디바이스를 통해 직접 구독을 취소할 수 있으므로 별도의 작업이 필요하지 않습니다. 예를 들어, 앱을 다운로드하거나 사용하는 경우 알림을 중지하도록 선택할 수 있습니다. 마찬가지로 모바일 운영 체제나 웹 브라우저 설정을 통해 알림 설정을 변경할 수 있습니다.
