...
Adobe Journey Optimizer에서 ABAC를 사용하여 데이터를 보호하고 XDM(Experience Data Model) 스키마, 프로필 속성 및 세그먼트를 포함한 특정 필드 요소에 대한 특정 액세스 권한을 부여할 수 있습니다.
...
1. 를 사용하십시오  **[!UICONTROL Schema field]** ( Adobe Journey Optimizer )를 참조하십시오.
...
1. 에서 **[!UICONTROL Users]** 탭, **[!UICONTROL Add users]**.

   ![](assets/role_8.png)

1. 에서 **[!UICONTROL Labels]** 탭, 선택 **[!UICONTROL Add label]**.
...
레이블 지정 후 **국적** 이제 새 스키마에서 필드 이름과 새 역할에 대해 이러한 제한이 Adobe Journey Optimizer에서 미치는 영향을 확인할 수 있습니다.
예를 들어, C2라는 레이블이 지정된 객체에 액세스할 수 있는 첫 번째 사용자 X가 제한된 객체를 대상으로 하는 조건이 있는 여정을 만듭니다 **[!UICONTROL Field name]**. C2 레이블이 지정된 객체에 액세스할 수 없는 두 번째 사용자 Y가 여정을 게시해야 합니다.

1. Adobe Journey Optimizer에서 먼저 다음을 구성해야 합니다 **[!UICONTROL Data source]** 새 스키마 사용.

   ![](assets/journey_1.png)

1. 새 추가 **[!UICONTROL Field group]** 새로 만든 **[!UICONTROL Schema]** 기본 제공 **[!UICONTROL Data source]**. 새 외부 파일을 만들 수도 있습니다 **[!UICONTROL data source]** 및 관련 **[!UICONTROL Field groups]**.
...
1. 필요에 따라 고객 여정을 개인화하고 **[!UICONTROL Email]** 작업.

   ![](assets/journey_8.png)

C2 객체에 레이블을 지정할 수 없는 사용자 Y가 이 제한된 필드를 사용하여 이 여정에 액세스해야 하는 경우:
