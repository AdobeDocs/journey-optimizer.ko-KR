...
| 의사 결정 관리 | <ul> <li>**[!DNL Manage decisions]**: 결정을 읽고 만들고 편집하고 삭제합니다.</li> <li>**[!DNL Manage ranking strategies]**: 등급 전략을 읽고, 만들고, 편집하고, 삭제합니다.</li> </ul> |
| 여정 | <ul> <li>**[!DNL Manage journeys]**: 여정 읽기, 만들기, 편집, 중지(실시간, 테스트 모드 및 시험 실행) 및 삭제 </li> <li>**[!DNL Manage journeys events, data sources and actions]**: 이벤트, 소스 또는 작업을 읽고, 만들고, 편집하고, 삭제합니다.</li> <li>**[!DNL Publish journeys]**: 여정 게시, 테스트 모드 시작, 시험 실행 시작, 일시 중지 및 다시 시작 </li> <li>**[!DNL View journeys report]**: 여정 보고서를 읽고 편집합니다.</li> </ul> |
...
| 의사 결정 관리 | <ul><li>**[!DNL Manage decisions]**: 의사 결정 엔터티를 읽고 만들고 편집하고 삭제합니다.</li><li>**[!DNL Manage ranking strategies]**: 사용자 지정 보고서를 읽고, 만들고, 편집하고, 삭제하고, 작업 기능을 사용합니다.</li></ul> |
| 여정 | <ul><li>**[!DNL Manage journeys]**: 여정 읽기, 만들기, 편집, 중지(실시간, 테스트 모드 및 시험 실행) 및 삭제 </li><li>**[!DNL Publish journey]**: 여정 게시, 테스트 모드 시작, 시험 실행 시작, 일시 중지 및 다시 시작 </li><li>**[!DNL View journeys events, data sources and actions]**: 여정 이벤트, 여정 지정 작업 및 여정 데이터 소스에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL View journeys report]**: 여정 보고서를 읽고 편집합니다.</li></ul> |
...
| 채널 구성 | <ul><li>**[!DNL View channel configurations]**: 채널 구성에 대한 읽기 전용 액세스 권한.</li></ul> |
| 의사 결정 관리 | <ul><li>**[!DNL Manage decisions]**: 의사 결정 엔터티를 읽고 만들고 편집하고 삭제합니다.</li><li>**[!DNL Manage ranking strategies]**: 사용자 지정 보고서를 읽고, 만들고, 편집하고, 삭제하고, 작업 기능을 사용합니다.</li></ul> |
| 여정 | <ul><li>**[!DNL Manage journeys]**: 여정 읽기, 만들기, 편집, 중지(실시간, 테스트 모드 및 시험 실행) 및 삭제</li><li>**[!DNL View journeys events]**: 여정 이벤트, 여정 지정 작업 및 여정 데이터 소스에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL View journeys report]**: 여정 보고서를 읽고 편집합니다.</li></ul> |
...
* **TL;DR:** Journey Optimizer은 캠페인 관리자에서 오케스트레이션된 캠페인 뷰어에 이르기까지 기본 제공 역할과 함께 제공되므로, 관리자는 처음부터 역할을 빌드하지 않고도 책임과 일치하는 액세스 수준을 사용자에게 신속하게 부여할 수 있습니다.

**의도:**

* 사용자의 직무에 가장 적합한 기본 제공 역할 확인
* 각 기본 제공 역할이 수행할 수 있는 작업 및 수행할 수 없는 작업 이해(게시 권한 포함)
* 여정, 캠페인 및 오케스트레이션된 캠페인 도메인에서 역할 비교
* 사용자 정의 역할을 만드는 대신 준비된 역할을 할당하십시오.
* AI Assistant 액세스를 포함하는 역할 이해

**용어집:**

* **기본 제공 역할**: 사용자 지정 구성 *(제품별) 없이 사용자에게 할당할 준비가 된 사전 정의된 권한 및 리소스 권한 집합*
* **여정 관리자**: 채널 구성 및 데이터 거버넌스 권한을 포함하여 여정 및 의사 결정 관리의 관리 및 게시를 활성화하는 기본 제공 역할 *(제품별)*
* **캠페인 관리자**: 채널 구성 *(제품별)을(를) 포함하여 캠페인 및 의사 결정 관리의 관리 및 게시를 활성화하는 기본 제공 역할*
* **의사 결정 관리자**: 의사 결정 관리 메뉴에만 액세스할 수 있는 기본 제공 역할로, 의사 결정 *(제품별) 관리, 보기 및 게시할 수 있습니다.*
* **콘텐츠 라이브러리 관리자**: 콘텐츠 템플릿 메뉴에만 액세스할 수 있는 기본 제공 역할로, 여정 또는 캠페인에 액세스할 수 없습니다. *(제품별)*
* **테스트 모드**: 여정 관리 및 여정 게시 권한에서 참조한 여정 실행 모드(여정 관리자는 테스트 모드에서 여정을 중지할 수 있으며, 여정 게시 권한은 테스트 모드 시작을 포함) *(제품별)*
* **시험 실행**: 테스트 모드 *(제품별)과(와) 함께 여정 관리 및 여정 게시 권한에 참조된 여정 실행 모드*

**용어:**

* 정식 이름: 기본 제공 역할 — 변형: 기본 제공 역할, OOTB 역할, 제품 프로필
* 다음과 같이 혼동하지 마십시오. &quot;캠페인 승인자&quot;(캠페인 승인 및 게시 가능) ≠ &quot;캠페인 관리자&quot;(캠페인을 만들고 편집할 수 있지만 게시할 수 없음)
* 혼동하지 마십시오. &quot;여정 승인자&quot;(여정 승인 및 게시 가능)≠ &quot;여정 관리자&quot;(여정을 만들고 편집할 수 있지만 게시할 수 없음)
* 다음과 같은 항목을 혼동하지 마십시오. &quot;여정 뷰어&quot;(여정 및 의사 결정 관리에 대한 읽기 전용 액세스) ≠ &quot;캠페인 뷰어&quot;(캠페인 및 의사 결정 관리에 대한 읽기 전용 액세스)
* 다음과 같이 혼동하지 마십시오. &quot;오케스트레이션된 캠페인 관리자&quot;(오케스트레이션된 캠페인 관리, AI 어시스턴트 및 데이터 수집/관리 포함) ≠ &quot;캠페인 관리자&quot;(표준 캠페인 관리, 오케스트레이션된 캠페인 권한 포함)
* &quot;테스트 모드&quot;(여정 관리/게시 여정을 통해 중단하거나 시작할 수 있는 여정 실행 상태로 참조됨) ≠ &quot;시험 실행&quot;(동일한 권한에서도 별도의 여정 실행 모드가 참조됨)을 혼동하지 마십시오.

**FAQ:**

* **Q: 여정을 게시할 수 있는 기본 제공 역할은 무엇입니까?** — 여정 관리자 및 여정 승인자는 여정을 게시할 수 있습니다.
* **Q: 여정 관리자가 여정을 게시할 수 있습니까?** — 아니요. 여정 관리자는 여정을 만들고 편집할 수 있지만 여정 게시 권한은 해당 역할에 포함되지 않습니다.
* **Q: [의사 결정 관리] 메뉴에 대한 액세스 권한만 부여하는 역할은 무엇입니까?** — 의사 결정 관리자
* **Q: 콘텐츠 템플릿에만 액세스할 수 있는 역할은 무엇입니까?** — 컨텐츠 라이브러리 관리자
* **Q: AI Assistant 사용 권한이 포함된 기본 역할은 무엇입니까?** — 오케스트레이션된 캠페인 관리자, 오케스트레이션된 캠페인 승인자, 오케스트레이션된 캠페인 관리자 및 오케스트레이션된 캠페인 뷰어입니다.
