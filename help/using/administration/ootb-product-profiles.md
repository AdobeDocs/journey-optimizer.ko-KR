...
다음 **[!DNL Journey Administrator]** 제품 프로필을 사용하면 관리 메뉴에서 여정, 메시지 및 의사 결정 관리를 관리하고 게시할 수 있습니다.
...
|메시지| <ul><li>**[!DNL Manage messages]**: 메시지 및 랜딩 페이지를 읽고, 만들고, 편집하고, 삭제할 수 있습니다.</li><li>**[!DNL Publish messages]** 메시지 및 랜딩 페이지를 게시합니다.</li><li>**[!DNL Manage messages preview and test]**: 메시지/랜딩 페이지 미리 보기를 읽고, 만들고 편집하고, 테스트/증명을 보냅니다.</li><li>**[!DNL View messages report]**: 메시지 및 랜딩 페이지 보고서를 읽고 편집합니다.</li></ul>|
...
|메시지| <ul><li>**[!DNL Manage messages]**: 메시지 및 랜딩 페이지를 읽고, 만들고, 편집하고, 삭제할 수 있습니다.</li><li> **[!DNL Manage messages preview and test]**: 메시지/랜딩 페이지 미리 보기를 읽고, 만들고 편집하고, 테스트/증명을 보냅니다.</li><li>**[!DNL View messages report]**: 메시지 및 랜딩 페이지 보고서를 읽고 편집합니다.</li></ul>|
|의사 결정 관리| <ul><li>**[!DNL Manage decisions]**: 의사결정 엔티티를 읽기, 만들기, 편집 및 삭제합니다.</li><li>**[!DNL Manage ranking strategies]**: 사용자 정의 메시지 보고서를 읽고, 만들고, 편집하고, 삭제하고, 작업 기능을 사용하십시오.</li></ul>| |Adobe Experience Platform| <ul><li> **[!DNL Manage segments]**: 세그먼트 및 구독 목록을 읽고, 만들고, 편집하고, 삭제합니다.</li><li>**[!DNL Manage profiles]**: 프로필 읽기, 만들기, 편집 및 삭제합니다.</li><li>**[!DNL Read datasets]**: 데이터 세트에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Read schemas]**: 스키마에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Manage merge policies]**: 병합 정책을 읽고, 만들고, 편집하고, 삭제합니다.</li></ul>|
|관리| <ul><li>**[!DNL View messages presets]**: 메시지 사전 설정에 대한 읽기 전용 액세스 권한.</li></ul>|

## [!DNL Journey viewer] {#journey-viewer}

다음 **[!DNL Journey viewer]** 제품 프로필에서는 읽기 전용 액세스 권한을 갖습니다 **[!UICONTROL Journeys]**, **[!UICONTROL Goals]**, **[!UICONTROL Messages]** 및 **[!UICONTROL Decision management]** 기능.
...
|메시지| <ul><li>**[!DNL View messages]**: 메시지 및 랜딩 페이지에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL View messages report]**: 메시지 및 랜딩 페이지 보고서에 대한 읽기 전용 액세스 권한.</li></ul>|
|의사 결정 관리| <ul><li>**[!DNL View decisions]**: 의사 결정 엔터티에 대한 읽기 전용 액세스 권한.</li></ul>|

## [!DNL Message Manager] {#message-manager}

다음 **[!DNL Message Manager]** 제품 프로필을 사용하면 사용자가 만들고 편집할 수 있습니다 **[!UICONTROL Messages]** 및 **[!UICONTROL Decision management]** 게시할 수 없습니다.

이 제품 프로필에는 다음과 같은 권한이 포함됩니다.

| 기능 | 권한| |-|-| |여정| <ul><li>**[!DNL View journeys]**: 여정에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL View Journeys events, data sources and actions]**: 여정 이벤트, 여정 사용자 지정 작업 및 여정 데이터 소스에 대한 읽기 전용 액세스 권한.</li></ul>|
|메시지| <ul><li>**[!DNL Manage messages]**: 메시지 및 랜딩 페이지를 읽고, 만들고, 편집하고, 삭제할 수 있습니다.</li><li>**[!DNL Manage messages preview and test]**: 메시지/랜딩 페이지 미리 보기를 읽고, 만들고 편집하고, 테스트/증명을 보냅니다.</li><li> **[!DNL View messages report]**: 메시지 및 랜딩 페이지 보고서를 읽고 편집합니다.</li></ul>|
|의사 결정 관리| <ul><li>**[!DNL Manage decisions]**: 의사결정 엔티티를 읽기, 만들기, 편집 및 삭제합니다.</li></ul>| |Adobe Experience Platform| <ul><li>**[!DNL Read profiles]**: 미리 보기 및 테스트를 위해 프로필에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Read datasets]**: 데이터 세트에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Read schemas]**: 스키마에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Manage merge policies]**: 병합 정책을 읽고, 만들고, 편집하고, 삭제합니다.</li></ul>|
|관리| <ul><li>**[!DNL View messages presets]**: 메시지 사전 설정에 대한 읽기 전용 액세스 권한.</li></ul>|
...
| 기능 | 권한| |-|-| |의사 결정 관리| <ul><li>**[!DNL Manage decisions]**: 의사결정 엔티티를 읽기, 만들기, 편집 및 삭제합니다.</li><li>**[!DNL View decisions]**: 의사 결정 엔터티에 대한 읽기 전용 액세스 권한.</li><li>**[!DNL Manage ranking strategies]**: 사용자 정의 메시지 보고서를 읽고, 만들고, 편집하고, 삭제하고, 작업 기능을 사용하십시오.</li><li>**[!DNL Publish decisions]**: 의사결정 활동을 활성화 또는 비활성화합니다.</li></ul>|
