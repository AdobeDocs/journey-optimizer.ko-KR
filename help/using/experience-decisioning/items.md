...
1. 한도 임계값을 정의합니다. 이를 위해 정적 값을 입력하거나 표현식을 사용하여 임계값을 계산할 수 있습니다. 자세한 내용을 보려면 아래 섹션을 확장하십시오.
   ...
   **[!UICONTROL 최대 가용량 제한]** 필드에서 선택한 최대 가용량 유형에 따라 모든 사용자에게 또는 프로필별로 오퍼를 표시할 수 있는 횟수를 지정합니다. 숫자는 0보다 큰 정수여야 합니다.
   ...
   제한 임계값에 정적 값을 사용하는 대신 고유한 표현식을 정의할 수 있습니다. 이를 통해 Adobe Experience Platform 데이터 세트의 의사 결정 속성 및/또는 외부 속성을 사용하여 임계값을 동적으로 계산할 수 있습니다.
   ...
   >[!NOTE]
   >
   >최대 가용량 규칙 **식**&#x200B;은(는) 현재 모든 사용자에게 제한된 가용성으로 사용할 수 있습니다. **[!UICONTROL 총]** 한도 유형에 대해서만 지원됩니다.
