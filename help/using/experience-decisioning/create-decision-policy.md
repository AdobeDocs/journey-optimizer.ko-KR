...
1. [의사 결정 정책 추가](#add)
1. [결정 정책을 구성합니다](#configure) - 이름을 추가하고 전자 메일 및 DM 채널의 경우 반환할 항목 수를 지정합니다.
...
여정 또는 캠페인에서 구성된 채널 작업에 액세스하고 메시지의 콘텐츠를 편집합니다. 선택한 채널을 기반으로 결정 정책을 추가하는 방법에 대한 자세한 내용은 아래 탭을 참조하십시오.
...
1. 속성 창에서 ![](assets/do-not-localize/decisioning-icon.png) 아이콘을 클릭하여 **[!UICONTROL Decisioning]** 메뉴에 액세스합니다.
...
>[!IMPORTANT]
>
>하나의 이메일은 최대 10개의 의사 결정 정책을 지원합니다.
...
1. 전자 메일 디자이너에서 사용할 수 있는 **개인화 편집기** 또는 **의사 결정** 메뉴를 사용하여 새 의사 결정 정책을 추가하십시오.
   ...
   1. 제목 줄 필드 또는 개인화를 추가할 수 있는 이메일 본문의 모든 필드에서 사용할 수 있는 ![](assets/do-not-localize/editor-icon.svg) 아이콘을 사용하여 개인화 편집기를 엽니다.
...
전자 메일 Designer에서 **[!UICONTROL 직접 코드 작성]** 모드를 사용할 때 결정 정책을 추가할 수도 있습니다. 이렇게 하려면 **[!UICONTROL 의사 결정 정책]**(으)로 이동하여 의사 결정 정책 코드를 삽입합니다. 의사 결정 정책의 배치를 선택할 수 있는 배치 선택 UI가 표시됩니다. [자신의 전자 메일 콘텐츠를 코딩하는 방법에 대해 알아보세요](../email/code-content.md).
...
1. ![](assets/do-not-localize/editor-icon.svg) 아이콘을 사용하여 개인화 편집기를 엽니다.
1. **[!UICONTROL 의사 결정 정책]** 메뉴로 이동한 다음 **[!UICONTROL 의사 결정 정책 추가]** 단추를 클릭합니다.
...
DM의 경우 **추출 파일** 구성에서 결정 정책을 추가하십시오. [DM 메시지를 만드는 방법을 알아보세요](../direct-mail/create-direct-mail.md).

1. **[!UICONTROL 데이터 필드]** 섹션에서 열을 선택하거나 **[!UICONTROL 추가]**&#x200B;를 클릭하여 열을 만듭니다.

1. 서식 창에서 ![](assets/do-not-localize/editor-icon.svg) 아이콘을 사용하여 개인화 편집기를 엽니다.
...
1. 결정 정책 구성 화면에서 **[!UICONTROL 항목 수]** 필드를 사용하여 각 프로필에 대해 반환할 결정 항목 수를 정의합니다(예: 상위 2개의 적격 오퍼를 내보내는 경우 2). 추출 파일 열에서 [전략 설정](#strategy) 및 [개인화](use-decision-policy.md)를 계속합니다.
...
1. **[!UICONTROL 항목 수]** 필드를 사용하면 결정 정책으로 반환할 결정 항목의 수를 정의할 수 있습니다. 예를 들어 항목 2개를 선택하면 현재 구성에 대한 적격 제안 2개가 표시됩니다.
   ...
   >[!NOTE]
   >
   >**[!UICONTROL 항목 수]** 필드는 **전자 메일**, **코드 기반 경험** 및 **DM** 채널에서 사용할 수 있습니다. **SMS** 및 **푸시** 채널의 경우 작업당 하나의 결정 항목만 반환할 수 있습니다.
