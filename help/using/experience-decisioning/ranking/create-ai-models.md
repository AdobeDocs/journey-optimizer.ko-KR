...
**이 페이지에서:** 자동 최적화 또는 개인화된 최적화 AI 모델을 빌드하고 전환 데이터 세트에 연결하면 의사 결정 엔진이 자동으로 오퍼의 등급을 매기고 각 프로필로 가장 높게 변환한 모델을 제공할 수 있습니다.
...
## AI 모델 액세스 {#access-ai-models}

AI 모델 목록에 액세스하려면 **[!UICONTROL 의사 결정]** > **[!UICONTROL 전략 설정]**(으)로 이동하여 **[!UICONTROL AI 모델]**&#x200B;을(를) 선택하십시오. 인스턴스에서 만든 모든 AI 모델이 표시됩니다.
...
1. **[!UICONTROL 의사 결정]** > **[!UICONTROL 전략 설정]** 메뉴로 이동한 다음 **[!UICONTROL AI 모델]**&#x200B;을 선택합니다.
   ...
   지금까지 인스턴스에서 만든 모든 AI 모델이 표시됩니다.
