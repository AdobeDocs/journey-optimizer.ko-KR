...
>title="순위 공식 만들기"
>abstract="공식을 사용하면 항목의 우선순위 점수를 고려하지 않고 먼저 표시할 결정 항목을 정하는 규칙을 정의할 수 있습니다. 순위 공식이 만들어지면 이를 선택 전략에 할당할 수 있습니다."
...
>[!NOTE]
>
>컨텍스트 데이터를 전달하는 방법<!-- using the **Edge Decisioning** and **Decisioning** APIs-->에 대한 자세한 내용은 [이 섹션](../context-data.md)을 참조하세요.
...
>[!NOTE]
>
>AI 기반 수식 최적화는 **콘텐츠 생성**&#x200B;과 동일한 생성 AI 기능을 사용하며 동일한 액세스 제어를 사용합니다. 사용자에게 **[!UICONTROL AI 도우미]** 리소스에 대한 **[!UICONTROL 콘텐츠 생성]** 권한이 부여되어야 합니다. 자세한 내용은 [콘텐츠 생성에 액세스](../../content-management/gs-generative.md#generative-access)를 참조하십시오.
