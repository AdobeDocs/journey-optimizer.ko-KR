...
1. 규칙 엔티티를 선택하여 규칙을 작성할 객체 유형을 지정합니다.
   ...
   * **[!UICONTROL 타깃팅]** - [여정 활동 최적화](#targeting-rules)에서 캠페인 또는 여정의 [콘텐츠 최적화](../campaigns/campaigns-message-optimization.md#targeting)의 일부로 [타깃팅](../building-journeys/path-targeting.md) 규칙을 작성할 때 규칙을 사용할 수 있습니다.
