...
진정한 비즈니스 인사이트를 얻으려면 실험 하나에만 집중해야 합니다. 대신, 새로운 가설을 세우고, 다른 대상에 대해 다른 변경 사항을 적용한 새로운 테스트를 실행하고, 다른 지표에 미치는 영향을 조사하여 실험을 추적하십시오.
+++
...
예를 들어 처치 A의 **[!UICONTROL 전환율]**&#x200B;이 3%이고 처치 B의 **[!UICONTROL 전환율]**&#x200B;이 2%로 관찰되었다면 처치 A의 성과가 처치 B보다 좋은 것일까요? 이 질문에 답하려면 먼저 관찰된 전환율의 불확실성을 정량화해야 합니다.
...
* **보다 심층적으로 분석하기**
  ...
  한 대상자에 대해 효과가 있는 처치가 다른 대상자에게는 적합하지 않을 수도 있습니다. 다양한 대상자에 대해 치료가 어떻게 동작했는지에 대한 심층적인 분석을 수행하면 새로운 테스트를 위한 아이디어를 생성하는 데 도움이 됩니다.
