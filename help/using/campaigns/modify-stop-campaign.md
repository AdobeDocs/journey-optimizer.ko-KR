...
캠페인은에서 액세스할 수 있습니다. **[!UICONTROL 캠페인]** 메뉴 아래의 제품에서 사용할 수 있습니다.

기본적으로 목록에는 **[!UICONTROL 초안]**, **[!UICONTROL 예약됨]**, 및 **[!UICONTROL 라이브]** 상태. 중지, 완료 및 보관된 캠페인을 표시하려면 필터를 지워야 합니다.
...
* **[!UICONTROL 완료됨]**: 캠페인이 완료되었습니다. 이 상태는 캠페인이 활성화된 후 3일 또는 캠페인 종료 날짜(반복 실행이 있는 경우)에 자동으로 할당됩니다.
...
1. 캠페인을 연 다음 **[!UICONTROL 캠페인 수정]** 단추를 클릭합니다.

1. 캠페인의 새 버전이 만들어집니다. 을 클릭하여 라이브 버전을 확인할 수 있습니다. **[!UICONTROL 라이브 버전 열기]**.

   ![](assets/create-campaign-draft.png)

   캠페인 목록에서 진행 중인 초안 버전의 활성화된 캠페인은에 특정 아이콘과 함께 표시됩니다. **[!UICONTROL 상태]** 열. 이 아이콘을 클릭하여 캠페인의 초안 버전을 엽니다.

   ![](assets/create-campaign-edit-list.png)

1. 변경 사항이 준비되면 캠페인의 새 버전을 활성화할 수 있습니다( 참조) [캠페인 검토 및 활성화](create-campaign.md#review-activate)).
...
반복 캠페인을 중지하려면 캠페인을 연 다음 **[!UICONTROL 캠페인 중지]** 단추를 클릭합니다.
...
라이브 캠페인을 복제하여 새 캠페인을 만들 수 있습니다. 이렇게 하려면 캠페인을 연 다음 을 클릭합니다. **[!UICONTROL 복제]**.
...
이를 방지하기 위해 더 이상 필요하지 않은 완료 및 중지된 캠페인을 보관할 수 있습니다. 이렇게 하려면 줄임표 버튼을 클릭한 다음 을 선택합니다. **[!UICONTROL 보관]**.
