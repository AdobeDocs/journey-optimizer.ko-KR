...
1. **[!UICONTROL 이미지 설정]** 선택:
   ...
   * **[!UICONTROL 생성 모델]**: 사용 가능한 기본 제공 모델, 브랜드 자산에 대해 교육된 사용자 지정 Firefly 모델 또는 타사 이미지 생성 공급자 중에서 선택하여 특정 요구 사항과 브랜드 요구 사항에 맞는 이미지를 만듭니다. [자세히 알아보기](generative-models.md)
