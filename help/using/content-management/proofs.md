...
>
>Assets/이미지는 모든 조각/인라인 메시지에 처음 게시한 후 최대 2년(730일) 동안 게재된 콘텐츠 또는 증명 콘텐츠에서 액세스할 수 있습니다. 이 만료 기간(730일 후 언제든지) 이후에는 다시 게시해야 2년 동안 액세스할 수 있습니다. 첫 번째 게시 후 730일 이내에 다시 게시하면 에셋/이미지의 만료가 다음 730일로 연장되지 않습니다.
