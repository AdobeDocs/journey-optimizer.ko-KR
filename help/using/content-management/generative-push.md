...
title: AI Assistant를 사용하여 푸시 생성
...
1. 푸시 알림 캠페인을 만들고 구성한 후 **[!UICONTROL 콘텐츠 편집]**.

   푸시 알림 캠페인을 구성하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [이 페이지](../push/create-push.md).
...
1. 푸시 알림 캠페인을 만들고 구성한 후 **[!UICONTROL 콘텐츠 편집]**.
   ...
   푸시 캠페인을 구성하는 방법에 대한 자세한 내용은 다음을 참조하십시오. [이 페이지](../push/create-push.md).

1. 다음을 입력합니다. **[!UICONTROL 기본 세부 정보]** 캠페인을 위해 사용됩니다. 완료되면 다음을 클릭합니다. **[!UICONTROL 콘텐츠 편집]**.

1. 필요에 따라 푸시 알림을 개인화합니다. [자세히 알아보기](../push/design-push.md)

1. 액세스 **[!UICONTROL AI Assistant 표시]** 메뉴 옆에 있는 **[!UICONTROL 제목]** 또는 **[!UICONTROL 메시지]** 필드.
