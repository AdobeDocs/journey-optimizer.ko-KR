...
>[!AVAILABILITY]
>
> Experimentation Accelerator은 현재 베타 버전이며 기능이 점진적으로 롤아웃됩니다.
...
* **KPI 모니터링**: 실험 전반에서 상승도, 매출 및 신뢰도와 같은 지표를 추적합니다.
...
**[!UICONTROL Experimentation Accelerator]**&#x200B;에 액세스하려면:

* 왼쪽 메뉴에서 **[!UICONTROL 실험]** 드롭다운에서 **[!UICONTROL Experimentation Accelerator]**&#x200B;을(를) 선택합니다.

* 또는 앱 전환기에서 **[!UICONTROL Experimentation Accelerator]**&#x200B;을(를) 선택합니다.

Target 라이선스만 있는 사용자는 앱 전환기를 통해서만 액세스할 수 있습니다.
