...
웹 페이지를 만들고 개인화한 후에는 생성 AI에서 제공하는 Journey Optimizer의 AI Assistant를 사용하여 콘텐츠를 한 차원 끌어올립니다.
...
아래 예에서는 Journey Optimizer의 AI Assistant를 활용하여 에셋을 최적화하고 개선하여 보다 사용자 친화적인 경험을 제공하는 방법에 대해 알아봅니다.
