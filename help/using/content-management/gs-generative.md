...
title: Journey Optimizer에서 콘텐츠 생성 시작
description: Journey Optimizer에서 콘텐츠 생성 기능에 액세스하고 사용하는 방법을 알아봅니다.
...
# 콘텐츠 생성 시작 {#gs-content-assistant}

>[!BEGINSHADEBOX]

**이 페이지의 내용:** Adobe Journey Optimizer에서 콘텐츠 생성 기능에 액세스하는 방법, 필요한 권한을 설정하는 방법, 텍스트 및 이미지 콘텐츠 생성 시 유의 사항을 알아봅니다.

>[!ENDSHADEBOX]

>[!CONTEXTUALHELP]
>id="ajo_ai_generation_settings"
>title="Journey Optimizer에서 콘텐츠 생성"
>abstract="게재 내용을 작성하고 개인화한 후 AI를 사용하여 콘텐츠를 편집하고 개선할 수 있습니다. 이 기능을 사용하면 생성하려는 내용을 설명하여 콘텐츠를 더욱 세부적으로 조정할 수 있어 개인화 및 콘텐츠 개선 프로세스가 간소화됩니다."

>[!CONTEXTUALHELP]
>id="ajo_ai_generation_context"
>title="브랜드 에셋 업로드"
>abstract="브랜드 에셋 업로드 메뉴를 이용하면 Journey Optimizer의 콘텐츠 생성에 추가 컨텍스트를 제공할 수 있는 콘텐츠가 포함된 브랜드 에셋을 추가하거나 이전에 업로드한 에셋을 선택할 수 있습니다. 이 옵션을 사용하면 콘텐츠 생성이 기능과 관련성을 개선하는 데 필요한 모든 자료에 액세스할 수 있습니다."
...
Microsoft Azure OpenAI 및 Adobe Firefly 기반의 Adobe Journey Optimizer 콘텐츠 생성 기능은 텍스트 및 이미지에 대한 콘텐츠 변형 제안을 사전에 제공합니다. 이 새로운 기능은 **프롬프트 기반의 텍스트 및 이미지 생성**&#x200B;을 제공합니다. 이미지 생성은 Adobe Firefly로 관리됩니다.

콘텐츠 생성은 **다국어** 생성을 지원하여 전 세계 다양한 고객에게 도달하고 참여를 유도할 수 있습니다. 콘텐츠 생성 기능은 다음 언어로 제공됩니다.
...
AI를 활용하여 다양한 제목과 이미지를 실험해 보고 메시지의 효과를 최적화합니다. 여러 변형을 생성하고 비교할 실험을 빌드합니다. **Journey Optimizer 콘텐츠 실험**&#x200B;을 활용하면 여러 메시지 처리를 정의하여 어느 메시지가 타깃 대상자에게 가장 적합한지 측정할 수 있습니다. 게재 콘텐츠 또는 제목을 변경하도록 선택할 수 있습니다. 메시지 대상자는 지정된 지표 측면에서 가장 적합한 처리를 결정하기 위해 각 처리에 임의로 할당됩니다. [이 섹션](../content-management/content-experiment.md)에서 콘텐츠 실험에 대해 자세히 알아보십시오.

>[!IMPORTANT]
>
>* 이 기능을 사용하기 전에 관련 [가드레일 및 제한 사항](#generative-guardrails)을 읽어보세요.
>
>
>* Adobe Journey Optimizer에서 콘텐츠 생성 기능을 사용하려면 먼저 [사용자 계약](https://www.adobe.com/kr/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}에 동의해야 합니다. 자세한 내용은 Adobe 담당자에게 문의하세요.

## 콘텐츠 생성 액세스 {#generative-access}

Adobe Journey Optimizer에서 콘텐츠 생성 기능에 액세스하려면 사용자에게 **콘텐츠 생성** 권한이 부여되어야 합니다. [자세히 알아보기](../administration/permissions.md)
...
Adobe Journey Optimizer에서 콘텐츠 생성 기능으로 이메일을 생성할 때 따라야 할 일반 지침은 다음과 같습니다.
...
* 변형을 선택할 때 엄지손가락 위로, 엄지손가락 아래로, 플래그 아이콘 중하나를 사용하여 문제가 있는 출력을 보고하십시오.
...
* 여러 브랜드 자산을 업로드할 수 있지만 특정 세대에는 하나만 활용할 수 있습니다.

### 이메일 템플릿 및 이미지

* 브랜드별 또는 사용자 정의 템플릿을 사용하여 Adobe Journey Optimizer에서 콘텐츠 생성 기능을 통해 이메일 콘텐츠를 만들 수 있습니다. 최대 8~10개의 이미지가 포함된 이메일 템플릿을 권장합니다.

### 법적 사용 및 투명성

* 콘텐츠 생성 기능 사용은 Adobe Experience Cloud 생성형 AI 사용자 지침을 준수해야 합니다. [자세히 알아보기](https://www.adobe.com/kr/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html)
...
### 개인화 표현식용 콘텐츠 생성 {#ai-assistant-personalization-editor-guardrails}

다음 가드레일은 [!UICONTROL 개인화 편집기] 및 이메일 디자이너의 [개인화 표현식용 콘텐츠 생성](generative-personalization-expressions.md)에 적용됩니다.

* **오퍼 및 Experience Decisioning** — 지원되지 않습니다.
* **즐겨찾기** — 지원되지 않습니다.
* **저장된 조건** — 지원되지 않습니다.
* **Adobe Experience Manager 콘텐츠 조각** — 지원되지 않습니다.

## 콘텐츠 생성 기능 {#generative-features}
...
* **[콘텐츠 생성 사용 사례](generative-uc.md)** - 사용 사례를 통해 콘텐츠 생성 기능을 사용하는 방법을 알아봅니다.
* **[콘텐츠 생성 튜토리얼](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/introduction-to-journey-optimizer/ai-assistant){target="_blank"}** - 콘텐츠 생성 기능 및 모범 사례에 대한 단계별 비디오 튜토리얼을 살펴봅니다.
