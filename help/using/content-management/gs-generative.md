...
**이 페이지의 내용:** Adobe Journey Optimizer에서 AI 어시스턴트에 액세스하는 방법, 필요한 권한을 설정하는 방법, 텍스트 및 이미지 콘텐츠 생성 시 가드레일을 알아봅니다.
...
### 개인화 표현식에 AI 어시스턴트 사용 {#ai-assistant-personalization-editor-guardrails}

다음 가드레일은 [!UICONTROL 개인화 편집기] 및 이메일 디자이너의 [개인화 표현식용 AI 어시스턴트](generative-personalization-expressions.md)에 적용됩니다.
...
* **[AI 어시스턴트 사용 사례](generative-uc.md)** - 사용 사례를 통해 AI 어시스턴트 사용 방법 알아보기
