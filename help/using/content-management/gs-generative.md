...
title: Journey Optimizer에서 컨텐츠 생성 시작
description: Journey Optimizer에서 컨텐츠 생성에 액세스하고 작업하는 방법을 알아봅니다.
...
**이 페이지에서:** Adobe Journey Optimizer에서 [콘텐츠 생성]에 액세스하고 필요한 권한을 설정하고 텍스트 및 이미지 콘텐츠를 생성하기 위한 가드레일을 이해하는 방법에 대해 알아봅니다.

>[!ENDSHADEBOX]

>[!CONTEXTUALHELP]
>id="ajo_ai_generation_settings"
>title="Journey Optimizer에서 컨텐츠 생성"
>abstract="게재를 제작하고 개인화하면 AI를 사용하여 콘텐츠를 편집하고 구체화할 수 있습니다. 이 기능을 사용하면 생성하려는 내용을 설명하여 콘텐츠를 더욱 세부적으로 조정할 수 있어 개인화 및 콘텐츠 개선 프로세스가 간소화됩니다."

>[!CONTEXTUALHELP]
>id="ajo_ai_generation_context"
>title="브랜드 에셋 업로드"
>abstract="브랜드 자산 업로드 메뉴를 사용하면 Journey Optimizer에서 컨텐츠 생성에 대한 추가 컨텍스트를 제공하거나 이전에 업로드한 자산을 선택할 수 있는 컨텐츠가 포함된 브랜드 자산을 추가할 수 있습니다. 이 옵션을 사용하면 콘텐츠 생성에서 기능과 연관성을 높이기 위해 필요한 모든 자료에 액세스할 수 있습니다."
...
Microsoft Azure OpenAI 및 Adobe Firefly에서 제공하는 Adobe Journey Optimizer에서 컨텐츠 생성은 텍스트 및 이미지에 대한 사전 예방적 컨텐츠 변형 제안을 제공합니다. 이 새로운 기능은 **프롬프트 기반의 텍스트 및 이미지 생성**&#x200B;을 제공합니다. 이미지 생성은 Adobe Firefly로 관리됩니다.

콘텐츠 생성은 다양한 글로벌 대상자에게 도달하고 참여할 수 있도록 여러 언어로 **생성을 지원합니다**. 콘텐츠 생성은 다음 언어로 사용할 수 있습니다.
...
Adobe Journey Optimizer에서 콘텐츠 생성에 액세스하려면 사용자에게 **콘텐츠 생성** 권한이 부여되어야 합니다. [자세히 알아보기](../administration/permissions.md)
...
Adobe Journey Optimizer에서 콘텐츠 생성을 사용하여 이메일을 생성하는 일반적인 지침은 다음과 같습니다.
...
* 생성된 콘텐츠의 품질은 사용자가 정의한 마케팅 목표/프롬프트의 영향을 크게 받습니다. 생성형 AI 모델이 정확하게 해석할 수 있도록 잘 정의된 프롬프트를 사용해야 합니다. 
...
* 브랜드별 또는 사용자 지정 템플릿을 사용하여 Adobe Journey Optimizer에서 콘텐츠 생성을 사용하여 이메일 콘텐츠를 만듭니다. 최대 8~10개의 이미지가 포함된 이메일 템플릿을 권장합니다.
...
[!UICONTROL Personalization 편집기] 및 전자 메일 Designer의 [개인화 식에 대한 콘텐츠 생성](generative-personalization-expressions.md)에 다음 보호 기능이 적용됩니다.
...
* **[콘텐츠 사용 사례 생성](generative-uc.md)** - 사용 사례를 통해 콘텐츠 생성을 사용하는 방법을 알아봅니다.
* **[콘텐츠 튜토리얼 생성](https://experienceleague.adobe.com/ko/docs/journey-optimizer-learn/tutorials/introduction-to-journey-optimizer/ai-assistant){target="_blank"}** - 콘텐츠 생성 기능 및 모범 사례에 대한 단계별 비디오 튜토리얼을 살펴보십시오.
