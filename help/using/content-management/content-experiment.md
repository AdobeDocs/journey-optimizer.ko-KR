...
**이 페이지에서:** 콘텐츠 실험을 만들어 여러 처리를 정의 및 비교하고, 실험 유형을 선택하고, Adobe Journey Optimizer의 캠페인 및 여정에서 가장 성과가 좋은 변형을 확장하는 방법을 알아봅니다.
...
1. 먼저 요구 사항에 따라 [campaign](../campaigns/create-campaign.md) 또는 [여정](../building-journeys/journey-action.md)을(를) 만들고 구성합니다.
