...
>title="성공 지표"
>abstract="성공 지표는 실험에서 가장 효과적인 처리를 추적하고 평가하는 데 사용됩니다. 성공 지표를 사용하기 전에 데이터세트를 특정 지표에 맞게 설정해야 합니다."
...
우승자 비율 조정 을 사용하면 실험의 우승 변형을 전체 대상자에게 자동 또는 수동으로 롤아웃할 수 있습니다. 이 기능은 일단 승자가 결정되면 실험을 지속적으로 모니터링하지 않고 도달 범위와 효과를 증폭시킬 수 있도록 한다.
