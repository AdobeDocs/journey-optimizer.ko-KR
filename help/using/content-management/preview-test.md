...
>[!IMPORTANT]
>
>**[!UICONTROL 오케스트레이션된 캠페인]** 채널 활동에서 **콘텐츠 시뮬레이션**&#x200B;을 사용하는 경우 [콘텐츠 확인 및 테스트](../orchestrated/activities/channels.md#simulate-content-test-profiles)에서 자세한 내용 및 중요 참고 사항을 확인하세요.
