...
또한 테스트 및 유효성 검사를 위해 특정 수신자 또는 구독자에게 이메일 메시지 테스트 게재를 보내고 인기 있는 데스크톱, 모바일 및 웹 기반 클라이언트에서 해당 렌더링을 확인할 수 있습니다. 또한 가독성 및 효과성과 같은 일반적인 콘텐츠 품질 측면을 평가할 수 있습니다. [콘텐츠 품질 유효성 검사에 대해 자세히 알아보기](brands-score.md#validate-quality)
