...
**이 페이지의 내용:** 테스트 프로필 또는 샘플 입력 데이터를 사용하여 Adobe Journey Optimizer에서 메시지 콘텐츠를 미리 보고 테스트하여 전송하기 전에 렌더링, 개인화 및 정확성을 확인하는 방법을 알아봅니다.
...
또한 테스트 및 유효성 검사를 위해 특정 수신자 또는 구독자에게 이메일 메시지 테스트 게재를 보내고, 널리 쓰이는 데스크탑, 모바일, 웹 기반 클라이언트에서 해당 렌더링을 확인할 수 있습니다. 또한 가독성 및 효과성과 같은 일반적인 콘텐츠 품질 측면을 평가할 수 있습니다. [콘텐츠 품질 확인에 대해 자세히 알아보기](brands-score.md#validate-quality)

이러한 모든 액션은 메시지의 콘텐츠 편집 화면이나 이메일 및 웹 채널용 이메일 및 웹 디자이너에서 액세스할 수 있는 **[!UICONTROL 콘텐츠 시뮬레이션]** 버튼을 사용하여 수행할 수 있습니다. **[!UICONTROL 콘텐츠 시뮬레이션]**&#x200B;을 클릭하면 샘플 입력 데이터를 사용하여 콘텐츠 변형을 테스트할 수 있습니다. 테스트 프로필로 미리 보기, 교정본 전송 또는 이메일 렌더링 확인을 하려면 드롭다운 메뉴에서 **[!UICONTROL 콘텐츠 시뮬레이션(AEP 프로필)]**&#x200B;을 선택합니다.

![](../email/assets/email-preview-button.png)

>[!IMPORTANT]
>
>**오케스트레이션된 캠페인** 채널 활동에서 **[!UICONTROL 콘텐츠 시뮬레이션]**&#x200B;을 사용하는 경우, 자세한 내용과 중요 참고 사항은 [콘텐츠 확인 및 테스트](../orchestrated/activities/channels.md#simulate-content-test-profiles)를 참조하세요.
