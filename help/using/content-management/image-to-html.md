...
이미지를 이메일 콘텐츠 템플릿으로 변환할 때 다음 제한 사항에 유의하십시오.
...
* **제한된 가용성**: 제한된 가용성 기능으로서 이 변환기는 계속 개선되고 있습니다. 기능과 정확도는 다를 수 있으며 피드백은 기능을 향상시키는 데 도움이 됩니다.
...
* **초안 검토**: 전환이 완료되면 템플릿이 자동으로 초안으로 저장됩니다. 시간을 내어 생성된 콘텐츠의 정확성을 신중하게 검토하십시오
