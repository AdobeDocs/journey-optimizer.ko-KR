...
**이 페이지에서:** 타깃팅 규칙을 사용하여 프로필 특성, 컨텍스트 데이터 또는 대상 멤버십을 기반으로 특정 대상 세그먼트에 개인화된 콘텐츠를 전달하는 방법을 알아봅니다.
...
>title="대체 콘텐츠란 무엇입니까?"
>abstract="대체 콘텐츠를 설정하면 타기팅 규칙에 해당하지 않는 사용자에게도 기본 콘텐츠가 노출됩니다.</br>이 옵션을 해제할 경우, 설정한 규칙에 부합하지 않는 사용자는 어떤 콘텐츠도 볼 수 없습니다."
