...
# SMS 사용 보고서 생성 {#sms-usage-report}
...
## SMS 사용량 보고서 구성 및 보기 {#configure-sms-usage-report}
...
1. 보고서를 구성합니다.
   ...
   * **[!UICONTROL 시작 날짜]** 및 **[!UICONTROL 종료 날짜]**: 보고서의 날짜 범위를 설정합니다. 사용 데이터는 지난 90일 동안만 사용할 수 있습니다.
