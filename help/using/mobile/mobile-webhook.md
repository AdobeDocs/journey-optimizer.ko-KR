...
1. 아래에 자세히 설명된 대로 웹후크 설정을 구성합니다.
   ...
   * **[!UICONTROL API 자격 증명]**: 드롭다운에서 [이전에 구성한 API 자격 증명](mobile-configuration-sinch.md)을 선택합니다.
...
1. **[!UICONTROL 인바운드 키워드 범주]** 드롭다운에서 키워드 범주를 선택하여 구성하십시오.
   ...
   * 사용자를 옵트아웃하고 모바일 메시지 전송에 대한 동의를 제거하는 키워드를 활성화합니다. 사용자의 메시지가 구성된 키워드와 일치하면 해당 전화번호는 SMS 메시지를 수신하지 않도록 옵트아웃됩니다.
...
1. 아래에 자세히 설명된 대로 웹후크 설정을 구성합니다.
   ...
   * **[!UICONTROL API 자격 증명]**: 드롭다운에서 [이전에 구성한 API 자격 증명](mobile-configuration-infobip.md#api-credential)을 선택합니다.
...
1. 아래에 자세히 설명된 대로 웹후크 설정을 구성합니다.
   ...
   * **[!UICONTROL API 자격 증명]**: 드롭다운에서 [이전에 구성한 API 자격 증명](mobile-configuration-custom.md)을 선택합니다.
