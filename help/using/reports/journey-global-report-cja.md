...
**[!UICONTROL 여정 제외]** 표에는 사용자 프로필을 제외하는 다양한 요인에 대한 포괄적인 보기가 표시됩니다. 데이터 레이크 수준에서 비즈니스 규칙 관련 제외를 조사하고 한도에 도달했거나 낮은 우선 순위로 인해 프로필이 제외되었는지 여부를 확인하려면 [이 섹션](query-examples.md#business-rules-queries)에서 사용할 수 있는 쿼리를 사용하십시오.
