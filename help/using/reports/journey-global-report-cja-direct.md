...
**이 페이지에서:** DM 메시지의 전송 통계, 게재 상태, 오류 이유 및 제외 이유를 포함하여 여정 보고서에서 DM 지표를 읽는 방법을 알아봅니다.

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

여정 내의 **[!UICONTROL 보고서 보기]** 단추를 클릭하여 DM 여정 보고서에 액세스할 수 있습니다. [자세히 알아보기](report-gs-cja.md)
