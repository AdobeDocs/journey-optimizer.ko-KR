...
여정 **[!UICONTROL 라이브 보고서]** 페이지는 다음 탭에 표시됩니다.
...
여정 **[!UICONTROL 라이브 보고서]** 은 여정의 성공 및 오류를 자세히 설명하는 서로 다른 위젯으로 구분됩니다. 필요한 경우 각 위젯의 크기를 조정하고 삭제할 수 있습니다. 자세한 내용은 다음을 참조하십시오 [섹션](live-report.md#modify-dashboard).

Adobe Journey Optimizer에서 사용할 수 있는 모든 지표에 대한 자세한 목록은 다음을 참조하십시오 [이 페이지](live-report.md#list-of-components-live).

## 여정 탭 {#journey-live}

여정에서 **[!UICONTROL 라이브 보고서]**, **[!UICONTROL 여정]** 탭에서는 여정에 대해 가장 중요한 추적 데이터에 대한 명확한 보기를 제공합니다.

![](assets/journey_live_1.png)

+++여정 보고서에 사용할 수 있는 다양한 지표 및 위젯에 대해 자세히 알아보십시오.

**[!UICONTROL 여정 성능]** 여정을 단계별로 타겟팅된 프로필의 경로를 확인할 수 있습니다.
...
다음 **[!UICONTROL 지난 24시간 동안 실행된 이벤트]** 및 **[!UICONTROL 이벤트]** 위젯을 사용하면 요약 번호, 그래프 및 표를 통해 성공적으로 실행된 이벤트 중 하나를 확인할 수 있습니다.

다음 **[!UICONTROL 지난 24시간 동안 실행된 작업]** 및 **[!UICONTROL 실행된 작업 및 오류]** 위젯은 작업이 트리거될 때 발생한 가장 성공적인 작업 및 오류를 나타냅니다. 작업 그래프, 표 및 요약 번호에는 다음과 같은 작업에 사용할 수 있는 데이터가 포함되어 있습니다.

* **[!UICONTROL 실행된 작업]**: 여정에 대해 성공적으로 실행된 총 작업 수입니다.

* **[!UICONTROL 작업 오류]**: 작업에 대해 발생한 총 오류 수입니다.
+++

## 이메일 탭 {#email-live}

여정에서 **[!UICONTROL 라이브 보고서]**, **[!UICONTROL 이메일]** 탭에서는 여정에서 전송된 이메일 게재와 관련된 주요 정보를 자세히 설명합니다.
...
여정에서 **[!UICONTROL 라이브 보고서]**, **[!UICONTROL 푸시 알림]** 탭에서 여정에 전송된 푸시 게재와 관련된 기본 정보를 자세히 설명합니다.
...
다음 **[!UICONTROL SMS 요약]** 그래프는 게재 성공에 대해 자세히 설명합니다.
