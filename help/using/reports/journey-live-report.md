...
여정 **[!UICONTROL 실시간 보고서]** 페이지가 다음 탭과 함께 표시됩니다.
...
여정 **[!UICONTROL 라이브 보고서]**&#x200B;에서 **[!UICONTROL 여정]** 탭을 사용하면 여정에 대한 가장 중요한 추적 데이터를 명확하게 볼 수 있습니다.
...
>title="여정 성능"
>abstract="여정 성능 위젯을 사용하여 지난 24시간 동안 여정을 진행하는 동안 타기팅된 프로필 경로를 시각적으로 추적할 수 있습니다."

![](assets/journey_live_performance.png)

**[!UICONTROL 여정 성능]**&#x200B;을 통해 대상 프로필의 경로를 여정 단계별로 확인할 수 있습니다.
...
**[!UICONTROL 여정 통계]** 주요 성과 지표(KPI)는 모든 것을 포괄하는 대시보드로 작동하여 지난 24시간 동안 여정과 관련된 필수 지표에 대한 분석을 제공합니다. 여기에는 입력된 프로필 수 및 실패한 개별 여정의 인스턴스 등 세부 정보가 포함되며, 이를 통해 여정의 효율성 및 참여 수준에 대한 포괄적인 insight을 제공합니다.
...
* **[!UICONTROL 실패한 개별 여정]**: 실행되지 않은 총 개별 여정 수입니다.
+++
...
지난 24시간 동안 실행된 **[!UICONTROL 작업]** 위젯은 작업이 트리거될 때 발생한 가장 성공적인 작업을 나타냅니다.

+++ 지난 24시간 지표 동안 실행된 작업에 대해 자세히 알아보기

* **[!UICONTROL 실행된 작업]**: 여정에 대해 실행된 총 작업 수

* **[!UICONTROL 작업에 오류가 있습니다]**: 작업에 대해 발생한 총 오류 수입니다.
...
**[!UICONTROL 실행된 작업 및 오류]** 위젯은 최근 24시간 동안 작업이 트리거될 때 발생한 가장 성공적인 작업 및 오류를 나타냅니다.
...
**[!UICONTROL 작업 오류 이유]** 테이블 및 그래프는 지난 24시간 내에 작업을 실행하는 동안 발생한 오류에 대한 포괄적인 개요를 제공합니다.
...
**[!UICONTROL 작업별 오류 유형]** 테이블 및 그래프는 지난 24시간 내에 작업을 실행할 때마다 발생한 오류에 대한 포괄적인 개요를 제공합니다.
...
**[!UICONTROL 지난 24시간 동안 실행된 이벤트]** 위젯을 사용하면 지난 24시간 내에 성공적으로 실행된 이벤트를 식별할 수 있습니다.
...
>title="이벤트"
>abstract="이벤트 위젯을 통해 성공적으로 실행된 이벤트를 포괄적으로 볼 수 있으며 24시간 동안의 자세한 인사이트에 대한 요약 번호, 그래프 및 테이블을 제공합니다."

![](assets/journey_live_events.png)

**[!UICONTROL 이벤트]** 위젯을 통해 요약 번호, 그래프 및 표를 통해 이벤트 중 어느 이벤트가 성공적으로 실행되었는지 확인할 수 있습니다.
...
**[!UICONTROL 원본별 이벤트]** 테이블 및 그래프는 지난 24시간 동안 이벤트를 성공적으로 수신한 것에 대한 자세한 관점을 제공합니다. 이러한 시각적 표현을 통해 효과적으로 수신된 이벤트를 정확하게 식별할 수 있으므로, 여정 내 개별 이벤트의 성능과 영향에 대한 중요한 통찰력을 제공할 수 있습니다.

## 이메일 탭 {#email-live}

**[!UICONTROL 이메일]** 탭은 여정 **[!UICONTROL 라이브 보고서]**&#x200B;에서 여정에 보낸 이메일과 관련된 기본 정보를 자세히 설명합니다.
...
**[!UICONTROL 이메일 - 전송 성능]** 그래프는 여정에서 전송된 이메일과 관련된 데이터를 종합적으로 볼 수 있도록 해주며 지난 24시간 동안 발생한 게재 및 바운스 수와 같은 주요 지표에 대한 통찰력을 제공합니다. 이를 통해 이메일 전송 프로세스를 자세히 분석할 수 있으므로 여정의 효율성과 성능에 대한 중요한 정보를 제공합니다.

+++ 이메일에 대해 자세히 알아보기 - 성능 지표 보내기
...
**[!UICONTROL 전자 메일 - 통계]** 표에는 지난 24시간 동안 여정에 있는 전자 메일과 관련된 필수 데이터에 대한 포괄적인 요약이 제공됩니다. 여기에는 타겟팅된 대상의 크기 및 성공적으로 전달된 이메일 수와 같은 주요 지표가 자세히 설명되어 있으며, 이를 통해 이메일 및 여정의 효율성 및 도달 가능성에 대한 중요한 통찰력을 제공합니다.
...
* **[!UICONTROL 전송됨]**: 전송된 총 전자 메일 수입니다.
...
**[!UICONTROL 전자 메일 - 날짜별 성능]** 위젯은 그래프를 통해 제공되는 전자 메일과 관련된 주요 정보에 대한 자세한 개요를 제공하여 지난 24시간 동안의 성능 추세에 대한 통찰력을 제공합니다.

+++ 이메일에 대해 자세히 알아보기 - 일자별 성능 지표
...
**[!UICONTROL 반송 이유]** 및 **[!UICONTROL 반송 범주]** 위젯은 반송 메시지와 관련된 사용 가능한 데이터를 컴파일하여 지난 24시간 동안 이메일 반송 이면의 특정 이유 및 범주에 대한 자세한 통찰력을 제공합니다.
...
**[!UICONTROL 오류 원인]** 그래프와 테이블은 지난 24시간 동안 보내는 동안 발생한 특정 오류에 대한 가시성을 제공하여 오류의 특성 및 발생에 대한 중요한 정보를 제공합니다.
...
**[!UICONTROL 제외된 이유]** 그래프와 표는 타깃팅된 대상에서 사용자 프로필을 제외하여 지난 24시간 동안 메시지가 수신되지 않은 다양한 요인에 대한 포괄적인 보기를 제공합니다.
...
**[!UICONTROL 전자 메일 - 최고 수신자 도메인]** 그래프 및 표에는 프로필이 지난 24시간 내에 전자 메일을 여는 데 가장 많이 사용하는 도메인에 대한 자세한 분류가 제공됩니다. 이렇게 하면 프로필 동작에 대한 중요한 통찰력을 제공하여 선호하는 플랫폼을 이해하는 데 도움이 됩니다.
...
**[!UICONTROL 푸시 알림]** 탭은 여정 **[!UICONTROL 라이브 보고서]**&#x200B;에서 여정에 전송된 푸시 알림과 관련된 기본 정보를 자세히 설명합니다.
...
**[!UICONTROL 푸시 알림 - 통계]** 표에는 지난 24시간 내에 타깃팅된 메시지 수 및 배달된 메시지 수와 같은 주요 지표를 포함하여 푸시 알림과 관련된 필수 데이터에 대한 간결한 요약이 제공됩니다.
...
**[!UICONTROL 푸시 알림 요약]** 그래프는 지난 24시간 내에 푸시 알림 활동에 대한 분석을 표시하는 동적 표현을 제공합니다. 이 그래픽 표현은 전송된 푸시 알림에 대한 포괄적인 분석을 제공합니다.
...
**[!UICONTROL 오류 원인]** 테이블 및 그래프는 푸시 알림을 보내는 동안 발생한 특정 오류를 식별하는 기능을 제공하며 지난 24시간 동안 발생한 문제에 대한 자세한 통찰력을 제공합니다.
...
**[!UICONTROL 제외된 이유]** 그래프와 표에는 타깃팅된 프로필에서 제외된 사용자 프로필이 지난 24시간 내에 푸시 알림을 받지 못한 다양한 이유가 표시됩니다.
...
**[!UICONTROL SMS - 통계]** 표에는 SMS 메시지와 관련된 필수 데이터에 대한 간략한 요약이 있으며, 여기에는 타겟팅된 메시지 수 및 지난 24시간 동안 성공적으로 배달된 메시지 수와 같은 주요 지표가 포함됩니다.
...
* **[!UICONTROL 바운스 수]**: 전송 프로세스 및 자동 반환 처리 중에 누적된 총 오류 수입니다.
...
**[!UICONTROL SMS - 날짜별 성능]** 위젯에서는 그래프로 표시된 메시지와 관련된 주요 정보에 대한 자세한 개요를 제공하여 지난 24시간 동안의 성능 추세에 대한 통찰력을 제공합니다.
...
**[!UICONTROL SMS - 반송 원인]** 그래프와 표는 반송된 SMS 메시지와 관련된 데이터에 대한 포괄적인 개요를 제공하여 지난 24시간 동안 SMS 메시지 반송 인스턴스가 발생한 특정 이유에 대한 중요한 통찰력을 제공합니다.
...
**[!UICONTROL SMS - 오류 원인]** 그래프와 표를 사용하면 SMS 메시지를 보내는 동안 발생한 특정 오류를 식별할 수 있으므로 지난 24시간 동안 발생한 문제를 철저히 분석할 수 있습니다.
...
**[!UICONTROL SMS - 제외된 이유]** 그래프 및 표는 타깃팅된 대상에서 사용자 프로필을 제외하여 SMS 메시지를 받지 못하게 하는 다양한 요인을 시각적으로 나타냅니다.
...
**[!UICONTROL 인앱 성과]** KPI는 지난 24시간 동안 여정의 인앱 메시지 참여에 대한 중요한 통찰력을 제공하며 프로필에 포함된 인앱 메시지의 효과와 영향을 평가하는 데 중요한 지표를 제공합니다.
...
**[!UICONTROL 유형별 상호 작용]** 그래프 및 표에는 사용자가 클릭, 무시 또는 상호 작용을 추적하여 인앱 메시지와 상호 작용하는 방식이 자세히 설명되어 있습니다.
