...
다음 **[!UICONTROL 실행된 액션 및 오류]** 위젯은 작업이 트리거될 때 발생한 가장 성공적인 작업 및 오류를 나타냅니다.
...
다음 **[!UICONTROL SMS - 링크를 통한 클릭 수]** 위젯은 메시지에 포함된 URL과 방문자의 참여도에 대한 필수 통찰력을 제공하여 지난 24시간 동안 가장 많은 상호 작용을 유발하는 링크에 대한 중요한 정보를 제공합니다.
