...
>[!NOTE]
>
>샌드박스에 대한 연결이 여러 개 있는 경우 [데이터 보기](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html){target="_blank"}가 [CJA에서 사용](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html){target="_blank"} 플래그가 지정된 **[!UICONTROL 연결]**&#x200B;을 참조하는지 확인하십시오. 그렇지 않으면 [**에서** CJA에서 분석](report-cja-manage.md#analyze) 단추[!DNL Journey Optimizer]이(가) 비활성화될 수 있습니다.
