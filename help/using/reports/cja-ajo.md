...
1. Adobe Experience Platform으로 보낼 [데이터 세트](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=ko)를 사용하여 [!DNL Customer Journey Analytics]연결을 만듭니다&#x200B;**[!UICONTROL .]**
