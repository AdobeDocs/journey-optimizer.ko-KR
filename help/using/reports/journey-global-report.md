...
Journey Global 보고서는 **[!UICONTROL View report]** 버튼을 클릭합니다.
...
여정 **[!UICONTROL Global report]** 은 여정의 성공 및 오류를 설명하는 여러 위젯으로 구분됩니다. 필요한 경우 각 위젯의 크기를 조정하고 삭제할 수 있습니다. 자세한 내용은 다음을 참조하십시오 [섹션](global-report.md#modify-dashboard).

Adobe Journey Optimizer에서 사용할 수 있는 모든 지표의 세부 목록을 보려면 다음을 참조하십시오 [이 페이지](global-report.md#list-of-components-global).

## 여정 탭 {#journey-global}

여정 **[!UICONTROL Global report]**, **[!UICONTROL Journey]** 탭에서는 여정에 대해 가장 중요한 추적 데이터를 명확하게 볼 수 있습니다.
...
여정 **[!UICONTROL Global report]**, **[!UICONTROL Email]** 탭에서 여정에 전송된 이메일 게재와 관련된 기본 정보를 자세히 설명합니다.
...
* **[!UICONTROL Targeted]**: 이메일 또는 SMS 보내기 등의 작업을 위해 Adobe Journey Orchestration에서 타겟팅한 프로필 수입니다.
...
여정 **[!UICONTROL Global report]**, **[!UICONTROL Push notification]** 탭에서 여정에 전송된 푸시 게재와 관련된 기본 정보를 자세히 설명합니다.
