...
>title="여정 성능"
>abstract="여정 성능 위젯을 사용하면 타겟팅된 프로필이 여정을 통해 진행할 때 해당 프로필의 경로를 시각적으로 추적할 수 있습니다."
...
>title="여정 통계"
>abstract="여정 통계 주요 성과 지표(KPI)는 포괄적인 대시보드 역할을 하며 여정과 관련된 필수 지표에 대한 심층적인 분석을 제공합니다."
...
>title="작업 성능"
>abstract="작업 성능 위젯은 작업이 시작되었을 때 발생한 가장 성공적인 작업을 보여 줍니다."
...
>title="상위 작업"
>abstract="최상위 작업 테이블은 작업에 대한 중요한 정보를 통합하여 각 작업의 빈도와 효율성 모두에 대한 간결한 관찰을 제공합니다."
...
>title="액션 오류 이유"
>abstract="작업 오류 원인 테이블 및 그래프는 작업을 실행하는 동안 발생한 오류에 대한 자세한 요약을 제공하여 발생했을 수 있는 문제에 대한 포괄적인 개요를 제공합니다."
...
>title="원본을 통한 이벤트"
>abstract="원점별 이벤트 테이블 및 그래프는 이벤트를 성공적으로 수신하는 뷰를 제공합니다. 이러한 시각적 표현을 사용하면 효과적으로 받은 이벤트를 정확하게 식별할 수 있으므로, 여정 내에서 각 이벤트의 성능과 영향에 대한 중요한 통찰력을 제공합니다."
...
>abstract="이벤트 그래프에서 수신한 이벤트 를 통해 효과적으로 실행된 여정 내의 특정 이벤트를 식별하고 분석할 수 있으므로, 개별 이벤트의 성능 및 성공률에 대한 중요한 통찰력을 제공합니다."
...
>title="상위 이벤트"
>abstract="최상위 이벤트 테이블에는 이벤트에 대한 필수 데이터가 통합되어 각 개별 이벤트의 빈도와 성능 모두에 대한 간결한 관찰이 제공됩니다."
...
>title="동의 정책"
>abstract="동의 정책 테이블 및 그래프는 사용자 지정 작업 내의 각 정책에서 제외된 프로필 수량을 표시합니다. 이 프레젠테이션은 프로필 제외에 대한 각 동의 정책의 영향에 대한 명확한 통찰력을 제공합니다."
...
>abstract="이메일 - 바운스 카테고리 및 이유 위젯은 반송된 메시지와 관련된 데이터를 집계하여 이메일 반송에 기여하는 특정 이유 및 범주에 대한 심층적인 통찰력을 제공합니다"
...
>title="이메일 - 최적화"
>abstract="전송 시간 최적화 및 최적화된 위젯과 최적화되지 않은 위젯은 최적화된 메시지인지 여부를 강조 표시하여 메시지에 대한 자세한 정보를 제공합니다."
...
>title="이메일 - 오퍼"
>abstract="오퍼 통계 및 오퍼 세부 통계 위젯은 오퍼의 성능에 대한 포괄적인 통찰력을 제공하여 시간 경과에 따른 영향을 자세히 분석하고 세부 통계를 제시하여 보다 깊이 있는 이해를 가능하게 합니다."
...
>title="푸시 알림 - 제외된 이유"
>abstract="제외된 이유 그래프 및 표는 타겟팅된 대상에서 제외된 사용자 프로필이 메시지를 받지 못하게 하는 다양한 요인을 보여 줍니다."
