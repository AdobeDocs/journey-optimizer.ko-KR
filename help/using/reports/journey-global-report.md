...
다음 **[!UICONTROL 원본을 통한 이벤트]** 표 및 그래프는 의 성공적인 수신에 대한 자세한 관점을 제공합니다. **[!UICONTROL 이벤트]**. 이러한 시각적 표현을 통해 다음 중 하나를 정확하게 식별할 수 있습니다. **[!UICONTROL 이벤트]** 은 효과적으로 수신되어 여정 내 개별 이벤트의 성능 및 영향에 대한 중요한 통찰력을 제공합니다.
