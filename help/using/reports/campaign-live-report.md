...
캠페인에서 **[!UICONTROL Live report]**, **[!UICONTROL Push notification]** 탭 은 campaign에서 전송된 푸시 게재와 관련된 기본 정보를 자세히 설명합니다.
...
캠페인에서 **[!UICONTROL Live report]**, **[!UICONTROL SMS]** 탭 은 campaign에서 전송된 SMS 게재와 관련된 주요 정보를 자세히 설명합니다.
