...
**이 페이지에서:** 게재됨 대 클릭 트렌드, 게재 상태, 전송 및 추적 통계, 전자 메일 도메인, 추적된 링크, 주제, 바운스 및 제외 이유 등 여정 보고서에서 전자 메일 지표를 읽는 방법을 알아봅니다.
...
* **[!UICONTROL 예상 CTOR]**(클릭 후 열람률): 예상 열람 수 대비 예상 클릭 수로 계산됩니다.
