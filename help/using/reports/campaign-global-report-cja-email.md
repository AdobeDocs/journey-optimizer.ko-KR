...
**이 페이지에서:** Adobe Journey Optimizer에서 이메일 캠페인 보고서를 읽고 이메일 KPI, 클릭 및 게재 단계, 추적 통계, 바운스 및 오류 이유, 도메인, 제목 및 링크별 참여를 분석하는 방법을 알아봅니다.
...
* **[!UICONTROL 고유 타깃팅]**: 제외, 제외 또는 동의 제거가 적용되기 전에 대상에 적합한 고유 프로필 수입니다.
