...
**이 페이지에서:** 게재 및 클릭 트렌드, 추적된 링크, 인바운드 메시지, 공급자, 바운스, 오류 및 제외 이유 등 Adobe Journey Optimizer 여정 보고서의 SMS 지표를 이해합니다.
...
**[!UICONTROL Campaign 개요]** 테이블은 여정의 각 캠페인 작업에 대한 SMS 성능을 위한 대시보드 역할을 합니다. 여기에는 타겟팅된 프로필, 클릭 및 클릭스루 지표(보트 및 비인간 상호 작용 트래픽을 제외하는 예상 클릭 포함) 및 바운스 수, 전송 오류 및 제외와 같은 게재 결과가 요약됩니다.
