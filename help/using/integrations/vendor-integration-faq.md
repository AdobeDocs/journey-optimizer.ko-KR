...
**이 페이지에서:** 구성, 인증, 지원되는 채널 및 형식, 권한 및 문제 해결에 대해 다루는 Adobe Journey Optimizer의 통합에 대해 자주 묻는 질문에 대한 답변을 찾아보십시오.
...
➡️ [통합 개요에 대해 자세히 알아보기](integrations.md)
...
➡️ [관리자 및 마케터 워크플로에 대해 자세히 알아보기](integrations.md)
...
➡️ [통합 만들기에 대한 자세한 정보](integrations.md#configure)
...
➡️ [타사 시스템의 예제 데이터에 대해 자세히 알아보기](integrations.md)
...
➡️ [인증 유형에 대해 자세히 알아보기](integrations.md#configure)
...
➡️ [응답 페이로드 매핑에 대해 자세히 알아보기](integrations.md#configure)
...
➡️ [통합을 사용한 개인화에 대해 자세히 알아보기](integrations.md#personalization)
...
➡️ [여정 및 캠페인에 대해 자세히 알아보기](integrations.md#limitations)
...
➡️ [지원되는 채널에 대해 자세히 알아보기](integrations.md#limitations)
...
➡️ [검색 및 목록 API에 대해 자세히 알아보기](integrations.md#limitations)
...
➡️ [통합 기능 자세히 알아보기](integrations.md)
...
➡️ [테스트 연결 및 페이로드 유효성 검사에 대해 자세히 알아보기](integrations.md#configure)
...
➡️ [테스트 연결 및 활성화에 대해 자세히 알아보기](integrations.md#configure)
