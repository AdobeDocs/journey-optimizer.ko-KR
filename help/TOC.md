...
+ 시작하기 {#get-started}
   ...
   + 기본 사항 {#essentials}
      ...
      + [사용 사례 개요](using/start/ajo-use-case-guide.md)
...
+ 여정 {#orchestrate-journeys}
   ...
   + {hide-from-toc}[여정 유형 및 선택 안내서](using/building-journeys/journey-types-selection.md)
   ...
   + 표현식 작성 {#building-advanced-conditions-journeys}
      ...
      + [표현식 어시스턴트를 사용하여 표현식 생성](using/building-journeys/expression/expression-agent.md)
      + 구문 {#syntax}
         ...
         + {hide-from-toc}[예](using/building-journeys/expression/advanced-editor-use-cases.md)
   ...
   + 사용 사례 {#journey-use-cases}
      ...
      + {hide-from-toc}[점진적 게재 늘리기](using/building-journeys/ramp-up-deliveries-uc.md)
...
+ 캠페인 {#campaigns}
   ...
   + 오케스트레이션된 캠페인 {#orchestrated-campaigns}
      ...
      + 데이터베이스 쿼리 {#query-database}
         ...
         + [미리 정의된 필터 작업](using/orchestrated/predefined-filters.md)
...
+ 콘텐츠 관리 {#content-management}
   ...
   + 개인화 {#personalization}
      ...
      + 도우미 함수 목록 {#functions}
         ...
         + {hide-from-toc}[외부 데이터 조회 도우미](using/personalization/external-data-lookup.md)
   ...
   + 솔루션 간 사용 사례 {#combine}
      ...
      + Experience Manager 콘텐츠 조각 {#aem}
         ...
         + [콘텐츠 조각에 대한 저장소 구성](using/integrations/aem-admin-settings.md)
         + [Experience Manager 콘텐츠 조각 작업](using/integrations/aem-fragments.md)
         + [Adobe Experience Manager 콘텐츠 조각 관리](using/integrations/aem-fragments-manage.md)
   ...
   + 콘텐츠 최적화 {#message-optimization}
      ...
      + [타기팅 사용](using/content-management/optimization-targeting.md)
      + [실험 사용](using/content-management/optimization-experimentation.md)
      + [타기팅과 실험 결합](using/content-management/optimization-combination.md)
...
+ 보고 {#reporting}
   ...
   + 전체 시간 보고서 {#channel-report}
      ...
      + 캠페인 보고서 {#campaign-reporting}
         ...
         + {hide-from-toc}[라이브 활동 캠페인 보고서](using/reports/campaign-global-report-cja-activity.md)
   ...
   + 의사 결정 관리 {#offer-decisioning}
      ...
      + 오퍼 만들기 및 관리 {#managing-offers-in-the-offer-library}
         ...
         + 오퍼 구성 {#configure-offers}
            ...
            + [개인화 편집기에서 지원되는 함수](using/offers/offer-library/personalization-editor-supported-functions.md)
