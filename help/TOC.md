...
+ 테스트 및 승인 {#test}
   ...
   + 콘텐츠 미리 보기 및 테스트 {#preview-test}
      ...
      + {hide-from-toc}[콘텐츠 변형의 자동 생성](using/test-approve/simulate-sample-input-generated.md)
   ...
   + 이메일 채널 {#email}
      ...
      + 이메일 콘텐츠 디자인 {#design-email}
         ...
         + 콘텐츠 디자인 {#add-content}
            ...
            + {hide-from-toc}[AI 받은 편지함에 대한 전자 메일 최적화](using/email/llm-email-optimizer.md)
...
+ 콘텐츠 관리 {#content-management}
   ...
   + 솔루션 간 사용 사례 {#combine}
      ...
      + {hide-from-toc}[MCP를 통해 AI 도구로 작업 - 숨김](/help/using/integrations/ajo-mcp.md)
