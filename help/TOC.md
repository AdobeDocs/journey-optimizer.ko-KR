...
user-guide-description: Journey Optimizer를 사용하여 고객에게 연결되고 상황에 맞는 개인화된 경험을 구축하고 전달할 수 있습니다
type: Documentation
...
+ 시작{#get-started}
   + [Journey Optimizer란 무엇입니까?](using/start/get-started.md)
...
+ 여정 {#orchestrate-journeys}
   ...
   + 여정 만들기{#create-journey}
      + [첫 번째 여정 만들기](using/building-journeys/journey-gs.md)
   ...
   + 활동 {#about-journey-building}
      ...
      + [세그먼트 자격](using/building-journeys/segment-qualification-events.md)
      ...
      + [사용자 지정 작업](using/building-journeys/using-custom-actions.md)
   ...
   + 표현식 작성 {#building-advanced-conditions-journeys}
      ...
      + 구문 {#syntax}
         ...
         + [예](using/building-journeys/expression/advanced-editor-use-cases.md)
      + 함수 {#main-functions-journey}
         ...
         + 날짜 {#date}
            + [현재 &#x200B; 시간(밀리)](using/building-journeys/functions/functioncurrenttimeinmillis.md)
         ...
         + 목록 {#list}
            ...
            + [필터](using/building-journeys/functions/functionfilter.md)
            + [getListItem](using/building-journeys/functions/functiongetlistitem.md)
            + [in](using/building-journeys/functions/functionin.md)
            + [교차](using/building-journeys/functions/functionintersect.md)
...
+ 이메일 채널 {#email}
   ...
   + 이메일 콘텐츠 디자인 {#design-email}
      ...
      + 컨텐츠 만들기 시작 {#start-creating-content}
         ...
         + [고유한 컨텐츠 코드 지정](using/email/code-content.md)
...
+ DM {#direct-mail}
   ...
   + [DM 구성](using/direct-mail/direct-mail-configuration.md)
+ 웹 채널{#web}
   + [웹 채널 시작](using/web/get-started-web.md)
   + [웹 경험 만들기](using/web/create-web.md)
   + [웹 페이지 작성](using/web/author-web.md)
   + [시각적 편집 도우미 확장](using/web/visual-editing-helper.md)
...
+ 추적 및 모니터링 {#reporting}
   ...
   + 게재 기능 {#deliverability}
      + [게재 기능 시작](using/reports/deliverability.md)
...
+ 의사 결정 관리 {#offer-decisioning}
   ...
   + 등급 만들기 {#rankings}
      ...
      + AI 모델 {#ai-models}
         + [AI 모델](using/offers/ranking/ai-models.md)
   ...
   + 오퍼 카탈로그 내보내기 {#export-catalog}
      ...
      + [내보낸 오퍼 카탈로그에 액세스합니다](using/offers/export-catalog/access-dataset.md)
      + [개인화된 오퍼 데이터 세트](using/offers/export-catalog/export-offers.md)
      + [결정 데이터 세트](using/offers/export-catalog/export-decisions.md)
   ...
   + API 참조 {#api-reference}
      ...
      + API를 사용하여 의사 결정을 만들고 관리합니다 {#activities-api}
         + [결정 나열](using/offers/api-reference/activities-api/activities/activities-list.md)
...
+ 데이터 관리 {#data-management}
   ...
   + Journey Optimizer 데이터 세트 {#datasets}
      + [데이터 세트 시작](using/data/get-started-datasets.md)
...
+ 구성{#configuration}
   ...
   + [채널 서피스 설정](using/configuration/channel-surfaces.md)
   ...
   + 여정 구성 {#configure-journeys}
      ...
      + 작업 구성 {#action-journeys}
         ...
         + [Adobe Campaign Standard와 통합](using/action/acs-action.md)
