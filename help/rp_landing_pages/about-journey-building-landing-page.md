...
Adobe Journey Optimizer의 활동은 여러 채널에서 이벤트를 트리거하고, 의사 결정을 내리고, 의미 있는 작업을 수행할 수 있도록하여 고객 여정을 실현하는 기본 구성단위입니다. 구매 이벤트 수신, 개인화된 이메일 전송, 실시간 프로필 업데이트 등 활동을 통해 여정의 모든 단계를 맞춤화할 수 있습니다. 이벤트, 오케스트레이션 또는 액션과 같은 모든 활동 유형은 서로 협력하여 원활하고 매력적인 경험을 만드는 고유한 역할을 합니다. 이러한 도구를 탐색하면서 트리거, 조건, 액션을 사용하여 고객의 요구를 충족시킬 만큼 역동적인 여정을 구축하는 방법을 알아봅니다.
...
- **[기본 제공 채널 액션](../using/building-journeys/journey-action.md)** - 여정을 사용하여 Journey Optimizer의 기본 제공 기능으로 이메일, SMS, 푸시 알림, 인앱, 웹, 코드 기반 경험을 통해 메시지나 경험, 또는 콘텐츠 카드를 게재합니다.
