...
동의 관리는 GDPR과 같은 개인 정보 보호 규정 준수를 보장하면서 대상자와 신뢰를 구축하는 데 중요합니다. Adobe Journey Optimizer의 동의는 [데이터 요청](../using/privacy/requests.md) 및 [감사 로그](../using/privacy/audit-logs.md)를 포함한 개인 정보 관리[&#128279;](../using/privacy/get-started-privacy.md) 및 중요한 필드를 타사 시스템으로 내보내지지 않도록 보호하는 [데이터 거버넌스](../using/action/action-privacy.md) 정책과 함께 작동합니다.
...
동의 정책을 사용하여 구독 주제 및 채널 환경 설정을 관리하여 동의를 존중하면서 고객의 선택에 따라 고객을 타깃팅하는 방법에 대해 알아봅니다.
