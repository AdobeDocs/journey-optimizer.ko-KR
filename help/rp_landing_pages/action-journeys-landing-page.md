...
title: 액션 구성
description: Journey Optimizer에서 사용자 정의 액션을 구성하여 API 호출, 응답, 모니터링 및 거버넌스를 통해 여정을 제3자 시스템과 연결하는 방법을 알아봅니다.
...
내장된 모니터링 및 보고 기능을 사용하여 여정에서 사용자 정의 액션의 성능과 실행을 추적합니다.
