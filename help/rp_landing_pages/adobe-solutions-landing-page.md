...
description: 사용자 정의 액션을 사용하여 Journey Optimizer 여정에서 Adobe Campaign Standard, Campaign v7/v8, Marketo Engage를 통해 메시지를 보내는 방법을 알아봅니다.
...
[Campaign Standard와 통합](../using/action/acs-action.md)
:::
...
[Campaign v7/v8 통합](../using/action/acc-action.md)
:::
