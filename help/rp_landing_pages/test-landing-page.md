...
### 질문: 캠페인을 시작하기 전에 필요한 테스트는 무엇입니까?

**최소:** 테스트 프로필 + 스팸 점수 확인(이메일)이 포함된 콘텐츠 미리 보기
**권장:** + 전자 메일 렌더링 + 충돌 검색 + 승인 워크플로
**모범 사례:** + 샘플 입력 데이터 테스트 + 시드 목록 + A/B 실험(최적화하는 경우)

### Q: 많은 테스트 프로필을 만들지 않고 개인화를 테스트하려면 어떻게 합니까?
...
### Q: 여정의 테스트 모드와 시험 실행의 차이점은 무엇입니까?
...
**다른 모든 기능:** Journey Optimizer에 내장되어 있으므로 추가 통합이 필요하지 않습니다.
**참고:** 테스트 프로필에는 실시간 고객 프로필 서비스(포함)가 필요합니다.

### Q: API 트리거 캠페인을 어떻게 테스트합니까?
...
**옵션 2:** UI에서 테스트 프로필이 있는 콘텐츠 미리 보기
