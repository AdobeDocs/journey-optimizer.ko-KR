...
1. **샘플 데이터가 있는 콘텐츠 변형을 테스트합니다** - CSV 또는 JSON 파일, 수동 입력 또는 AI 자동 생성의 [샘플 입력 데이터](../using/test-approve/simulate-sample-input.md)를 사용하여 다양한 테스트 프로필을 만들지 않고도 최대 30개의 개인화 시나리오를 테스트합니다.
...
**[입력 데이터 샘플](../using/test-approve/simulate-sample-input.md)** - CSV 또는 JSON 파일, 수동 입력 또는 개인화 테스트를 위한 AI 자동 생성. 최대 30개의 변형을 지원합니다. [콘텐츠 베리에이션을 시뮬레이션하는 방법](../using/test-approve/simulate-sample-input.md)
...
* [콘텐츠 변형 시뮬레이션](../using/test-approve/simulate-sample-input.md) - CSV 또는 JSON 파일, 수동 입력 또는 AI 자동 생성을 사용하여 최대 30개의 개인화 시나리오를 테스트합니다.
