...
캠페인 및 여정을 시작하기 전에 예상대로 작동하는지 확인합니다. [테스트 프로필](../using/content-management/test-profiles.md)로 콘텐츠를 미리 보고 여러 디바이스에 걸쳐 이메일 렌더링을 확인하고 [테스트 모드](../using/building-journeys/testing-the-journey.md) 또는 [시험 실행](../using/building-journeys/journey-dry-run.md)으로 여정 논리의 유효성을 검사합니다. 품질 관리를 적용하기 위해 [승인 워크플로](../using/test-approve/gs-approval.md)를 설정하고 [시스템 경고](../using/reports/alerts.md)를 사용하여 문제를 모니터링합니다. 이른 단계부터 테스트하면 오류를 포착하여 정확하고 효과적인 캠페인을 전달하는 데 도움이 됩니다.
...
* [여정의 실시간 보고서](../using/building-journeys/report-journey.md) - 실시간으로 여정 지표를 모니터링하여 실행 중 성과를 추적하고 문제를 식별합니다.

* [테스트 프로필 만들기](../using/audience/creating-test-profiles.md) - 테스트 프로필을 만들고 관리하여 실제 고객 시나리오를 시뮬레이션하고 개인화를 확인합니다.

* [콘텐츠 관리](content-management-landing-page.md) - 템플릿, 조각, 이메일 디자이너를 사용하여 콘텐츠를 디자인하고 미리 보고 관리하는 방법에 대해 알아봅니다.

* [여정 FAQ](../using/building-journeys/journey-faq.md) - 여정 만들기, 테스트, 실행, 문제 해결과 관련해 많이 나오는 질문에 대한 답변을 찾을 수 있습니다.

* [이메일 스팸 보고서](../using/content-management/spam-report.md) - 보내기 전에 이메일 스팸 점수를 확인하여 전달성과 받은 편지함 내 배치 위치를 개선합니다.
