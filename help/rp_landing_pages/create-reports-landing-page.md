...
description: 이벤트 데이터 세트와 DecisioningEvents XDM 스키마를 사용하여 오퍼 성과 및 의사 결정 결과를 분석하는 의사 결정 관리 보고서를 만드는 방법을 알아봅니다.
...
Adobe Journey Optimizer에서 의사 결정 관리 이벤트 데이터와 DecisioningEvents XDM 스키마를 사용하여 사용자 정의 보고서를 작성합니다. 이 섹션에서는 이벤트 데이터 세트를 사용하고 오퍼 선택, 대체 사용량 및 배치 효율성을 분석하는 데 필요한 XDM 필드에 액세스하는 방법을 설명합니다.
