...
title: 데이터 구성
description: Journey Optimizer에서 오케스트레이션된 캠페인을 실행하기 위해 관계형 스키마, 데이터 세트, 타겟팅 차원 및 채널 설정을 구성하는 방법을 알아봅니다.
...
이메일 및 기타 지원되는 채널을 포함하여 오케스트레이션된 캠페인에 사용할 채널 구성을 설정하고 구성하는 방법을 알아봅니다.
